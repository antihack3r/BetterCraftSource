...
public class ReflectorMethod
{
    ...
    public ReflectorMethod(final ReflectorClass p_i93_1_, final String p_i93_2_) {
        this(p_i93_1_, p_i93_2_, null, false);
    }
    
    public ReflectorMethod(final ReflectorClass p_i94_1_, final String p_i94_2_, final Class[] p_i94_3_) {
        this(p_i94_1_, p_i94_2_, p_i94_3_, false);
    }
    
    public ReflectorMethod(final ReflectorClass p_i95_1_, final String p_i95_2_, final Class[] p_i95_3_, final boolean p_i95_4_) {
