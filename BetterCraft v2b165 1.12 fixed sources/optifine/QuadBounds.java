...
public class QuadBounds
{
    ...
    public QuadBounds(final int[] p_i76_1_) {
        ...
        final int i = p_i76_1_.length / 4;
        for (int j = 0; j < 4; ++j) {
            final int k = j * i;
            final float f = Float.intBitsToFloat(p_i76_1_[k + 0]);
            final float f2 = Float.intBitsToFloat(p_i76_1_[k + 1]);
            final float f3 = Float.intBitsToFloat(p_i76_1_[k + 2]);
            if (this.minX > f) {
                this.minX = f;
            }
            if (this.minY > f2) {
