...
public class ReflectorForge
{
    ...
    public static int getLightValue(final IBlockState p_getLightValue_0_, final IBlockAccess p_getLightValue_1_, final BlockPos p_getLightValue_2_) {
    ...
    public static MapData getMapData(final ItemMap p_getMapData_0_, final ItemStack p_getMapData_1_, final World p_getMapData_2_) {
