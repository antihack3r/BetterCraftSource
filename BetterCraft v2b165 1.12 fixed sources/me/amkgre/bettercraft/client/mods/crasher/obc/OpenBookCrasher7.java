        ...
        new Thread() {
            ...
            public void run() {
                ...
                while (Minecraft.getMinecraft().player != null) {
                    try {
                        Minecraft.getMinecraft().getConnection().getNetworkManager().sendPacket(new CPacketPlayerBlockPlacement(new BlockPos(Minecraft.getMinecraft().player.posX, Minecraft.getMinecraft().player.posY - 2.0, Minecraft.getMinecraft().player.posZ), 1, Item2, 0.0f, 0.0f, 0.0f));
                        Thread.sleep(500L);
                    }
