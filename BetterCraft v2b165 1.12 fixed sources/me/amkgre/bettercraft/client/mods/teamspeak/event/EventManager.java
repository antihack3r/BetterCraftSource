...
import me.amkgre.bettercraft.client.mods.teamspeak.impl.GroupImpl;
import me.amkgre.bettercraft.client.mods.teamspeak.api.TalkStatus;
import me.amkgre.bettercraft.client.mods.teamspeak.impl.PrivateChatImpl;
...
public class EventManager
{
    ...
    private void createTextMessageEvent(final PropertyMap propertyMap) {
        ...
        if (targetMode == MessageTargetMode.CLIENT) {
            ...
            privateChat.addMessage(new MessageImpl(String.valueOf(Utils.getChatTimeString()) + "\"" + invoker.getName() + "\": " + msg, System.currentTimeMillis()));
        }
    ...
    private void createClientPokeEvent(final PropertyMap propertyMap) {
        ...
        tab.getPokeChat().addMessage(new MessageImpl(String.valueOf(Utils.getChatTimeString()) + "\"" + invoker.getName() + "\": " + message, System.currentTimeMillis()));
