...
public class ShaderUtils
{
    ...
    public ShaderUtils(final String fragment) {
    ...
    public ShaderUtils uniform1i(final String loc, final int i) {
        GL20.glUniform1i(GL20.glGetUniformLocation(this.program, loc), i);
        return this;
    }
    
    public ShaderUtils uniform2i(final String loc, final int i, final int i1) {
        GL20.glUniform2i(GL20.glGetUniformLocation(this.program, loc), i, i1);
        return this;
    }
    
    public ShaderUtils uniform3i(final String loc, final int i, final int i1, final int i2) {
        GL20.glUniform3i(GL20.glGetUniformLocation(this.program, loc), i, i1, i2);
        return this;
    }
    
    public ShaderUtils uniform4i(final String loc, final int i, final int i1, final int i2, final int i3) {
        GL20.glUniform4i(GL20.glGetUniformLocation(this.program, loc), i, i1, i2, i3);
        return this;
    }
    
    public ShaderUtils uniform1f(final String loc, final float f) {
        GL20.glUniform1f(GL20.glGetUniformLocation(this.program, loc), f);
        return this;
    }
    
    public ShaderUtils uniform2f(final String loc, final float f, final float f1) {
        GL20.glUniform2f(GL20.glGetUniformLocation(this.program, loc), f, f1);
        return this;
    }
    
    public ShaderUtils uniform3f(final String loc, final float f, final float f1, final float f2) {
        GL20.glUniform3f(GL20.glGetUniformLocation(this.program, loc), f, f1, f2);
        return this;
    }
    
    public ShaderUtils uniform4f(final String loc, final float f, final float f1, final float f2, final float f3) {
        GL20.glUniform4f(GL20.glGetUniformLocation(this.program, loc), f, f1, f2, f3);
        return this;
    }
    
    public ShaderUtils uniform1b(final String loc, final boolean b) {
