...
public class AdvancedServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public AdvancedServerListEntryNormal(final AdvancedGuiMainMenu owner, final ServerData data) {
        this.owner = owner;
    ...
    public void ping() {
        ...
        AdvancedServerListEntryNormal.field_148302_b.submit(() -> {
            try {
                this.owner.getServerPinger().ping(this.serverData);
            }
            catch (final UnknownHostException var2) {
                this.serverData.pingToServer = -1L;
                this.serverData.serverMOTD = TextFormatting.DARK_RED + "Server doesn't exist";
            }
            catch (final Exception var3) {
                this.serverData.pingToServer = -1L;
                this.serverData.serverMOTD = TextFormatting.DARK_RED + "Server is offline";
            }
        });
    }
    ...
    public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
        ...
        if (this.serverData.pingToServer == -1L) {
            String s = "§7Version§8: §cUnknown";
            this.mc.fontRendererObj.drawString(s, p_192634_2_ + p_192634_4_ + 3, p_192634_3_ + 1, -1);
            s = "§7Protocol§8: §cUnknown";
            this.mc.fontRendererObj.drawString(s, p_192634_2_ + p_192634_4_ + 3, p_192634_3_ + 10, -1);
            s = "§7Ping§8: §cUnknown";
            this.mc.fontRendererObj.drawString(s, p_192634_2_ + p_192634_4_ + 3, p_192634_3_ + 19, -1);
        }
        else if (this.serverData.pingToServer == -2L) {
            String s = "§7Version§8: §aLoading...";
            this.mc.fontRendererObj.drawString(s, p_192634_2_ + p_192634_4_ + 3, p_192634_3_ + 1, -1);
            ...
            String s = "§7Version§8: §e" + this.serverData.gameVersion.split(" ")[0];
            this.mc.fontRendererObj.drawString(s, p_192634_2_ + p_192634_4_ + 3, p_192634_3_ + 1, -1);
            final String n = ProtocolVersionUtils.getKnownAs(this.serverData.version);
            s = "§7Protocol§8: §e" + this.serverData.version + " §7(" + ((n == null) ? "§cUnknown§7" : n) + ")";
            this.mc.fontRendererObj.drawString(s, p_192634_2_ + p_192634_4_ + 3, p_192634_3_ + 10, -1);
            final long ping = this.serverData.pingToServer;
            int color = 52;
            if (ping <= 50L) {
                color = 97;
            }
        ...
        final String s2 = notJoinable ? (TextFormatting.DARK_RED + this.serverData.gameVersion) : this.serverData.populationInfo;
        ...
        if (this.field_148305_h != null) {
            ...
            this.func_178012_a(p_192634_2_, p_192634_3_, AdvancedServerListEntryNormal.UNKNOWN_SERVER);
        }
        ...
        if (this.mc.gameSettings.touchscreen || p_192634_8_) {
            this.mc.getTextureManager().bindTexture(AdvancedServerListEntryNormal.SERVER_SELECTION_BUTTONS);
            ...
            if (this.owner.func_175392_a(p_192634_1_)) {
                if (k2 < 16 && l2 < 16) {
            ...
            if (this.owner.func_175394_b(p_192634_1_)) {
                if (k2 < 16 && l2 > 16) {
        ...
        if (this.serverData.getBase64EncodedIconData() == null) {
            ...
            Label_0233: {
                try {
                    ...
                    AdvancedServerListEntryNormal.logger.error("Invalid icon for server " + this.serverData.serverName + " (" + this.serverData.serverIP + ")", throwable);
    ...
    public boolean mousePressed(final int p_192634_1_, final int p_148278_2_, final int p_148278_3_, final int p_148278_4_, final int p_148278_5_, final int p_148278_6_) {
        if (p_148278_5_ <= 32) {
            ...
            if (p_148278_5_ < 16 && p_148278_6_ < 16 && this.owner.func_175392_a(p_192634_1_)) {
                this.owner.func_175391_a(p_192634_1_, GuiScreen.isShiftKeyDown());
                return true;
            }
            if (p_148278_5_ < 16 && p_148278_6_ > 16 && this.owner.func_175394_b(p_192634_1_)) {
                this.owner.func_175393_b(p_192634_1_, GuiScreen.isShiftKeyDown());
                return true;
            }
        }
        this.owner.selectServer(p_192634_1_);
