...
public class IOUtils
{
    ...
    public static byte[] readAllBytes(final InputStream var0) throws IOException {
        return readNBytes(var0, Integer.MAX_VALUE);
    }
    
    public static byte[] readNBytes(final InputStream var0, final int var1) throws IOException {
        if (var1 < 0) {
        ...
        do {
            byte[] var7;
            int var8;
            for (var7 = new byte[Math.min(var5, 8192)], var8 = 0; (var6 = var0.read(var7, var8, Math.min(var7.length - var8, var5))) > 0; var8 += var6, var5 -= var6) {}
            if (var8 <= 0) {
                continue;
            }
        ...
        if (var2 != null) {
            ...
            int var9 = 0;
            var5 = var4;
            for (final byte[] var10 : var2) {
                final int var11 = Math.min(var10.length, var5);
                System.arraycopy(var10, 0, var3, var9, var11);
                var9 += var11;
                var5 -= var11;
            }
            return var3;
    ...
    public static long skip(final InputStream input, final long toSkip) throws IOException {
        ...
        long remain;
        long n;
        for (remain = toSkip; remain > 0L && (n = input.read(IOUtils.SKIP_BYTE_BUFFER, 0, (int)Math.min(remain, 2048L))) >= 0L; remain -= n) {}
    ...
    public static long skip(final Reader input, final long toSkip) throws IOException {
        ...
        long remain;
        long n;
        for (remain = toSkip; remain > 0L && (n = input.read(IOUtils.SKIP_CHAR_BUFFER, 0, (int)Math.min(remain, 2048L))) >= 0L; remain -= n) {}
        return toSkip - remain;
    }
