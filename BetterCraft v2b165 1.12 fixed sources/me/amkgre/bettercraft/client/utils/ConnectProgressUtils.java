...
public class ConnectProgressUtils
{
    ...
    static {
        ConnectProgressUtils.PROGRESS = 0;
        ConnectProgressUtils.CURRENT = "";
    }
    ...
    public static void setProgress(final int givenProgress, final String givenText) {
        ConnectProgressUtils.PROGRESS = givenProgress;
        ConnectProgressUtils.CURRENT = givenText;
        update();
    }
    ...
    public static void drawSplash(final TextureManager tm) {
        ...
        if (ConnectProgressUtils.splash == null) {
            ConnectProgressUtils.splash = new ResourceLocation("textures/gui/title/mojang.png");
        }
        tm.bindTexture(ConnectProgressUtils.splash);
    ...
    private static void drawProgress() {
        ...
        if (ConnectProgressUtils.ufr == null) {
            ConnectProgressUtils.ufr = UnicodeFontRendererUtils.getFontOnPC("NONE", 20);
        }
        final ScaledResolution sr = new ScaledResolution(Minecraft.getMinecraft());
        final double nProgress = ConnectProgressUtils.PROGRESS;
        ...
        GlStateManager.resetColor();
        resetTextureState();
        ConnectProgressUtils.ufr.drawString(ConnectProgressUtils.CURRENT, 20.0f, (float)(ScaledResolution.getScaledHeight() - 25), -1);
        final String step = String.valueOf(ConnectProgressUtils.PROGRESS) + "/" + 11;
        ConnectProgressUtils.ufr.drawString(step, ScaledResolution.getScaledWidth() - 20 - ConnectProgressUtils.ufr.getWidth(step), (float)(ScaledResolution.getScaledHeight() - 25), -505290241);
        GlStateManager.resetColor();
        resetTextureState();
