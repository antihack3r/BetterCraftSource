            ...
            switch (this.size) {
                ...
                default: {
                    if (this.valueComparator != null) {
                        ...
                        Arrays.sort(this.entries, 0, this.size, (Comparator<? super ImmutableMapEntry<K, V>>)Ordering.from(this.valueComparator).onResultOf((com.google.common.base.Function<Entry<?, ? extends V>, ? extends V>)Maps.valueFunction()));
                    }
