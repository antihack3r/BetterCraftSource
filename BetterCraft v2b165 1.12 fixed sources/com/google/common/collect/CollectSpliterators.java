        ...
        class FlatMapSpliterator implements Spliterator<T>
        {
            ...
            public boolean tryAdvance(final Consumer<? super T> action) {
                while (this.prefix == null || !this.prefix.tryAdvance(action)) {
                    this.prefix = null;
                    if (!this.from.tryAdvance(fromElement -> {
                        final Object val$function = this.val$function;
                        this.prefix = function.apply(fromElement);
                        return;
                    })) {
                        return false;
                    }
            ...
            public void forEachRemaining(final Consumer<? super T> action) {
                ...
                this.from.forEachRemaining(fromElement -> {
                    final Object val$function = this.val$function;
                    function.apply(fromElement).forEachRemaining(action);
                    return;
                });
