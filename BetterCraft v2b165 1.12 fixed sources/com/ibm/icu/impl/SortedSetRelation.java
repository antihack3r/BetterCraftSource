...
public class SortedSetRelation
{
    ...
    public static <T extends Object & Comparable<? super T>> boolean hasRelation(final SortedSet<T> a, final int allow, final SortedSet<T> b) {
        if (allow < 0 || allow > 7) {
        ...
        T bb = (T)bit.next();
        while (true) {
            final int comp = ((Comparable<T>)aa).compareTo(bb);
            if (comp == 0) {
                if (!ab) {
                    return false;
                }
    ...
    public static <T extends Object & Comparable<? super T>> SortedSet<? extends T> doOperation(final SortedSet<T> a, final int relation, final SortedSet<T> b) {
        switch (relation) {
            case 7: {
