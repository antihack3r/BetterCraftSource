...
public class GuiEditNBTTree extends GuiScreen
{
    ...
    private void quitWithSave() {
        Minecraft.getMinecraft().player.getHeldItemMainhand().setTagCompound(this.guiTree.getNBTTree().toNBTTagCompound());
        new Thread(() -> {
            try {
    ...
    public Entity getEntity() {
        return this.entity ? this.mc.world.getEntityByID(this.entityOrX) : null;
    }
