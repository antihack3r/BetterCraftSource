...
public class SoundPackets1_13 extends RewriterBase<Protocol1_12_2To1_13>
{
    ...
    protected void registerPackets() {
        ((AbstractProtocol<ClientboundPackets1_13, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_13.NAMED_SOUND, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    final String newSound = wrapper.get(Type.STRING, 0);
        ...
        ((AbstractProtocol<ClientboundPackets1_13, ClientboundPackets1_12_1, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_13.STOP_SOUND, ClientboundPackets1_12_1.PLUGIN_MESSAGE, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
