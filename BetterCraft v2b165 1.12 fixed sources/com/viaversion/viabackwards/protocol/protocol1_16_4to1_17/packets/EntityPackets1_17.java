...
public final class EntityPackets1_17 extends EntityRewriter<Protocol1_16_4To1_17>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, ClientboundPackets1_16_2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_17.REMOVE_ENTITY, ClientboundPackets1_16_2.DESTROY_ENTITIES, new PacketRemapper() {
            @Override
        ...
        ((AbstractProtocol<ClientboundPackets1_17, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_17.JOIN_GAME, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    ...
                    final CompoundTag biomeRegsitry = registry.get("minecraft:worldgen/biome");
                    final ListTag biomes = biomeRegsitry.get("value");
                    biomes.iterator();
