...
public final class BlockItemPackets1_17 extends ItemRewriter<Protocol1_16_4To1_17>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<C1, C2, ServerboundPackets1_17, ServerboundPackets1_16_2>)this.protocol).registerServerbound(ServerboundPackets1_16_2.WINDOW_CONFIRMATION, null, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
                    wrapper.cancel();
