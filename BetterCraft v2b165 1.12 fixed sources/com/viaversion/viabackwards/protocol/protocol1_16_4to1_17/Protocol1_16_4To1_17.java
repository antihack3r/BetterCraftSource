...
public final class Protocol1_16_4To1_17 extends BackwardsProtocol<ClientboundPackets1_17, ClientboundPackets1_16_2, ServerboundPackets1_17, ServerboundPackets1_16_2>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, ClientboundPackets1_16_2, S1, S2>)this).registerClientbound(ClientboundPackets1_17.PING, null, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
                    wrapper.cancel();
        ...
        ((AbstractProtocol<ClientboundPackets1_17, ClientboundPackets1_16_2, S1, S2>)this).registerClientbound(ClientboundPackets1_17.CLEAR_TITLES, ClientboundPackets1_16_2.TITLE, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
    ...
    public void mergePacket(final ClientboundPackets1_17 newPacketType, final ClientboundPackets1_16_2 oldPacketType, final int type) {
        ((AbstractProtocol<ClientboundPackets1_17, ClientboundPackets1_16_2, S1, S2>)this).registerClientbound(newPacketType, oldPacketType, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
