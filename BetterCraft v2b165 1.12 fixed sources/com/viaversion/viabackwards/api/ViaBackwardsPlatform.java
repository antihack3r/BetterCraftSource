...
public interface ViaBackwardsPlatform
{
    ...
    public static final String IMPL_VERSION = "git-ViaBackwards-4.0.2-SNAPSHOT:455bb54";
    ...
    default void init(final File dataFolder) {
        ...
        Via.getManager().getSubPlatforms().add("git-ViaBackwards-4.0.2-SNAPSHOT:455bb54");
