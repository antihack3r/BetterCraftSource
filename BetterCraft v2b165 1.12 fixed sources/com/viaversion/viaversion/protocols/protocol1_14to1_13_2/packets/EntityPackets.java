...
public class EntityPackets
{
    public static void register(final Protocol1_14To1_13_2 protocol) {
        ...
        ((AbstractProtocol<ClientboundPackets1_13, ClientboundPackets1_14, S1, S2>)protocol).registerClientbound(ClientboundPackets1_13.USE_BED, ClientboundPackets1_14.ENTITY_METADATA, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.map(Type.VAR_INT);
                this.handler(new PacketHandler() {
