...
public class EntityPackets
{
    ...
    public static void register(final Protocol1_16To1_15_2 protocol) {
        ...
        ((AbstractProtocol<ClientboundPackets1_15, ClientboundPackets1_16, S1, S2>)protocol).registerClientbound(ClientboundPackets1_15.SPAWN_GLOBAL_ENTITY, ClientboundPackets1_16.SPAWN_ENTITY, new PacketRemapper() {
            @Override
