...
public final class InventoryPackets extends ItemRewriter<Protocol1_17To1_16_4>
{
    ...
    public void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_16_2, ClientboundPackets1_17, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_16_2.WINDOW_CONFIRMATION, null, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
        ...
        ((AbstractProtocol<C1, C2, ServerboundPackets1_16_2, ServerboundPackets1_17>)this.protocol).registerServerbound(ServerboundPackets1_17.PONG, null, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
