...
public final class EntityPackets extends EntityRewriter<Protocol1_17To1_16_4>
{
    ...
    public void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_16_2, ClientboundPackets1_17, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_16_2.DESTROY_ENTITIES, null, new PacketRemapper() {
            @Override
        ...
        ((AbstractProtocol<ClientboundPackets1_16_2, ClientboundPackets1_17, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_16_2.COMBAT_EVENT, null, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(wrapper -> {
