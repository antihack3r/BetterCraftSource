...
public class RealmsPlayerScreen extends RealmsScreen
{
    ...
    public void init() {
        ...
        this.buttonsClear();
        this.buttonsAdd(RealmsScreen.newButton(1, this.column2_x, RealmsConstants.row(1), this.column_width + 10, 20, RealmsScreen.getLocalizedString("mco.configure.world.buttons.invite")));
        this.buttonsAdd(RealmsScreen.newButton(3, this.column2_x, RealmsConstants.row(3), this.column_width + 10, 20, RealmsScreen.getLocalizedString("mco.configure.world.buttons.activity")));
    ...
    private void op(final int index) {
        ...
        final String selectedInvite = this.serverData.players.get(index).getUuid();
        try {
    ...
    public void render(final int xm, final int ym, final float a) {
        ...
        final int bottomBorder = RealmsConstants.row(12) + 20;
        GL11.glDisable(2896);
        GL11.glDisable(2912);
        ...
        t.vertex(0.0, this.height(), 0.0).tex(0.0, (this.height() - bottomBorder) / 32.0f + 0.0f).color(64, 64, 64, 255).endVertex();
        t.vertex(this.width(), this.height(), 0.0).tex(this.width() / 32.0f, (this.height() - bottomBorder) / 32.0f + 0.0f).color(64, 64, 64, 255).endVertex();
        t.vertex(this.width(), bottomBorder, 0.0).tex(this.width() / 32.0f, 0.0).color(64, 64, 64, 255).endVertex();
    ...
    private void drawRemoveIcon(final int x, final int y, final int xm, final int ym) {
        final boolean hovered = xm >= x && xm <= x + 9 && ym >= y && ym <= y + 9 && ym < RealmsConstants.row(12) + 20 && ym > RealmsConstants.row(1);
