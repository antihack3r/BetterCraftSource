...
public class RealmsResetNormalWorldScreen extends RealmsScreen
{
    ...
    public RealmsResetNormalWorldScreen(final RealmsResetWorldScreen lastScreen, final String buttonTitle) {
        this(lastScreen);
    ...
    public void init() {
        ...
        this.buttonsAdd(this.resetButton = RealmsScreen.newButton(1, this.width() / 2 - 102, RealmsConstants.row(12), 97, 20, this.buttonTitle));
