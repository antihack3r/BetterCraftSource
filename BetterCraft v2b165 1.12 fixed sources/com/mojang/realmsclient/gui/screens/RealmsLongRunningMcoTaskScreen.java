...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen implements ErrorCallback
{
    ...
    public void init() {
        this.task.init();
        this.buttonsAdd(RealmsScreen.newButton(666, this.width() / 2 - 106, RealmsConstants.row(12), 212, 20, RealmsScreen.getLocalizedString("gui.cancel")));
    }
    ...
    public void error(final String errorMessage) {
        ...
        this.buttonsClear();
        this.buttonsAdd(RealmsScreen.newButton(667, this.width() / 2 - 106, this.height() / 4 + 120 + 12, RealmsScreen.getLocalizedString("gui.back")));
    }
