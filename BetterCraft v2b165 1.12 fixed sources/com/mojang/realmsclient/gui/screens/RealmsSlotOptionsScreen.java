...
public class RealmsSlotOptionsScreen extends RealmsScreen
{
    ...
    public RealmsSlotOptionsScreen(final RealmsConfigureWorldScreen configureWorldScreen, final RealmsWorldOptions options, final RealmsServer.WorldType worldType, final int activeSlot) {
    ...
    public void init() {
        ...
        (this.nameEdit = this.newEditBox(11, this.column1_x + 2, RealmsConstants.row(1), this.column_width - 4, 20)).setFocus(true);
        this.nameEdit.setMaxLength(10);
        this.nameEdit.setValue(this.options.getSlotName(this.activeSlot));
        this.buttonsAdd(this.pvpButton = RealmsScreen.newButton(4, this.column2_x, RealmsConstants.row(1), this.column_width, 20, this.pvpTitle()));
        this.buttonsAdd(RealmsScreen.newButton(3, this.column1_x, RealmsConstants.row(3), this.column_width, 20, this.gameModeTitle()));
        this.buttonsAdd(this.spawnAnimalsButton = RealmsScreen.newButton(5, this.column2_x, RealmsConstants.row(3), this.column_width, 20, this.spawnAnimalsTitle()));
        this.buttonsAdd(RealmsScreen.newButton(2, this.column1_x, RealmsConstants.row(5), this.column_width, 20, this.difficultyTitle()));
        this.buttonsAdd(this.spawnMonstersButton = RealmsScreen.newButton(6, this.column2_x, RealmsConstants.row(5), this.column_width, 20, this.spawnMonstersTitle()));
        this.buttonsAdd(this.spawnProtectionButton = new SettingsSlider(8, this.column1_x, RealmsConstants.row(7), this.column_width, 17, this.spawnProtection, 0.0f, 16.0f));
        this.buttonsAdd(this.spawnNPCsButton = RealmsScreen.newButton(7, this.column2_x, RealmsConstants.row(7), this.column_width, 20, this.spawnNPCsTitle()));
        this.buttonsAdd(this.forceGameModeButton = RealmsScreen.newButton(10, this.column1_x, RealmsConstants.row(9), this.column_width, 20, this.forceGameModeTitle()));
        this.buttonsAdd(this.commandBlocksButton = RealmsScreen.newButton(9, this.column2_x, RealmsConstants.row(9), this.column_width, 20, this.commandBlocksTitle()));
        if (!this.worldType.equals(RealmsServer.WorldType.NORMAL)) {
    ...
    public void render(final int xm, final int ym, final float a) {
        ...
        if (this.notNormal) {
            if (this.worldType.equals(RealmsServer.WorldType.ADVENTUREMAP)) {
                this.drawCenteredString(RealmsScreen.getLocalizedString("mco.configure.world.edit.subscreen.adventuremap"), this.width() / 2, 26, 16711680);
            }
            else if (this.worldType.equals(RealmsServer.WorldType.INSPIRATION)) {
                this.drawCenteredString(RealmsScreen.getLocalizedString("mco.configure.world.edit.subscreen.inspiration"), this.width() / 2, 26, 16711680);
            }
            else {
                this.drawCenteredString(RealmsScreen.getLocalizedString("mco.configure.world.edit.subscreen.experience"), this.width() / 2, 26, 16711680);
            }
        }
