...
public class RealmsSettingsScreen extends RealmsScreen
{
    ...
    public void init() {
        ...
        this.buttonsAdd(RealmsScreen.newButton(5, this.width() / 2 - 53, RealmsConstants.row(0), 106, 20, RealmsScreen.getLocalizedString(this.serverData.state.equals(RealmsServer.State.OPEN) ? "mco.configure.world.buttons.close" : "mco.configure.world.buttons.open")));
