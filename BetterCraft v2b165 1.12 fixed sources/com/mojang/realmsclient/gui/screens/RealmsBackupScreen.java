...
public class RealmsBackupScreen extends RealmsScreen
{
    ...
    private void postInit() {
        this.buttonsAdd(this.downloadButton = RealmsScreen.newButton(2, this.width() - 135, 32, 120, 20, RealmsScreen.getLocalizedString("mco.backup.button.download")));
        this.buttonsAdd(RealmsScreen.newButton(0, this.width() - 100, this.height() - 35, 85, 20, RealmsScreen.getLocalizedString("gui.back")));
    }
    ...
    private void downloadWorldData() {
        final RealmsTasks.DownloadTask downloadTask = new RealmsTasks.DownloadTask(this.serverData.id, this.slotId, this.serverData.name + " (" + this.serverData.slots.get(this.serverData.activeSlot).getSlotName(this.serverData.activeSlot) + ")", this);
        final RealmsLongRunningMcoTaskScreen longRunningMcoTaskScreen = new RealmsLongRunningMcoTaskScreen(this.lastScreen.getNewScreen(), downloadTask);
    ...
    private void restore() {
        ...
        final RealmsTasks.RestoreTask restoreTask = new RealmsTasks.RestoreTask(backup, this.serverData.id, this.lastScreen);
