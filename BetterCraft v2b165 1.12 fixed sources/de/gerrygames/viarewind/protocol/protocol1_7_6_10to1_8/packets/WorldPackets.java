...
public class WorldPackets
{
    public static void register(final Protocol1_7_6_10TO1_8 protocol) {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, ClientboundPackets1_7, S1, S2>)protocol).registerClientbound(ClientboundPackets1_8.WORLD_BORDER, null, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(packetWrapper -> {
