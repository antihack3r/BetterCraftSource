    ...
    static {
        ...
        StatBase.timeStatType = new IStatType() {
            ...
            public String format(final int number) {
                ...
                if (d5 > 0.5) {
                    return String.valueOf(StatBase.decimalFormat.format(d5)) + " y";
                }
                if (d4 > 0.5) {
                    return String.valueOf(StatBase.decimalFormat.format(d4)) + " d";
                }
                if (d3 > 0.5) {
                    return String.valueOf(StatBase.decimalFormat.format(d3)) + " h";
                }
                return (d2 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(d2)) + " m") : (String.valueOf(d0) + " s");
            }
        };
        StatBase.distanceStatType = new IStatType() {
            ...
            public String format(final int number) {
                ...
                if (d2 > 0.5) {
                    return String.valueOf(StatBase.decimalFormat.format(d2)) + " km";
                }
                return (d0 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(d0)) + " m") : (String.valueOf(number) + " cm");
            }
        };
