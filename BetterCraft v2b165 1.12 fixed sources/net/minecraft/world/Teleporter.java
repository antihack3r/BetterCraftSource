...
public class Teleporter
{
    ...
    public Teleporter(final WorldServer worldIn) {
        this.destinationCoordinateCache = new Long2ObjectOpenHashMap<PortalPosition>(4096);
    ...
    public boolean placeInExistingPortal(final Entity entityIn, final float rotationYaw) {
        ...
        if (this.destinationCoordinateCache.containsKey(l)) {
            final PortalPosition teleporter$portalposition = this.destinationCoordinateCache.get(l);
            d0 = 0.0;
    ...
    public void removeStalePortalLocations(final long worldTime) {
        if (worldTime % 100L == 0L) {
            ...
            final ObjectIterator<PortalPosition> objectiterator = this.destinationCoordinateCache.values().iterator();
            while (objectiterator.hasNext()) {
                final PortalPosition teleporter$portalposition = objectiterator.next();
