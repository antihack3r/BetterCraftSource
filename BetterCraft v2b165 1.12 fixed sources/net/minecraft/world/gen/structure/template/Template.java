...
public class Template
{
    ...
    private void takeEntitiesFromWorld(final World worldIn, final BlockPos startPos, final BlockPos endPos) {
        final List<Entity> list = worldIn.getEntitiesWithinAABB((Class<? extends Entity>)Entity.class, new AxisAlignedBB(startPos, endPos), (Predicate<? super Entity>)new Predicate<Entity>() {
            @Override
