...
public class WorldGenDesertWells extends WorldGenerator
{
    ...
    static {
        IS_SAND = BlockStateMatcher.forBlock(Blocks.SAND).where(BlockSand.VARIANT, (Predicate<? extends BlockSand.EnumType>)Predicates.equalTo(BlockSand.EnumType.SAND));
    }
