...
public class ChunkGeneratorFlat implements IChunkGenerator
{
    ...
    public Chunk provideChunk(final int x, final int z) {
        ...
        final Biome[] abiome = this.worldObj.getBiomeProvider().getBiomes(null, x * 16, z * 16, 16, 16);
    ...
    public void populate(final int x, final int z) {
        ...
        final Biome biome = this.worldObj.getBiome(new BlockPos(i + 16, 0, j + 16));
        boolean flag = false;
        ...
        for (final MapGenStructure mapgenstructure : this.structureGenerators.values()) {
            final boolean flag2 = mapgenstructure.generateStructure(this.worldObj, this.random, chunkpos);
    ...
    public boolean func_193414_a(final World p_193414_1_, final String p_193414_2_, final BlockPos p_193414_3_) {
        final MapGenStructure mapgenstructure = this.structureGenerators.get(p_193414_2_);
