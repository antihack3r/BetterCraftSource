...
public abstract class World implements IBlockAccess
{
    ...
    public boolean spawnEntityInWorld(final Entity entityIn) {
        ...
        if (FBP.enabled && this instanceof WorldClient) {
            FBP.INSTANCE.eventHandler.onEntityJoinWorldEvent(entityIn);
        }
        return true;
    }
    ...
    public boolean collidesWithAnyBlock(final AxisAlignedBB bbox) {
        return this.func_191504_a(null, bbox, true, (List<AxisAlignedBB>)Lists.newArrayList());
    }
    ...
    public EntityPlayer func_190525_a(final double p_190525_1_, final double p_190525_3_, final double p_190525_5_, final double p_190525_7_, final Predicate<Entity> p_190525_9_) {
        ...
        for (int j2 = 0; j2 < this.playerEntities.size(); ++j2) {
            ...
            if (p_190525_9_.apply(entityplayer2)) {
    ...
    public EntityPlayer getNearestAttackablePlayer(final double posX, final double posY, final double posZ, final double maxXZDistance, final double maxYDistance, @Nullable final Function<EntityPlayer, Double> playerToDouble, @Nullable final Predicate<EntityPlayer> p_184150_12_) {
        ...
        for (int j2 = 0; j2 < this.playerEntities.size(); ++j2) {
            final EntityPlayer entityplayer2 = this.playerEntities.get(j2);
            if (!entityplayer2.capabilities.disableDamage && entityplayer2.isEntityAlive() && !entityplayer2.isSpectator() && (p_184150_12_ == null || p_184150_12_.apply(entityplayer2))) {
                ...
                if (playerToDouble != null) {
                    d3 *= MoreObjects.firstNonNull(playerToDouble.apply(entityplayer2), 1.0);
                }
