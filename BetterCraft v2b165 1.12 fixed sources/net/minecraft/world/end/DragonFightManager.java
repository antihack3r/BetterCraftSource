...
public class DragonFightManager
{
    ...
    static {
        ...
        VALID_PLAYER = Predicates.and((Predicate<? super EntityPlayerMP>)EntitySelectors.IS_ALIVE, EntitySelectors.withinRange(0.0, 128.0, 0.0, 192.0));
    }
    ...
    public DragonFightManager(final WorldServer worldIn, final NBTTagCompound compound) {
        ...
        if (compound.hasKey("Gateways", 9)) {
            ...
            this.gateways.addAll(ContiguousSet.create((Range<Integer>)Range.closedOpen(0, (C)20), DiscreteDomain.integers()));
    ...
    public void tick() {
        ...
        if (!this.bossInfo.getPlayers().isEmpty()) {
            if (this.scanForLegacyFight) {
                ...
                final List<EntityDragon> list = this.world.getEntities((Class<? extends EntityDragon>)EntityDragon.class, (Predicate<? super EntityDragon>)EntitySelectors.IS_ALIVE);
                if (list.isEmpty()) {
                    this.dragonKilled = true;
                }
                else {
                    ...
                    DragonFightManager.LOGGER.info("Found that there's a dragon still alive ({})", entitydragon);
            ...
            if (!this.dragonKilled) {
                if (this.dragonUniqueId == null || ++this.ticksSinceDragonSeen >= 1200) {
                    this.loadChunks();
                    final List<EntityDragon> list2 = this.world.getEntities((Class<? extends EntityDragon>)EntityDragon.class, (Predicate<? super EntityDragon>)EntitySelectors.IS_ALIVE);
                    if (list2.isEmpty()) {
    ...
    private void updateplayers() {
        ...
        for (final EntityPlayerMP entityplayermp : this.world.getPlayers((Class<? extends EntityPlayerMP>)EntityPlayerMP.class, (Predicate<? super EntityPlayerMP>)DragonFightManager.VALID_PLAYER)) {
