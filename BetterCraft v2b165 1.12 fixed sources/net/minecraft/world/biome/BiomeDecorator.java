...
public class BiomeDecorator
{
    ...
    protected void genDecorations(final Biome biomeIn, final World worldIn, final Random random) {
        ...
        for (int j2 = 0; j2 < this.sandPerChunk; ++j2) {
            ...
            this.gravelAsSandGen.generate(worldIn, random, worldIn.getTopSolidOrLiquidBlock(this.chunkPos.add(i4, 0, j3)));
        }
        ...
        for (int j4 = 0; j4 < k2; ++j4) {
            ...
            final WorldGenAbstractTree worldgenabstracttree = biomeIn.genBigTreeChance(random);
        ...
        for (int l3 = 0; l3 < this.flowersPerChunk; ++l3) {
            ...
            if (j5 > 0) {
                ...
                if (blockflower.getDefaultState().getMaterial() != Material.AIR) {
                    ...
                    this.yellowFlowerGen.generate(worldIn, random, blockpos2);
                }
            }
        }
