...
public class EntityAIFollowGolem extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        final List<EntityIronGolem> list = this.theVillager.world.getEntitiesWithinAABB((Class<? extends EntityIronGolem>)EntityIronGolem.class, this.theVillager.getEntityBoundingBox().expand(6.0, 2.0, 6.0));
        if (list.isEmpty()) {
            return false;
        }
