...
public class EntityAIEatGrass extends EntityAIBase
{
    ...
    static {
        IS_TALL_GRASS = BlockStateMatcher.forBlock(Blocks.TALLGRASS).where(BlockTallGrass.TYPE, (Predicate<? extends BlockTallGrass.EnumType>)Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
    }
    ...
    public boolean shouldExecute() {
        ...
        return EntityAIEatGrass.IS_TALL_GRASS.apply(this.entityWorld.getBlockState(blockpos)) || this.entityWorld.getBlockState(blockpos.down()).getBlock() == Blocks.GRASS;
    }
    ...
    public void updateTask() {
        ...
        if (this.eatingGrassTimer == 4) {
            final BlockPos blockpos = new BlockPos(this.grassEaterEntity.posX, this.grassEaterEntity.posY, this.grassEaterEntity.posZ);
            if (EntityAIEatGrass.IS_TALL_GRASS.apply(this.entityWorld.getBlockState(blockpos))) {
