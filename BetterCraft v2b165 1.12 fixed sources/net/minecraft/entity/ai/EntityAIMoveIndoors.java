...
public class EntityAIMoveIndoors extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        final Village village = this.entityObj.world.getVillageCollection().getNearestVillage(blockpos, 14);
        if (village == null) {
            return false;
        }
    ...
    public void startExecuting() {
        ...
        if (this.entityObj.getDistanceSq(blockpos) > 256.0) {
            final Vec3d vec3d = RandomPositionGenerator.findRandomTargetBlockTowards(this.entityObj, 14, 3, new Vec3d(i + 0.5, j, k + 0.5));
            if (vec3d != null) {
