    ...
    public boolean attackEntityAsMob(final Entity entityIn) {
        ...
        if (flag) {
            ...
            if (entityIn instanceof EntityPlayer) {
                ...
                final ItemStack itemstack2 = entityplayer.isHandActive() ? entityplayer.getActiveItemStack() : ItemStack.field_190927_a;
                if (!itemstack.func_190926_b() && !itemstack2.func_190926_b() && itemstack.getItem() instanceof ItemAxe && itemstack2.getItem() == Items.SHIELD) {
