...
public class EntityShulker extends EntityGolem implements IMob
{
    ...
    public void readEntityFromNBT(final NBTTagCompound compound) {
        ...
        if (compound.hasKey("APX")) {
            ...
            this.dataManager.set(EntityShulker.ATTACHED_BLOCK_POS, Optional.absent());
        }
    }
    ...
    public void onUpdate() {
        super.onUpdate();
        BlockPos blockpos = this.dataManager.get(EntityShulker.ATTACHED_BLOCK_POS).orNull();
        if (blockpos == null && !this.world.isRemote) {
            blockpos = new BlockPos(this);
            this.dataManager.set(EntityShulker.ATTACHED_BLOCK_POS, Optional.of(blockpos));
        }
        if (this.isRiding()) {
            blockpos = null;
    ...
    public void setPosition(final double x, final double y, final double z) {
        ...
        if (this.dataManager != null && this.ticksExisted != 0) {
            ...
            final Optional<BlockPos> optional2 = Optional.of(new BlockPos(x, y, z));
            ...
            for (int i = 0; i < 5; ++i) {
                ...
                if (blockpos2.getY() > 0 && this.world.isAirBlock(blockpos2) && this.world.func_191503_g(this) && this.world.getCollisionBoxes(this, new AxisAlignedBB(blockpos2)).isEmpty()) {
                    ...
                    if (flag) {
                        ...
                        this.dataManager.set(EntityShulker.ATTACHED_BLOCK_POS, Optional.of(blockpos2));
                        this.dataManager.set(EntityShulker.PEEK_TICK, (Byte)0);
    ...
    public BlockPos getAttachmentPos() {
        return this.dataManager.get(EntityShulker.ATTACHED_BLOCK_POS).orNull();
    }
    
    public void setAttachmentPos(@Nullable final BlockPos pos) {
        this.dataManager.set(EntityShulker.ATTACHED_BLOCK_POS, Optional.fromNullable(pos));
    }
