        ...
        if (livingdata instanceof GroupData) {
            ...
            if (entityzombie$groupdata.isChild) {
                ...
                if (this.world.rand.nextFloat() < 0.05) {
                    final List<EntityChicken> list = this.world.getEntitiesWithinAABB((Class<? extends EntityChicken>)EntityChicken.class, this.getEntityBoundingBox().expand(5.0, 3.0, 5.0), (Predicate<? super EntityChicken>)EntitySelectors.IS_STANDALONE);
                    if (!list.isEmpty()) {
