...
public class EntityMinecartHopper extends EntityMinecartContainer implements IHopper
{
    ...
    public boolean captureDroppedItems() {
        ...
        final List<EntityItem> list = this.world.getEntitiesWithinAABB((Class<? extends EntityItem>)EntityItem.class, this.getEntityBoundingBox().expand(0.25, 0.0, 0.25), (Predicate<? super EntityItem>)EntitySelectors.IS_ALIVE);
        if (!list.isEmpty()) {
