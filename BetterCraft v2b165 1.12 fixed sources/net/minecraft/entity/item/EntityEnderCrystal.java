...
public class EntityEnderCrystal extends Entity
{
    ...
    public void setBeamTarget(@Nullable final BlockPos beamTarget) {
        this.getDataManager().set(EntityEnderCrystal.BEAM_TARGET, Optional.fromNullable(beamTarget));
    }
    
    @Nullable
    public BlockPos getBeamTarget() {
        return this.getDataManager().get(EntityEnderCrystal.BEAM_TARGET).orNull();
    }
