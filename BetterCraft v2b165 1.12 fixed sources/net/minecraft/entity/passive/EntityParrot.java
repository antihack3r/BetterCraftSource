...
public class EntityParrot extends EntityShoulderRiding implements EntityFlying
{
    ...
    static {
        ...
        field_192016_bJ = Sets.newHashSet(Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS);
        (field_192017_bK = new Int2ObjectOpenHashMap<SoundEvent>(32)).put(EntityList.field_191308_b.getIDForObject(EntityBlaze.class), SoundEvents.field_193791_eM);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityCaveSpider.class), SoundEvents.field_193813_fc);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityCreeper.class), SoundEvents.field_193792_eN);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityElderGuardian.class), SoundEvents.field_193793_eO);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityDragon.class), SoundEvents.field_193794_eP);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityEnderman.class), SoundEvents.field_193795_eQ);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityEndermite.class), SoundEvents.field_193796_eR);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityEvoker.class), SoundEvents.field_193797_eS);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityGhast.class), SoundEvents.field_193798_eT);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityHusk.class), SoundEvents.field_193799_eU);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityIllusionIllager.class), SoundEvents.field_193800_eV);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityMagmaCube.class), SoundEvents.field_193801_eW);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityPigZombie.class), SoundEvents.field_193822_fl);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityPolarBear.class), SoundEvents.field_193802_eX);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityShulker.class), SoundEvents.field_193803_eY);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySilverfish.class), SoundEvents.field_193804_eZ);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySkeleton.class), SoundEvents.field_193811_fa);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySlime.class), SoundEvents.field_193812_fb);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySpider.class), SoundEvents.field_193813_fc);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityStray.class), SoundEvents.field_193814_fd);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityVex.class), SoundEvents.field_193815_fe);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityVindicator.class), SoundEvents.field_193816_ff);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWitch.class), SoundEvents.field_193817_fg);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWither.class), SoundEvents.field_193818_fh);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWitherSkeleton.class), SoundEvents.field_193819_fi);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWolf.class), SoundEvents.field_193820_fj);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityZombie.class), SoundEvents.field_193821_fk);
        EntityParrot.field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityZombieVillager.class), SoundEvents.field_193823_fm);
    }
    ...
    private static boolean func_192006_b(final World p_192006_0_, final Entity p_192006_1_) {
        if (!p_192006_1_.isSilent() && p_192006_0_.rand.nextInt(50) == 0) {
            final List<EntityLiving> list = p_192006_0_.getEntitiesWithinAABB((Class<? extends EntityLiving>)EntityLiving.class, p_192006_1_.getEntityBoundingBox().expandXyz(20.0), (Predicate<? super EntityLiving>)EntityParrot.field_192014_bH);
            if (!list.isEmpty()) {
    ...
    private static SoundEvent func_192003_a(final Random p_192003_0_) {
        if (p_192003_0_.nextInt(1000) == 0) {
            final List<Integer> list = new ArrayList<Integer>(EntityParrot.field_192017_bK.keySet());
    ...
    public static SoundEvent func_191999_g(final int p_191999_0_) {
        return EntityParrot.field_192017_bK.containsKey(p_191999_0_) ? EntityParrot.field_192017_bK.get(p_191999_0_) : SoundEvents.field_192792_ep;
    }
