...
{
    public static final DataParameter<Byte> TAMED;
    ...
    public UUID getOwnerId() {
        return this.dataManager.get(EntityTameable.OWNER_UNIQUE_ID).orNull();
    }
    
    public void setOwnerId(@Nullable final UUID p_184754_1_) {
        this.dataManager.set(EntityTameable.OWNER_UNIQUE_ID, Optional.fromNullable(p_184754_1_));
    }
