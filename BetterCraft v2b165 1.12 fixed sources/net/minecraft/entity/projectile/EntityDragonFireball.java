...
public class EntityDragonFireball extends EntityFireball
{
    ...
    protected void onImpact(final RayTraceResult result) {
        if ((result.entityHit == null || !result.entityHit.isEntityEqual(this.shootingEntity)) && !this.world.isRemote) {
            final List<EntityLivingBase> list = this.world.getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, this.getEntityBoundingBox().expand(4.0, 2.0, 4.0));
