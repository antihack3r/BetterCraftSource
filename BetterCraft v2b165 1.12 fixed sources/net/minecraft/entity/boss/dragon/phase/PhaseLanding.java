...
public class PhaseLanding extends PhaseBase
{
    ...
    public void doClientRenderEffects() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            this.dragon.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d4, d5, d6, -vec3d.xCoord * 0.07999999821186066 + this.dragon.motionX, -vec3d.yCoord * 0.30000001192092896 + this.dragon.motionY, -vec3d.zCoord * 0.07999999821186066 + this.dragon.motionZ, new int[0]);
