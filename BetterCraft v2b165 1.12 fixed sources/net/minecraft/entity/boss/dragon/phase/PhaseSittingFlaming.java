...
public class PhaseSittingFlaming extends PhaseSittingBase
{
    ...
    public void doClientRenderEffects() {
        ...
        if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int j = 0; j < 6; ++j) {
                    this.dragon.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d4, d5, d6, -vec3d.xCoord * 0.07999999821186066 * j, -vec3d.yCoord * 0.6000000238418579, -vec3d.zCoord * 0.07999999821186066 * j, new int[0]);
                }
    ...
    public void doLocalUpdate() {
        ...
        if (this.flameTicks >= 200) {
            ...
            final float f = 5.0f;
            final double d0 = this.dragon.dragonPartHead.posX + vec3d.xCoord * 5.0 / 2.0;
            final double d2 = this.dragon.dragonPartHead.posZ + vec3d.zCoord * 5.0 / 2.0;
