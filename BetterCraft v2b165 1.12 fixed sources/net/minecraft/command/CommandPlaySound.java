...
public class CommandPlaySound extends CommandBase
{
    ...
    public void execute(final MinecraftServer server, final ICommandSender sender, final String[] args) throws CommandException {
        ...
        double d2 = (args.length > i) ? CommandBase.parseDouble(vec3d.yCoord, args[i++], 0, 0, false) : vec3d.yCoord;
        double d3 = (args.length > i) ? CommandBase.parseDouble(vec3d.zCoord, args[i++], true) : vec3d.zCoord;
