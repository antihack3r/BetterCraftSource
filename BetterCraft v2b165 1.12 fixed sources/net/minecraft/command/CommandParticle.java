...
public class CommandParticle extends CommandBase
{
    ...
    public void execute(final MinecraftServer server, final ICommandSender sender, final String[] args) throws CommandException {
        ...
        final double d0 = (float)CommandBase.parseDouble(vec3d.xCoord, args[1], true);
        final double d2 = (float)CommandBase.parseDouble(vec3d.yCoord, args[2], true);
        final double d3 = (float)CommandBase.parseDouble(vec3d.zCoord, args[3], true);
    ...
    public List<String> getTabCompletionOptions(final MinecraftServer server, final ICommandSender sender, final String[] args, @Nullable final BlockPos pos) {
        ...
        return (args.length == 11) ? CommandBase.getListOfStringsMatchingLastWord(args, server.getAllUsernames()) : Collections.emptyList();
    }
