...
public abstract class CommandBase implements ICommand
{
    ...
    public static List<Entity> getEntityList(final MinecraftServer server, final ICommandSender sender, final String target) throws EntityNotFoundException, CommandException {
        return EntitySelector.hasArguments(target) ? EntitySelector.matchEntities(sender, target, (Class<? extends Entity>)Entity.class) : Lists.newArrayList(getEntity(server, sender, target));
    }
    ...
    private static Map<IProperty<?>, Comparable<?>> func_190795_c(final Block p_190795_0_, final String p_190795_1_) throws InvalidBlockStateException {
        ...
        for (final String s : CommandBase.field_190796_b.split(p_190795_1_)) {
            final Iterator<String> iterator2 = CommandBase.field_190797_c.split(s).iterator();
    ...
    public static List<String> getListOfStringsMatchingLastWord(final String[] inputArgs, final Collection<?> possibleCompletions) {
        ...
        if (!possibleCompletions.isEmpty()) {
            for (final String s2 : Iterables.transform((Iterable<?>)possibleCompletions, (Function<?, ? extends String>)Functions.toStringFunction())) {
