...
public class ShaderManager
{
    ...
    private void setupUniforms() {
        for (int i = 0, j = 0; i < this.samplerNames.size(); ++i, ++j) {
            ...
            if (k == -1) {
                ShaderManager.LOGGER.warn("Shader {}could not find sampler named {} in the specified shader program.", this.programFilename, s);
        ...
        for (final ShaderUniform shaderuniform : this.shaderUniforms) {
            ...
            if (l == -1) {
                ShaderManager.LOGGER.warn("Could not find uniform named {} in the specified shader program.", s2);
            }
            else {
