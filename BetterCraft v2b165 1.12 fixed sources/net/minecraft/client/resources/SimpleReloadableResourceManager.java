...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    public void reloadResources(final List<IResourcePack> resourcesPacksList) {
        this.clearResources();
        SimpleReloadableResourceManager.LOGGER.info("Reloading ResourceManager: {}", SimpleReloadableResourceManager.JOINER_RESOURCE_PACKS.join(Iterables.transform((Iterable<IResourcePack>)resourcesPacksList, (Function<? super IResourcePack, ?>)new Function<IResourcePack, String>() {
            @Override
