...
public class ModelLlama extends ModelQuadruped
{
    ...
    public ModelLlama(final float p_i47226_1_) {
        ...
        (this.field_191226_i = new ModelRenderer(this, 45, 28)).addBox(-3.0f, 0.0f, 0.0f, 8, 8, 3, p_i47226_1_);
        this.field_191226_i.setRotationPoint(-8.5f, 3.0f, 3.0f);
        this.field_191226_i.rotateAngleY = 1.5707964f;
        (this.field_191227_j = new ModelRenderer(this, 45, 41)).addBox(-3.0f, 0.0f, 0.0f, 8, 8, 3, p_i47226_1_);
    ...
    public void render(final Entity entityIn, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        ...
        final boolean flag = !abstractchesthorse.isChild() && abstractchesthorse.func_190695_dh();
