...
public class ModelHorse extends ModelBase
{
    ...
    public void render(final Entity entityIn, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        ...
        final boolean flag4 = !flag && flag3 && ((AbstractChestHorse)abstracthorse).func_190695_dh();
    ...
    public void setLivingAnimations(final EntityLivingBase entitylivingbaseIn, final float p_78086_2_, final float p_78086_3_, final float partialTickTime) {
        ...
        this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin(1.5707964f + f13 + f8 * -f11 * 0.5f * p_78086_3_) * 7.0f;
        this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + MathHelper.cos(-1.5707964f + f13 + f8 * -f11 * 0.5f * p_78086_3_) * 7.0f;
        this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin(1.5707964f + f13 + f8 * f11 * 0.5f * p_78086_3_) * 7.0f;
        this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + MathHelper.cos(-1.5707964f + f13 + f8 * f11 * 0.5f * p_78086_3_) * 7.0f;
        ...
        this.backLeftLeg.rotateAngleX = f13 + -f11 * 0.5f * p_78086_3_ * f8;
        ...
        this.backRightLeg.rotateAngleX = f13 + f11 * 0.5f * p_78086_3_ * f8;
        ...
        this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + 3.1415927f * Math.max(0.0f, 0.2f + f14 * 0.2f)) * f7 + (f12 + Math.max(0.0f, f11 * 0.5f * p_78086_3_)) * f8;
        this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX;
        this.frontRightLeg.rotateAngleX = f16;
        this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + 3.1415927f * Math.max(0.0f, 0.2f - f14 * 0.2f)) * f7 + (-f12 + Math.max(0.0f, -f11 * 0.5f * p_78086_3_)) * f8;
        ...
        f13 = -1.3089969f + p_78086_3_ * 1.5f;
        if (f13 > 0.0f) {
            f13 = 0.0f;
        }
        if (flag) {
