...
public class BlockColors
{
    ...
    public int getColor(final IBlockState p_189991_1_, final World p_189991_2_, final BlockPos p_189991_3_) {
        final IBlockColor iblockcolor = this.mapBlockColors.getByValue(Block.getIdFromBlock(p_189991_1_.getBlock()));
        if (iblockcolor != null) {
            return iblockcolor.colorMultiplier(p_189991_1_, null, null, 0);
        }
        final MapColor mapcolor = p_189991_1_.getMapColor(p_189991_2_, p_189991_3_);
