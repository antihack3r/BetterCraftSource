...
public class Selector
{
    ...
    public static class Deserializer implements JsonDeserializer<Selector>
    {
        ...
        static {
            FUNCTION_OR_AND = new Function<JsonElement, ICondition>() {
                @Nullable
                @Override
            ...
            FUNCTION_PROPERTY_VALUE = new Function<Map.Entry<String, JsonElement>, ICondition>() {
                @Nullable
                @Override
        ...
        static ICondition getOrAndCondition(final JsonObject json) {
            ...
            if (set.size() != 1) {
                return new ConditionAnd(Iterables.transform((Iterable<Map.Entry<String, JsonElement>>)set, (Function<? super Map.Entry<String, JsonElement>, ? extends ICondition>)Deserializer.FUNCTION_PROPERTY_VALUE));
            }
            if (json.has("OR")) {
                return new ConditionOr(Iterables.transform((Iterable<Object>)JsonUtils.getJsonArray(json, "OR"), (Function<? super Object, ? extends ICondition>)Deserializer.FUNCTION_OR_AND));
            }
            return json.has("AND") ? new ConditionAnd(Iterables.transform((Iterable<Object>)JsonUtils.getJsonArray(json, "AND"), (Function<? super Object, ? extends ICondition>)Deserializer.FUNCTION_OR_AND)) : makePropertyValue(set.iterator().next());
        }
