...
public class RenderManager
{
    ...
    public void renderEntityStatic(final Entity entityIn, final float partialTicks, final boolean p_188388_3_) {
        ...
        this.doRenderEntity(entityIn, d0 - RenderManager.renderPosX, d2 - RenderManager.renderPosY, d3 - RenderManager.renderPosZ, f, partialTicks, p_188388_3_);
    }
    ...
    public void renderMultipass(final Entity p_188389_1_, final float p_188389_2_) {
        ...
        if (render != null && this.renderEngine != null) {
            render.renderMultipass(p_188389_1_, d0 - RenderManager.renderPosX, d2 - RenderManager.renderPosY, d3 - RenderManager.renderPosZ, f, p_188389_2_);
        }
    }
    ...
    private void renderDebugBoundingBox(final Entity entityIn, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (aentity != null) {
            ...
            for (int length = (array = aentity).length, i = 0; i < length; ++i) {
                ...
                RenderGlobal.drawBoundingBox(axisalignedbb2.minX - RenderManager.renderPosX + d0, axisalignedbb2.minY - RenderManager.renderPosY + d2, axisalignedbb2.minZ - RenderManager.renderPosZ + d3, axisalignedbb2.maxX - RenderManager.renderPosX + d0, axisalignedbb2.maxY - RenderManager.renderPosY + d2, axisalignedbb2.maxZ - RenderManager.renderPosZ + d3, 0.25f, 1.0f, 0.0f, 1.0f);
            }
        }
