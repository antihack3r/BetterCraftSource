...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void initGui() {
        ...
        this.nextPage = this.addButton(new GuiButton(303, GuiCustomizeWorldScreen.width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next", new Object[0])));
        this.defaults = this.addButton(new GuiButton(304, GuiCustomizeWorldScreen.width / 2 - 187, GuiCustomizeWorldScreen.height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults", new Object[0])));
        this.randomize = this.addButton(new GuiButton(301, GuiCustomizeWorldScreen.width / 2 - 92, GuiCustomizeWorldScreen.height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize", new Object[0])));
        this.presets = this.addButton(new GuiButton(305, GuiCustomizeWorldScreen.width / 2 + 3, GuiCustomizeWorldScreen.height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets", new Object[0])));
        this.done = this.addButton(new GuiButton(300, GuiCustomizeWorldScreen.width / 2 + 98, GuiCustomizeWorldScreen.height - 27, 90, 20, I18n.format("gui.done", new Object[0])));
        this.defaults.enabled = this.settingsModified;
        this.confirm = new GuiButton(306, GuiCustomizeWorldScreen.width / 2 - 55, 160, 50, 20, I18n.format("gui.yes", new Object[0]));
        this.confirm.visible = false;
        this.buttonList.add(this.confirm);
        this.cancel = new GuiButton(307, GuiCustomizeWorldScreen.width / 2 + 5, 160, 50, 20, I18n.format("gui.no", new Object[0]));
    ...
    private void createPagedList() {
        ...
        this.list = new GuiPageButtonList(this.mc, GuiCustomizeWorldScreen.width, GuiCustomizeWorldScreen.height, 32, GuiCustomizeWorldScreen.height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][] { aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3, aguipagebuttonlist$guilistentry4 });
        for (int i = 0; i < 4; ++i) {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.title, GuiCustomizeWorldScreen.width / 2, 2, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, this.subtitle, GuiCustomizeWorldScreen.width / 2, 12, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, this.pageTitle, GuiCustomizeWorldScreen.width / 2, 22, 16777215);
        ...
        if (this.confirmMode != 0) {
            ...
            bufferbuilder.pos(GuiCustomizeWorldScreen.width / 2 - 90, 185.0, 0.0).tex(0.0, 2.65625).color(64, 64, 64, 64).endVertex();
            bufferbuilder.pos(GuiCustomizeWorldScreen.width / 2 + 90, 185.0, 0.0).tex(5.625, 2.65625).color(64, 64, 64, 64).endVertex();
            bufferbuilder.pos(GuiCustomizeWorldScreen.width / 2 + 90, 100.0, 0.0).tex(5.625, 0.0).color(64, 64, 64, 64).endVertex();
            bufferbuilder.pos(GuiCustomizeWorldScreen.width / 2 - 90, 100.0, 0.0).tex(0.0, 0.0).color(64, 64, 64, 64).endVertex();
            tessellator.draw();
