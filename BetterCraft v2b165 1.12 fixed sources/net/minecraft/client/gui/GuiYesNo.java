...
public class GuiYesNo extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.listLines.addAll(this.fontRendererObj.listFormattedStringToWidth(this.messageLine2, GuiYesNo.width - 50));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        for (final String s : this.listLines) {
            Gui.drawCenteredString(this.fontRendererObj, s, GuiYesNo.width / 2, i, 16777215);
