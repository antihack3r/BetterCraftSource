...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawString(this.fontRendererObj, s, 2, GuiVideoSettings.height - 10, 8421504);
        final String s3 = "Minecraft 1.12.2";
        final int i = this.fontRendererObj.getStringWidth(s3);
        Gui.drawString(this.fontRendererObj, s3, GuiVideoSettings.width - i - 2, GuiVideoSettings.height - 10, 8421504);
