...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.export = new GuiTextField(2, this.fontRendererObj, 50, 40, GuiScreenCustomizePresets.width - 100, 20);
        this.list = new ListPreset();
        this.export.setMaxStringLength(2000);
        this.export.setText(this.parent.saveValues());
        this.select = this.addButton(new GuiButton(0, GuiScreenCustomizePresets.width / 2 - 102, GuiScreenCustomizePresets.height - 27, 100, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.title, GuiScreenCustomizePresets.width / 2, 8, 16777215);
        Gui.drawString(this.fontRendererObj, this.shareText, 50, 30, 10526880);
