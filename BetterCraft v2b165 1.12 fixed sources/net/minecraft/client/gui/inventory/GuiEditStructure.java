...
public class GuiEditStructure extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.doneButton = this.addButton(new GuiButton(0, GuiEditStructure.width / 2 - 4 - 150, 210, 150, 20, I18n.format("gui.done", new Object[0])));
        this.cancelButton = this.addButton(new GuiButton(1, GuiEditStructure.width / 2 + 4, 210, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.saveButton = this.addButton(new GuiButton(9, GuiEditStructure.width / 2 + 4 + 100, 185, 50, 20, I18n.format("structure_block.button.save", new Object[0])));
        this.loadButton = this.addButton(new GuiButton(10, GuiEditStructure.width / 2 + 4 + 100, 185, 50, 20, I18n.format("structure_block.button.load", new Object[0])));
        this.modeButton = this.addButton(new GuiButton(18, GuiEditStructure.width / 2 - 4 - 150, 185, 50, 20, "MODE"));
        this.detectSizeButton = this.addButton(new GuiButton(19, GuiEditStructure.width / 2 + 4 + 100, 120, 50, 20, I18n.format("structure_block.button.detect_size", new Object[0])));
        this.showEntitiesButton = this.addButton(new GuiButton(20, GuiEditStructure.width / 2 + 4 + 100, 160, 50, 20, "ENTITIES"));
        this.mirrorButton = this.addButton(new GuiButton(21, GuiEditStructure.width / 2 - 20, 185, 40, 20, "MIRROR"));
        this.showAirButton = this.addButton(new GuiButton(22, GuiEditStructure.width / 2 + 4 + 100, 80, 50, 20, "SHOWAIR"));
        this.showBoundingBoxButton = this.addButton(new GuiButton(23, GuiEditStructure.width / 2 + 4 + 100, 80, 50, 20, "SHOWBB"));
        this.rotateZeroDegreesButton = this.addButton(new GuiButton(11, GuiEditStructure.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, "0"));
        this.rotateNinetyDegreesButton = this.addButton(new GuiButton(12, GuiEditStructure.width / 2 - 1 - 40 - 20, 185, 40, 20, "90"));
        this.rotate180DegreesButton = this.addButton(new GuiButton(13, GuiEditStructure.width / 2 + 1 + 20, 185, 40, 20, "180"));
        this.rotate270DegressButton = this.addButton(new GuiButton(14, GuiEditStructure.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, "270"));
        (this.nameEdit = new GuiTextField(2, this.fontRendererObj, GuiEditStructure.width / 2 - 152, 40, 300, 20)).setMaxStringLength(64);
        ...
        (this.posXEdit = new GuiTextField(3, this.fontRendererObj, GuiEditStructure.width / 2 - 152, 80, 80, 20)).setMaxStringLength(15);
        this.posXEdit.setText(Integer.toString(blockpos.getX()));
        this.tabOrder.add(this.posXEdit);
        (this.posYEdit = new GuiTextField(4, this.fontRendererObj, GuiEditStructure.width / 2 - 72, 80, 80, 20)).setMaxStringLength(15);
        this.posYEdit.setText(Integer.toString(blockpos.getY()));
        this.tabOrder.add(this.posYEdit);
        (this.posZEdit = new GuiTextField(5, this.fontRendererObj, GuiEditStructure.width / 2 + 8, 80, 80, 20)).setMaxStringLength(15);
        ...
        (this.sizeXEdit = new GuiTextField(6, this.fontRendererObj, GuiEditStructure.width / 2 - 152, 120, 80, 20)).setMaxStringLength(15);
        this.sizeXEdit.setText(Integer.toString(blockpos2.getX()));
        this.tabOrder.add(this.sizeXEdit);
        (this.sizeYEdit = new GuiTextField(7, this.fontRendererObj, GuiEditStructure.width / 2 - 72, 120, 80, 20)).setMaxStringLength(15);
        this.sizeYEdit.setText(Integer.toString(blockpos2.getY()));
        this.tabOrder.add(this.sizeYEdit);
        (this.sizeZEdit = new GuiTextField(8, this.fontRendererObj, GuiEditStructure.width / 2 + 8, 120, 80, 20)).setMaxStringLength(15);
        this.sizeZEdit.setText(Integer.toString(blockpos2.getZ()));
        this.tabOrder.add(this.sizeZEdit);
        (this.integrityEdit = new GuiTextField(15, this.fontRendererObj, GuiEditStructure.width / 2 - 152, 120, 80, 20)).setMaxStringLength(15);
        this.integrityEdit.setText(this.decimalFormat.format(this.tileStructure.getIntegrity()));
        this.tabOrder.add(this.integrityEdit);
        (this.seedEdit = new GuiTextField(16, this.fontRendererObj, GuiEditStructure.width / 2 - 72, 120, 80, 20)).setMaxStringLength(31);
        this.seedEdit.setText(Long.toString(this.tileStructure.getSeed()));
        this.tabOrder.add(this.seedEdit);
        (this.dataEdit = new GuiTextField(17, this.fontRendererObj, GuiEditStructure.width / 2 - 152, 120, 240, 20)).setMaxStringLength(128);
    ...
    private boolean sendToServer(final int p_189820_1_) {
        try {
            ...
            GuiEditStructure.LOGGER.warn("Could not send structure block info", exception);
            return false;
        }
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("tile.structureBlock.name", new Object[0]), GuiEditStructure.width / 2, 10, 16777215);
        if (tileentitystructure$mode != TileEntityStructure.Mode.DATA) {
            Gui.drawString(this.fontRendererObj, I18n.format("structure_block.structure_name", new Object[0]), GuiEditStructure.width / 2 - 153, 30, 10526880);
        ...
        if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD || tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
            Gui.drawString(this.fontRendererObj, I18n.format("structure_block.position", new Object[0]), GuiEditStructure.width / 2 - 153, 70, 10526880);
            ...
            Gui.drawString(this.fontRendererObj, s, GuiEditStructure.width / 2 + 154 - i, 150, 10526880);
        }
        if (tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
            Gui.drawString(this.fontRendererObj, I18n.format("structure_block.size", new Object[0]), GuiEditStructure.width / 2 - 153, 110, 10526880);
            ...
            Gui.drawString(this.fontRendererObj, s2, GuiEditStructure.width / 2 + 154 - k, 110, 10526880);
            final String s3 = I18n.format("structure_block.show_air", new Object[0]);
            final int j = this.fontRendererObj.getStringWidth(s3);
            Gui.drawString(this.fontRendererObj, s3, GuiEditStructure.width / 2 + 154 - j, 70, 10526880);
        }
        if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
            Gui.drawString(this.fontRendererObj, I18n.format("structure_block.integrity", new Object[0]), GuiEditStructure.width / 2 - 153, 110, 10526880);
            ...
            Gui.drawString(this.fontRendererObj, s4, GuiEditStructure.width / 2 + 154 - l, 70, 10526880);
        }
        if (tileentitystructure$mode == TileEntityStructure.Mode.DATA) {
            Gui.drawString(this.fontRendererObj, I18n.format("structure_block.custom_data", new Object[0]), GuiEditStructure.width / 2 - 153, 110, 10526880);
            this.dataEdit.drawTextBox();
        }
        final String s5 = "structure_block.mode_info." + tileentitystructure$mode.getName();
        Gui.drawString(this.fontRendererObj, I18n.format(s5, new Object[0]), GuiEditStructure.width / 2 - 153, 174, 10526880);
