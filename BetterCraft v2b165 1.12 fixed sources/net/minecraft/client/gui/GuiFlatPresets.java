...
public class GuiFlatPresets extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.export = new GuiTextField(2, this.fontRendererObj, 50, 40, GuiFlatPresets.width - 100, 20);
        this.list = new ListSlot();
        this.export.setMaxStringLength(1230);
        this.export.setText(this.parentScreen.getPreset());
        this.btnSelect = this.addButton(new GuiButton(0, GuiFlatPresets.width / 2 - 155, GuiFlatPresets.height - 28, 150, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.presetsTitle, GuiFlatPresets.width / 2, 8, 16777215);
        Gui.drawString(this.fontRendererObj, this.presetsShare, 50, 30, 10526880);
        Gui.drawString(this.fontRendererObj, this.listText, 50, 70, 10526880);
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void blitSlotIcon(final int p_148171_1_, final int p_148171_2_, final int p_148171_3_, final int p_148171_4_) {
            ...
            bufferbuilder.pos(p_148171_1_ + 0, p_148171_2_ + 18, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            bufferbuilder.pos(p_148171_1_ + 18, p_148171_2_ + 18, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            bufferbuilder.pos(p_148171_1_ + 18, p_148171_2_ + 0, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            bufferbuilder.pos(p_148171_1_ + 0, p_148171_2_ + 0, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            tessellator.draw();
        }
