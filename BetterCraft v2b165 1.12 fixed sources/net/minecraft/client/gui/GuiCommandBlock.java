...
public class GuiCommandBlock extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui() {
        ...
        this.doneBtn = this.addButton(new GuiButton(0, GuiCommandBlock.width / 2 - 4 - 150, GuiCommandBlock.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
        this.cancelBtn = this.addButton(new GuiButton(1, GuiCommandBlock.width / 2 + 4, GuiCommandBlock.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.outputBtn = this.addButton(new GuiButton(4, GuiCommandBlock.width / 2 + 150 - 20, 135, 20, 20, "O"));
        this.modeBtn = this.addButton(new GuiButton(5, GuiCommandBlock.width / 2 - 50 - 100 - 4, 165, 100, 20, I18n.format("advMode.mode.sequence", new Object[0])));
        this.conditionalBtn = this.addButton(new GuiButton(6, GuiCommandBlock.width / 2 - 50, 165, 100, 20, I18n.format("advMode.mode.unconditional", new Object[0])));
        this.autoExecBtn = this.addButton(new GuiButton(7, GuiCommandBlock.width / 2 + 50 + 4, 165, 100, 20, I18n.format("advMode.mode.redstoneTriggered", new Object[0])));
        (this.commandTextField = new GuiTextField(2, this.fontRendererObj, GuiCommandBlock.width / 2 - 150, 50, 300, 20)).setMaxStringLength(32500);
        this.commandTextField.setFocused(true);
        (this.previousOutputTextField = new GuiTextField(3, this.fontRendererObj, GuiCommandBlock.width / 2 - 150, 135, 276, 20)).setMaxStringLength(32500);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawString(this.fontRendererObj, I18n.format("advMode.command", new Object[0]), GuiCommandBlock.width / 2 - 150, 40, 10526880);
        this.commandTextField.drawTextBox();
        int i = 75;
        int j = 0;
        Gui.drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), GuiCommandBlock.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        Gui.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), GuiCommandBlock.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        Gui.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), GuiCommandBlock.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        Gui.drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), GuiCommandBlock.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        Gui.drawString(this.fontRendererObj, I18n.format("advMode.self", new Object[0]), GuiCommandBlock.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        if (!this.previousOutputTextField.getText().isEmpty()) {
            i = i + j * this.fontRendererObj.FONT_HEIGHT + 1;
            Gui.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), GuiCommandBlock.width / 2 - 150, i + 4, 10526880);
