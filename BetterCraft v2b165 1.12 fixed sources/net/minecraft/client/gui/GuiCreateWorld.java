...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.btnGameMode = this.addButton(new GuiButton(2, GuiCreateWorld.width / 2 - 75, 115, 150, 20, I18n.format("selectWorld.gameMode", new Object[0])));
        this.btnMoreOptions = this.addButton(new GuiButton(3, GuiCreateWorld.width / 2 - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions", new Object[0])));
        this.btnMapFeatures = this.addButton(new GuiButton(4, GuiCreateWorld.width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures", new Object[0])));
        this.btnMapFeatures.visible = false;
        this.btnBonusItems = this.addButton(new GuiButton(7, GuiCreateWorld.width / 2 + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems", new Object[0])));
        this.btnBonusItems.visible = false;
        this.btnMapType = this.addButton(new GuiButton(5, GuiCreateWorld.width / 2 + 5, 100, 150, 20, I18n.format("selectWorld.mapType", new Object[0])));
        this.btnMapType.visible = false;
        this.btnAllowCommands = this.addButton(new GuiButton(6, GuiCreateWorld.width / 2 - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands", new Object[0])));
        this.btnAllowCommands.visible = false;
        this.btnCustomizeType = this.addButton(new GuiButton(8, GuiCreateWorld.width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.inMoreWorldOptionsDisplay) {
            Gui.drawString(this.fontRendererObj, I18n.format("selectWorld.enterSeed", new Object[0]), GuiCreateWorld.width / 2 - 100, 47, -6250336);
            Gui.drawString(this.fontRendererObj, I18n.format("selectWorld.seedInfo", new Object[0]), GuiCreateWorld.width / 2 - 100, 85, -6250336);
            if (this.btnMapFeatures.visible) {
                Gui.drawString(this.fontRendererObj, I18n.format("selectWorld.mapFeatures.info", new Object[0]), GuiCreateWorld.width / 2 - 150, 122, -6250336);
            }
            if (this.btnAllowCommands.visible) {
                Gui.drawString(this.fontRendererObj, I18n.format("selectWorld.allowCommands.info", new Object[0]), GuiCreateWorld.width / 2 - 150, 172, -6250336);
            }
            ...
            Gui.drawString(this.fontRendererObj, I18n.format("selectWorld.enterName", new Object[0]), GuiCreateWorld.width / 2 - 100, 47, -6250336);
            Gui.drawString(this.fontRendererObj, String.valueOf(I18n.format("selectWorld.resultFolder", new Object[0])) + " " + this.saveDirName, GuiCreateWorld.width / 2 - 100, 85, -6250336);
            this.worldNameField.drawTextBox();
            Gui.drawString(this.fontRendererObj, this.gameModeDesc1, GuiCreateWorld.width / 2 - 100, 137, -6250336);
            Gui.drawString(this.fontRendererObj, this.gameModeDesc2, GuiCreateWorld.width / 2 - 100, 149, -6250336);
        }
