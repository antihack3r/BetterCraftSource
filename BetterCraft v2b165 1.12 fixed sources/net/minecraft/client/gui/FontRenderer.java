...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawString(final String text, final double e, final double d, final int color) {
        return this.enabled ? this.drawString(text, (float)e, (float)d, color, false) : 0;
    }
    ...
    public void setColor(final float p_setColor_1_, final float p_setColor_2_, final float p_setColor_3_, final float p_setColor_4_) {
