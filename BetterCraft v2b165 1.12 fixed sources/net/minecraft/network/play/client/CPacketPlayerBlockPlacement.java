...
public class CPacketPlayerBlockPlacement implements Packet<INetHandlerPlayServer>
{
    ...
    public CPacketPlayerBlockPlacement(final ItemStack stackIn) {
        this(CPacketPlayerBlockPlacement.field_179726_a, 255, stackIn, 0.0f, 0.0f, 0.0f);
    }
    
    public CPacketPlayerBlockPlacement(final BlockPos positionIn, final int placedBlockDirectionIn, final ItemStack stackIn, final float facingXIn, final float facingYIn, final float facingZIn) {
