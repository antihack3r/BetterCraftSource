...
public class SignStrictJSON implements IFixableData
{
    ...
    static {
        GSON_INSTANCE = new GsonBuilder().registerTypeAdapter(ITextComponent.class, new JsonDeserializer<ITextComponent>() {
            @Override
            public ITextComponent deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
                ...
                if (p_deserialize_1_.isJsonArray()) {
                    ...
                    for (final JsonElement jsonelement : jsonarray) {
                        final ITextComponent itextcomponent2 = this.deserialize(jsonelement, (Type)jsonelement.getClass(), p_deserialize_3_);
