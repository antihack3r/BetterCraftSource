...
public abstract class TextComponentBase implements ITextComponent
{
    ...
    public Iterator<ITextComponent> iterator() {
        return Iterators.concat((Iterator<? extends ITextComponent>)Iterators.forArray(this), (Iterator<? extends ITextComponent>)createDeepCopyIterator(this.siblings));
    }
    ...
    public static Iterator<ITextComponent> createDeepCopyIterator(final Iterable<ITextComponent> components) {
        Iterator<ITextComponent> iterator = Iterators.concat(Iterators.transform(components.iterator(), (Function<? super ITextComponent, ? extends Iterator<? extends ITextComponent>>)new Function<ITextComponent, Iterator<ITextComponent>>() {
            @Override
            public Iterator<ITextComponent> apply(@Nullable final ITextComponent p_apply_1_) {
                return p_apply_1_.iterator();
            }
        }));
        iterator = Iterators.transform(iterator, (Function<? super ITextComponent, ? extends ITextComponent>)new Function<ITextComponent, ITextComponent>() {
            @Override
