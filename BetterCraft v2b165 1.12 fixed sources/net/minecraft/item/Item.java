...
import me.amkgre.bettercraft.client.mods.creative.InventorySection;
...
public class Item
{
    ...
    public final void addPropertyOverride(final ResourceLocation key, final IItemPropertyGetter getter2) {
        this.properties.putObject(key, getter2);
    }
    ...
    public String getItemStackDisplayName(final ItemStack stack) {
        return I18n.translateToLocal(String.valueOf(String.valueOf(this.getUnlocalizedNameInefficiently(stack))) + ".name").trim();
    }
    ...
    public static void getSubItems(final InventorySection itemIn, final NonNullList<ItemStack> tab) {
        for (final InventoryItem a : Client.getInstance().getInventoryManager().items) {
            if (a.getSection() != itemIn) {
                continue;
            }
            tab.add(a.getItem());
        }
