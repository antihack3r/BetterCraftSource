...
public abstract class ConcurrentSequencedCircularArrayQueue<E> extends ConcurrentCircularArrayQueue<E>
{
    ...
    public ConcurrentSequencedCircularArrayQueue(final int capacity) {
        ...
        this.sequenceBuffer = new long[actualCapacity + ConcurrentSequencedCircularArrayQueue.SEQ_BUFFER_PAD * 2];
    ...
    protected static long calcSequenceOffset(final long index, final long mask) {
