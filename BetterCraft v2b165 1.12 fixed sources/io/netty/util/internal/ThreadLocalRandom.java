...
public final class ThreadLocalRandom extends Random
{
    ...
    static {
        ...
        ThreadLocalRandom.initialSeedUniquifier = AccessController.doPrivileged((PrivilegedAction<Long>)new PrivilegedAction<Long>() {
            @Override
            public Long run() {
        ...
        if (ThreadLocalRandom.initialSeedUniquifier == 0L) {
            final boolean secureRandom = AccessController.doPrivileged((PrivilegedAction<Boolean>)new PrivilegedAction<Boolean>() {
                @Override
                public Boolean run() {
