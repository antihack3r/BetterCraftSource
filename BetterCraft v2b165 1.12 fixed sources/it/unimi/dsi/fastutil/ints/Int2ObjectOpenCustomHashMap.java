...
public class Int2ObjectOpenCustomHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    public Int2ObjectOpenCustomHashMap(final int expected, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2ObjectOpenCustomHashMap(final int expected, final IntHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Int2ObjectOpenCustomHashMap(final IntHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Int2ObjectOpenCustomHashMap(final Map<? extends Integer, ? extends V> m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2ObjectOpenCustomHashMap(final Map<? extends Integer, ? extends V> m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2ObjectOpenCustomHashMap(final Int2ObjectMap<V> m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll((Map<? extends Integer, ? extends V>)m);
    }
    
    public Int2ObjectOpenCustomHashMap(final Int2ObjectMap<V> m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2ObjectOpenCustomHashMap(final int[] k, final V[] v, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2ObjectOpenCustomHashMap(final int[] k, final V[] v, final IntHash.Strategy strategy) {
    ...
    final class MapEntry implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
    {
        ...
        public V setValue(final V v) {
            final V oldValue = Int2ObjectOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Int2ObjectOpenCustomHashMap.this.value[this.index] != null) ? Int2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask); !Int2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Int2ObjectOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2ObjectOpenCustomHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2ObjectOpenCustomHashMap.this.mask;
                    Label_0121: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0121;
        ...
        public void remove() {
            ...
            final Int2ObjectOpenCustomHashMap this$0 = Int2ObjectOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2ObjectOpenCustomHashMap.this.containsNullKey && ((Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.n] != null) ? Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final int[] key = Int2ObjectOpenCustomHashMap.this.key;
            int pos;
            int curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
                if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                    if (Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Int2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Int2ObjectOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Int2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
    ...
    private final class KeySet extends AbstractIntSet
    {
        ...
        public boolean rem(final int k) {
            final int oldSize = Int2ObjectOpenCustomHashMap.this.size;
