...
public class Int2DoubleOpenHashMap extends AbstractInt2DoubleMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Int2DoubleMap.Entry, Map.Entry<Integer, Double>
    {
        ...
        public double setValue(final double v) {
            final double oldValue = Int2DoubleOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2DoubleOpenHashMap.this.key[this.index] == e.getKey() && Int2DoubleOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(k) & Int2DoubleOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Int2DoubleOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2DoubleOpenHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Int2DoubleOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Int2DoubleOpenHashMap this$0 = Int2DoubleOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry> implements Int2DoubleMap.FastEntrySet
    {
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                ...
                if (curr != k) {
                    while ((curr = key[pos = (pos + 1 & Int2DoubleOpenHashMap.this.mask)]) != 0) {
                        if (curr == k && Int2DoubleOpenHashMap.this.value[pos] == v) {
    ...
    private final class KeySet extends AbstractIntSet
    {
        ...
        public boolean rem(final int k) {
            final int oldSize = Int2DoubleOpenHashMap.this.size;
