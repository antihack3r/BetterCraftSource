...
public class Int2ByteOpenCustomHashMap extends AbstractInt2ByteMap implements Serializable, Cloneable, Hash
{
    ...
    public Int2ByteOpenCustomHashMap(final int expected, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2ByteOpenCustomHashMap(final int expected, final IntHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Int2ByteOpenCustomHashMap(final IntHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Int2ByteOpenCustomHashMap(final Map<? extends Integer, ? extends Byte> m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2ByteOpenCustomHashMap(final Map<? extends Integer, ? extends Byte> m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2ByteOpenCustomHashMap(final Int2ByteMap m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2ByteOpenCustomHashMap(final Int2ByteMap m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2ByteOpenCustomHashMap(final int[] k, final byte[] v, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2ByteOpenCustomHashMap(final int[] k, final byte[] v, final IntHash.Strategy strategy) {
    ...
    final class MapEntry implements Int2ByteMap.Entry, Map.Entry<Integer, Byte>
    {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Int2ByteOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[this.index], e.getKey()) && Int2ByteOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask); !Int2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Int2ByteOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2ByteOpenCustomHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2ByteOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Int2ByteOpenCustomHashMap this$0 = Int2ByteOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractIntSet
    {
        ...
        public boolean rem(final int k) {
            final int oldSize = Int2ByteOpenCustomHashMap.this.size;
