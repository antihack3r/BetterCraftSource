    ...
    public static class Singleton extends Int2BooleanFunctions.Singleton implements Int2BooleanMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Int2BooleanMap.Entry, Map.Entry<Integer, Boolean>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Integer && e.getValue() != null && e.getValue() instanceof Boolean && Singleton.this.key == (int)e.getKey() && Singleton.this.value == (boolean)e.getValue();
            }
