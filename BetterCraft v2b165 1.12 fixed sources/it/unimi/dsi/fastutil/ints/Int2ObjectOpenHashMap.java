...
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ObjectOpenHashMap.this.key[this.index] == e.getKey() && ((Int2ObjectOpenHashMap.this.value[this.index] != null) ? Int2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == 0) {
                return Int2ObjectOpenHashMap.this.containsNullKey && ((Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n] != null) ? Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n].equals(v) : (v == null));
            }
            final int[] key = Int2ObjectOpenHashMap.this.key;
            int pos;
            int curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                if (Int2ObjectOpenHashMap.this.containsNullKey) {
                    if (Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Int2ObjectOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Int2ObjectOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
