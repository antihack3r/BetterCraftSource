...
public class Int2DoubleRBTreeMap extends AbstractInt2DoubleSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof IntComparator) {
            ...
            this.actualComparator = new IntComparator() {
                ...
                public int compare(final int k1, final int k2) {
                    return Int2DoubleRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Double put(final Integer ok, final Double ov) {
        final double oldValue = this.put((int)ok, (double)ov);
    ...
    public Double remove(final Object ok) {
        final double oldValue = this.remove((int)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2DoubleRBTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2DoubleRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2DoubleSortedMap implements Serializable
    {
        ...
        protected transient IntSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Int2DoubleRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2DoubleRBTreeMap.Entry f = Int2DoubleRBTreeMap.this.findKey((int)e.getKey());
        ...
        @Override
        public int firstIntKey() {
            final Int2DoubleRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public int lastIntKey() {
            final Int2DoubleRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2DoubleRBTreeMap this$0 = submap.this$0;
                            final Int2DoubleRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
