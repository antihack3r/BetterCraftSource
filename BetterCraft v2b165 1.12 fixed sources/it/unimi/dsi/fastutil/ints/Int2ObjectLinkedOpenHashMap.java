...
public class Int2ObjectLinkedOpenHashMap<V> extends AbstractInt2ObjectSortedMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ObjectLinkedOpenHashMap.this.key[this.index] == e.getKey() && ((Int2ObjectLinkedOpenHashMap.this.value[this.index] != null) ? Int2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Int2ObjectMap.Entry<V>> implements Int2ObjectSortedMap.FastSortedEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == 0) {
                return Int2ObjectLinkedOpenHashMap.this.containsNullKey && ((Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n] != null) ? Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n].equals(v) : (v == null));
            }
            final int[] key = Int2ObjectLinkedOpenHashMap.this.key;
            int pos;
            int curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                if (Int2ObjectLinkedOpenHashMap.this.containsNullKey) {
                    if (Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Int2ObjectLinkedOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Int2ObjectLinkedOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
