...
public class Int2CharOpenCustomHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Int2CharMap.Entry, Map.Entry<Integer, Character>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2CharOpenCustomHashMap.this.strategy.equals(Int2CharOpenCustomHashMap.this.key[this.index], e.getKey()) && Int2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
