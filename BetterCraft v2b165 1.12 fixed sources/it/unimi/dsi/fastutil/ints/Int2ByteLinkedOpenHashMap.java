...
public class Int2ByteLinkedOpenHashMap extends AbstractInt2ByteSortedMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Int2ByteMap.Entry, Map.Entry<Integer, Byte>
    {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Int2ByteLinkedOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final int from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Int2ByteLinkedOpenHashMap.this.mask; Int2ByteLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Int2ByteLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Int2ByteLinkedOpenHashMap this$0 = Int2ByteLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Int2ByteLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Int2ByteLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Int2ByteLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Int2ByteLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Int2ByteLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Int2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Int2ByteLinkedOpenHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Int2ByteLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Int2ByteMap.Entry> implements Int2ByteSortedMap.FastSortedEntrySet
    {
        ...
        @Override
        public ObjectSortedSet<Int2ByteMap.Entry> subSet(final Int2ByteMap.Entry fromElement, final Int2ByteMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Int2ByteMap.Entry> headSet(final Int2ByteMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Int2ByteMap.Entry> tailSet(final Int2ByteMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractIntSortedSet
    {
        ...
        public boolean rem(final int k) {
            final int oldSize = Int2ByteLinkedOpenHashMap.this.size;
