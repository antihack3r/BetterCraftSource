...
public class Int2BooleanRBTreeMap extends AbstractInt2BooleanSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof IntComparator) {
            ...
            this.actualComparator = new IntComparator() {
                ...
                public int compare(final int k1, final int k2) {
                    return Int2BooleanRBTreeMap.this.storedComparator.compare(k1, k2);
                }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2BooleanRBTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2BooleanRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2BooleanSortedMap implements Serializable
    {
        ...
        protected transient IntSortedSet keys;
        protected transient BooleanCollection values;
        final /* synthetic */ Int2BooleanRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey((int)e.getKey());
        ...
        @Override
        public int firstIntKey() {
            final Int2BooleanRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public int lastIntKey() {
            final Int2BooleanRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2BooleanRBTreeMap this$0 = submap.this$0;
                            final Int2BooleanRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
