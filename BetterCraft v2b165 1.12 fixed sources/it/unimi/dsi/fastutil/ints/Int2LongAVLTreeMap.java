...
public class Int2LongAVLTreeMap extends AbstractInt2LongSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof IntComparator) {
            ...
            this.actualComparator = new IntComparator() {
                ...
                public int compare(final int k1, final int k2) {
                    return Int2LongAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Long put(final Integer ok, final Long ov) {
        final long oldValue = this.put((int)ok, (long)ov);
    ...
    public Long remove(final Object ok) {
        final long oldValue = this.remove((int)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2LongAVLTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2LongSortedMap implements Serializable
    {
        ...
        protected transient IntSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Int2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2LongAVLTreeMap.Entry f = Int2LongAVLTreeMap.this.findKey((int)e.getKey());
        ...
        @Override
        public int firstIntKey() {
            final Int2LongAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public int lastIntKey() {
            final Int2LongAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2LongAVLTreeMap this$0 = submap.this$0;
                            final Int2LongAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
