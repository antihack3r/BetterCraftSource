...
public class Int2CharLinkedOpenHashMap extends AbstractInt2CharSortedMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Int2CharMap.Entry, Map.Entry<Integer, Character>
    {
        ...
        public char setValue(final char v) {
            final char oldValue = Int2CharLinkedOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final int from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Int2CharLinkedOpenHashMap.this.mask; Int2CharLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Int2CharLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Int2CharLinkedOpenHashMap this$0 = Int2CharLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Int2CharLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Int2CharLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Int2CharLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Int2CharLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Int2CharLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Int2CharLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Int2CharLinkedOpenHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Int2CharLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Int2CharMap.Entry> implements Int2CharSortedMap.FastSortedEntrySet
    {
        ...
        @Override
        public ObjectSortedSet<Int2CharMap.Entry> subSet(final Int2CharMap.Entry fromElement, final Int2CharMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Int2CharMap.Entry> headSet(final Int2CharMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Int2CharMap.Entry> tailSet(final Int2CharMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractIntSortedSet
    {
        ...
        public boolean rem(final int k) {
            final int oldSize = Int2CharLinkedOpenHashMap.this.size;
