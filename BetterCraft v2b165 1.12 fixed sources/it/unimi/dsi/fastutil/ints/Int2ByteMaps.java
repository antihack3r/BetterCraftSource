...
public class Int2ByteMaps
{
    ...
    public static Int2ByteMap singleton(final int key, final byte value) {
    ...
    public static class Singleton extends Int2ByteFunctions.Singleton implements Int2ByteMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Int2ByteMap.Entry, Map.Entry<Integer, Byte>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Integer && e.getValue() != null && e.getValue() instanceof Byte && Singleton.this.key == (int)e.getKey() && Singleton.this.value == (byte)e.getValue();
            }
