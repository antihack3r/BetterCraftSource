...
public class Byte2ObjectAVLTreeMap<V> extends AbstractByte2ObjectSortedMap<V> implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ByteComparator) {
            ...
            this.actualComparator = new ByteComparator() {
                ...
                public int compare(final byte k1, final byte k2) {
                    return Byte2ObjectAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry<V> locateKey = Byte2ObjectAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2ObjectSortedMap<V> implements Serializable
    {
        ...
        protected transient ByteSortedSet keys;
        protected transient ObjectCollection<V> values;
        final /* synthetic */ Byte2ObjectAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey((byte)e.getKey());
        ...
        @Override
        public byte firstByteKey() {
            final Byte2ObjectAVLTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public byte lastByteKey() {
            final Byte2ObjectAVLTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2ObjectAVLTreeMap this$0 = submap.this$0;
                            final Byte2ObjectAVLTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
