...
public class Byte2ByteAVLTreeMap extends AbstractByte2ByteSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ByteComparator) {
            ...
            this.actualComparator = new ByteComparator() {
                ...
                public int compare(final byte k1, final byte k2) {
                    return Byte2ByteAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Byte put(final Byte ok, final Byte ov) {
        final byte oldValue = this.put((byte)ok, (byte)ov);
    ...
    public Byte remove(final Object ok) {
        final byte oldValue = this.remove((byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2ByteAVLTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2ByteSortedMap implements Serializable
    {
        ...
        protected transient ByteSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Byte2ByteAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2ByteAVLTreeMap.Entry f = Byte2ByteAVLTreeMap.this.findKey((byte)e.getKey());
        ...
        @Override
        public byte firstByteKey() {
            final Byte2ByteAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public byte lastByteKey() {
            final Byte2ByteAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2ByteAVLTreeMap this$0 = submap.this$0;
                            final Byte2ByteAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
