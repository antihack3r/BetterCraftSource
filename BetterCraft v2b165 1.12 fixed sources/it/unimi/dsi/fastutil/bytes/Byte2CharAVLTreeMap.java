...
public class Byte2CharAVLTreeMap extends AbstractByte2CharSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ByteComparator) {
            ...
            this.actualComparator = new ByteComparator() {
                ...
                public int compare(final byte k1, final byte k2) {
                    return Byte2CharAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Character put(final Byte ok, final Character ov) {
        final char oldValue = this.put((byte)ok, (char)ov);
    ...
    public Character remove(final Object ok) {
        final char oldValue = this.remove((byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2CharAVLTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Byte2CharMap.Entry> subSet(final Byte2CharMap.Entry from, final Byte2CharMap.Entry to) {
                    return Byte2CharAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2CharMap.Entry> headSet(final Byte2CharMap.Entry to) {
                    return Byte2CharAVLTreeMap.this.headMap(to.getByteKey()).byte2CharEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2CharMap.Entry> tailSet(final Byte2CharMap.Entry from) {
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2CharAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2CharSortedMap implements Serializable
    {
        ...
        protected transient ByteSortedSet keys;
        protected transient CharCollection values;
        final /* synthetic */ Byte2CharAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey((byte)e.getKey());
        ...
        @Override
        public byte firstByteKey() {
            final Byte2CharAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public byte lastByteKey() {
            final Byte2CharAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2CharAVLTreeMap this$0 = submap.this$0;
                            final Byte2CharAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
