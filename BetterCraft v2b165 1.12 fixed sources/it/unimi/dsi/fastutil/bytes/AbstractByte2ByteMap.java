...
public abstract class AbstractByte2ByteMap extends AbstractByte2ByteFunction implements Byte2ByteMap, Serializable
{
    ...
    public void putAll(final Map<? extends Byte, ? extends Byte> m) {
        ...
        if (m instanceof Byte2ByteMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Byte, ? extends Byte> e2 = (Map.Entry<? extends Byte, ? extends Byte>)i.next();
        ...
        return new AbstractByteSet() {
            ...
            public ByteIterator iterator() {
                return new AbstractByteIterator() {
                    final ObjectIterator<Map.Entry<Byte, Byte>> i = AbstractByte2ByteMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Byte, Byte>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry implements Entry
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Byte && e.getValue() != null && e.getValue() instanceof Byte && this.key == (byte)e.getKey() && this.value == (byte)e.getValue();
        }
