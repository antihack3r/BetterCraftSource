...
public class Byte2LongOpenCustomHashMap extends AbstractByte2LongMap implements Serializable, Cloneable, Hash
{
    ...
    private int insert(final byte k, final long v) {
        int pos;
    ...
    final class MapEntry implements Byte2LongMap.Entry, Map.Entry<Byte, Long>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[this.index], e.getKey()) && Byte2LongOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
