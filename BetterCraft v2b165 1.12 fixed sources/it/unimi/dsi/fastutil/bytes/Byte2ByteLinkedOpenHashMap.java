...
public class Byte2ByteLinkedOpenHashMap extends AbstractByte2ByteSortedMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Byte2ByteMap.Entry, Map.Entry<Byte, Byte>
    {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Byte2ByteLinkedOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final byte from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Byte2ByteLinkedOpenHashMap.this.mask; Byte2ByteLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Byte2ByteLinkedOpenHashMap this$0 = Byte2ByteLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Byte2ByteLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Byte2ByteLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Byte2ByteLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Byte2ByteLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Byte2ByteLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Byte2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Byte2ByteLinkedOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2ByteLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Byte2ByteMap.Entry>
    {
        ...
        @Override
        public void set(final Byte2ByteMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Byte2ByteMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ByteMap.Entry> implements Byte2ByteSortedMap.FastSortedEntrySet
    {
        ...
        @Override
        public ObjectSortedSet<Byte2ByteMap.Entry> subSet(final Byte2ByteMap.Entry fromElement, final Byte2ByteMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Byte2ByteMap.Entry> headSet(final Byte2ByteMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(final Byte2ByteMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractByteSortedSet
    {
        ...
        public boolean rem(final byte k) {
            final int oldSize = Byte2ByteLinkedOpenHashMap.this.size;
