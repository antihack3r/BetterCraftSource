...
public class Byte2CharOpenCustomHashMap extends AbstractByte2CharMap implements Serializable, Cloneable, Hash
{
    ...
    public Byte2CharOpenCustomHashMap(final int expected, final float f, final ByteHash.Strategy strategy) {
    ...
    public Byte2CharOpenCustomHashMap(final int expected, final ByteHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Byte2CharOpenCustomHashMap(final ByteHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Byte2CharOpenCustomHashMap(final Map<? extends Byte, ? extends Character> m, final float f, final ByteHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Byte2CharOpenCustomHashMap(final Map<? extends Byte, ? extends Character> m, final ByteHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Byte2CharOpenCustomHashMap(final Byte2CharMap m, final float f, final ByteHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Byte2CharOpenCustomHashMap(final Byte2CharMap m, final ByteHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Byte2CharOpenCustomHashMap(final byte[] k, final char[] v, final float f, final ByteHash.Strategy strategy) {
    ...
    public Byte2CharOpenCustomHashMap(final byte[] k, final char[] v, final ByteHash.Strategy strategy) {
    ...
    private int insert(final byte k, final char v) {
        int pos;
    ...
    final class MapEntry implements Byte2CharMap.Entry, Map.Entry<Byte, Character>
    {
        ...
        public char setValue(final char v) {
            final char oldValue = Byte2CharOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[this.index], e.getKey()) && Byte2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(Byte2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2CharOpenCustomHashMap.this.mask); !Byte2CharOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Byte2CharOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2CharOpenCustomHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Byte2CharOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2CharOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Byte2CharOpenCustomHashMap this$0 = Byte2CharOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractByteSet
    {
        ...
        public boolean rem(final byte k) {
            final int oldSize = Byte2CharOpenCustomHashMap.this.size;
