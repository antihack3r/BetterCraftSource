    ...
    public static class Singleton extends Byte2FloatFunctions.Singleton implements Byte2FloatMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Byte2FloatMap.Entry, Map.Entry<Byte, Float>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Byte && e.getValue() != null && e.getValue() instanceof Float && Singleton.this.key == (byte)e.getKey() && Singleton.this.value == (float)e.getValue();
            }
