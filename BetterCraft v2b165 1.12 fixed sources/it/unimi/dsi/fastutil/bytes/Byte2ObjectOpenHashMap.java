...
public class Byte2ObjectOpenHashMap<V> extends AbstractByte2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Byte2ObjectMap.Entry<V>, Map.Entry<Byte, V>
    {
        ...
        public V setValue(final V v) {
            final V oldValue = Byte2ObjectOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Byte2ObjectOpenHashMap.this.key[this.index] == e.getKey() && ((Byte2ObjectOpenHashMap.this.value[this.index] != null) ? Byte2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(k) & Byte2ObjectOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Byte2ObjectOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2ObjectOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2ObjectOpenHashMap.this.mask;
                    Label_0109: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0109;
        ...
        public void remove() {
            ...
            final Byte2ObjectOpenHashMap this$0 = Byte2ObjectOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == 0) {
                return Byte2ObjectOpenHashMap.this.containsNullKey && ((Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n] != null) ? Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n].equals(v) : (v == null));
            }
            final byte[] key = Byte2ObjectOpenHashMap.this.key;
            int pos;
            byte curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                if (Byte2ObjectOpenHashMap.this.containsNullKey) {
                    if (Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Byte2ObjectOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Byte2ObjectOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
    ...
    private final class KeySet extends AbstractByteSet
    {
        ...
        public boolean rem(final byte k) {
            final int oldSize = Byte2ObjectOpenHashMap.this.size;
