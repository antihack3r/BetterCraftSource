    ...
    public static class Singleton extends Byte2ShortFunctions.Singleton implements Byte2ShortMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Byte2ShortMap.Entry, Map.Entry<Byte, Short>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Byte && e.getValue() != null && e.getValue() instanceof Short && Singleton.this.key == (byte)e.getKey() && Singleton.this.value == (short)e.getValue();
            }
