...
public class Byte2IntAVLTreeMap extends AbstractByte2IntSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ByteComparator) {
            ...
            this.actualComparator = new ByteComparator() {
                ...
                public int compare(final byte k1, final byte k2) {
                    return Byte2IntAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Integer put(final Byte ok, final Integer ov) {
        final int oldValue = this.put((byte)ok, (int)ov);
    ...
    public Integer remove(final Object ok) {
        final int oldValue = this.remove((byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2IntAVLTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2IntAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2IntSortedMap implements Serializable
    {
        ...
        protected transient ByteSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Byte2IntAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2IntAVLTreeMap.Entry f = Byte2IntAVLTreeMap.this.findKey((byte)e.getKey());
        ...
        @Override
        public byte firstByteKey() {
            final Byte2IntAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public byte lastByteKey() {
            final Byte2IntAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2IntAVLTreeMap this$0 = submap.this$0;
                            final Byte2IntAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
