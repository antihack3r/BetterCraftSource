...
public class Byte2ReferenceAVLTreeMap<V> extends AbstractByte2ReferenceSortedMap<V> implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ByteComparator) {
            ...
            this.actualComparator = new ByteComparator() {
                ...
                public int compare(final byte k1, final byte k2) {
                    return Byte2ReferenceAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public V put(final Byte ok, final V ov) {
        final V oldValue = this.put((byte)ok, ov);
    ...
    public V remove(final Object ok) {
        final V oldValue = this.remove((byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry<V> locateKey = Byte2ReferenceAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2ReferenceSortedMap<V> implements Serializable
    {
        ...
        protected transient ByteSortedSet keys;
        protected transient ReferenceCollection<V> values;
        final /* synthetic */ Byte2ReferenceAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2ReferenceAVLTreeMap.Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey((byte)e.getKey());
        ...
        @Override
        public byte firstByteKey() {
            final Byte2ReferenceAVLTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public byte lastByteKey() {
            final Byte2ReferenceAVLTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2ReferenceAVLTreeMap this$0 = submap.this$0;
                            final Byte2ReferenceAVLTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
