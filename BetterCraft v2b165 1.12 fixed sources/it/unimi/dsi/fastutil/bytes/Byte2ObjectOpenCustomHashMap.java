...
public class Byte2ObjectOpenCustomHashMap<V> extends AbstractByte2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Byte2ObjectMap.Entry<V>, Map.Entry<Byte, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Byte2ObjectOpenCustomHashMap.this.strategy.equals(Byte2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Byte2ObjectOpenCustomHashMap.this.value[this.index] != null) ? Byte2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                return Byte2ObjectOpenCustomHashMap.this.containsNullKey && ((Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n] != null) ? Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
            int pos;
            byte curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) {
                    if (Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Byte2ObjectOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Byte2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
