    ...
    public static class Singleton extends Byte2DoubleFunctions.Singleton implements Byte2DoubleMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Byte2DoubleMap.Entry, Map.Entry<Byte, Double>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Byte && e.getValue() != null && e.getValue() instanceof Double && Singleton.this.key == (byte)e.getKey() && Singleton.this.value == (double)e.getValue();
            }
