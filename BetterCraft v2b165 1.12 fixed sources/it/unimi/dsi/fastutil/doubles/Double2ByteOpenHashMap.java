...
public class Double2ByteOpenHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Double2ByteMap.Entry, Map.Entry<Double, Byte>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey()) && Double2ByteOpenHashMap.this.value[this.index] == e.getValue();
        }
