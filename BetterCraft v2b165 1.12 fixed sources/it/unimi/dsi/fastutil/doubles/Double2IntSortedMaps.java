...
public class Double2IntSortedMaps
{
    ...
    public static Double2IntSortedMap singleton(final Double key, final Integer value) {
        return new Singleton(key, value);
    }
    
    public static Double2IntSortedMap singleton(final Double key, final Integer value, final DoubleComparator comparator) {
    ...
    public static Double2IntSortedMap singleton(final double key, final int value, final DoubleComparator comparator) {
        return new Singleton(key, value, comparator);
    }
    ...
    public static class EmptySortedMap extends Double2IntMaps.EmptyMap implements Double2IntSortedMap, Serializable, Cloneable
    {
        ...
        @Deprecated
        @Override
        public Double2IntSortedMap headMap(final Double oto) {
            return this.headMap((double)oto);
        }
        
        @Deprecated
        @Override
        public Double2IntSortedMap tailMap(final Double ofrom) {
            return this.tailMap((double)ofrom);
        }
        
        @Deprecated
        @Override
        public Double2IntSortedMap subMap(final Double ofrom, final Double oto) {
    ...
    public static class Singleton extends Double2IntMaps.Singleton implements Double2IntSortedMap, Serializable, Cloneable
    {
        ...
        protected Singleton(final double key, final int value, final DoubleComparator comparator) {
            super(key, value);
        ...
        public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
            if (this.entries == null) {
                this.entries = (ObjectSet<Double2IntMap.Entry>)ObjectSortedSets.singleton(new SingletonEntry(), Double2IntSortedMaps.entryComparator(this.comparator));
            }
