...
public class Double2LongLinkedOpenHashMap extends AbstractDouble2LongSortedMap implements Serializable, Cloneable, Hash
{
    ...
    private int insert(final double k, final long v) {
        int pos;
    ...
    final class MapEntry implements Double2LongMap.Entry, Map.Entry<Double, Long>
    {
        ...
        public long setValue(final long v) {
            final long oldValue = Double2LongLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey()) && Double2LongLinkedOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final double from) {
            ...
            if (Double.doubleToLongBits(from) == 0L) {
                ...
                for (int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(from)) & Double2LongLinkedOpenHashMap.this.mask; Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[pos]) != 0L; pos = (pos + 1 & Double2LongLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Double2LongLinkedOpenHashMap this$0 = Double2LongLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Double2LongLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Double2LongLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Double2LongLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Double2LongLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Double2LongLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Double2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Double2LongLinkedOpenHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2LongLinkedOpenHashMap.this.mask;
                    Label_0363: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0363;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Double2LongMap.Entry> implements Double2LongSortedMap.FastSortedEntrySet
    {
        ...
        @Override
        public ObjectSortedSet<Double2LongMap.Entry> subSet(final Double2LongMap.Entry fromElement, final Double2LongMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Double2LongMap.Entry> headSet(final Double2LongMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Double2LongMap.Entry> tailSet(final Double2LongMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractDoubleSortedSet
    {
        ...
        public boolean rem(final double k) {
            final int oldSize = Double2LongLinkedOpenHashMap.this.size;
