...
public class Double2CharAVLTreeMap extends AbstractDouble2CharSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof DoubleComparator) {
            ...
            this.actualComparator = new DoubleComparator() {
                ...
                public int compare(final double k1, final double k2) {
                    return Double2CharAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Character put(final Double ok, final Character ov) {
        final char oldValue = this.put((double)ok, (char)ov);
    ...
    public Character remove(final Object ok) {
        final char oldValue = this.remove((double)ok);
