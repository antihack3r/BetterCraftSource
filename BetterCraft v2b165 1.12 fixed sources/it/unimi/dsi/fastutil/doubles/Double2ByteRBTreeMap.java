...
public class Double2ByteRBTreeMap extends AbstractDouble2ByteSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof DoubleComparator) {
            ...
            this.actualComparator = new DoubleComparator() {
                ...
                public int compare(final double k1, final double k2) {
                    return Double2ByteRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Byte put(final Double ok, final Byte ov) {
        final byte oldValue = this.put((double)ok, (byte)ov);
    ...
    public Byte remove(final Object ok) {
        final byte oldValue = this.remove((double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Double2ByteRBTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry locateKey = Double2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractDouble2ByteSortedMap implements Serializable
    {
        ...
        protected transient DoubleSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Double2ByteRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey((double)e.getKey());
        ...
        @Override
        public double firstDoubleKey() {
            final Double2ByteRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public double lastDoubleKey() {
            final Double2ByteRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2ByteRBTreeMap this$0 = submap.this$0;
                            final Double2ByteRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
