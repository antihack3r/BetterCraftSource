...
public class Double2ShortAVLTreeMap extends AbstractDouble2ShortSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof DoubleComparator) {
            ...
            this.actualComparator = new DoubleComparator() {
                ...
                public int compare(final double k1, final double k2) {
                    return Double2ShortAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Short put(final Double ok, final Short ov) {
        final short oldValue = this.put((double)ok, (short)ov);
    ...
    public Short remove(final Object ok) {
        final short oldValue = this.remove((double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Double2ShortAVLTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry locateKey = Double2ShortAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractDouble2ShortSortedMap implements Serializable
    {
        ...
        protected transient DoubleSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Double2ShortAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2ShortAVLTreeMap.Entry f = Double2ShortAVLTreeMap.this.findKey((double)e.getKey());
        ...
        @Override
        public double firstDoubleKey() {
            final Double2ShortAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public double lastDoubleKey() {
            final Double2ShortAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2ShortAVLTreeMap this$0 = submap.this$0;
                            final Double2ShortAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
