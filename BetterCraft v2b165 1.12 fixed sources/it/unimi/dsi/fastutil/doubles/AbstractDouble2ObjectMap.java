...
public abstract class AbstractDouble2ObjectMap<V> extends AbstractDouble2ObjectFunction<V> implements Double2ObjectMap<V>, Serializable
{
        ...
        return new AbstractDoubleSet() {
            ...
            public DoubleIterator iterator() {
                return new AbstractDoubleIterator() {
                    final ObjectIterator<Map.Entry<Double, V>> i = AbstractDouble2ObjectMap.this.entrySet().iterator();
    ...
    public static class BasicEntry<V> implements Entry<V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Double && Double.doubleToLongBits(this.key) == Double.doubleToLongBits((double)e.getKey()) && ((this.value != null) ? this.value.equals(e.getValue()) : (e.getValue() == null));
        }
