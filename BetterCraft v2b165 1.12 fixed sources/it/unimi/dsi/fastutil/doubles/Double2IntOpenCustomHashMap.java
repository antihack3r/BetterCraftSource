...
public class Double2IntOpenCustomHashMap extends AbstractDouble2IntMap implements Serializable, Cloneable, Hash
{
    ...
    private int insert(final double k, final int v) {
        int pos;
    ...
    final class MapEntry implements Double2IntMap.Entry, Map.Entry<Double, Integer>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[this.index], e.getKey()) && Double2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
