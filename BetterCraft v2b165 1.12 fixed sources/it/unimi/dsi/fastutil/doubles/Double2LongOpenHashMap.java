...
public class Double2LongOpenHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Double2LongMap.Entry, Map.Entry<Double, Long>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(Double2LongOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey()) && Double2LongOpenHashMap.this.value[this.index] == e.getValue();
        }
