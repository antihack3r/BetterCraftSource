...
public class Double2ObjectArrayMap<V> extends AbstractDouble2ObjectMap<V> implements Serializable, Cloneable
{
    ...
    private final class EntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            return Double2ObjectArrayMap.this.containsKey(k) && ((Double2ObjectArrayMap.this.get(k) != null) ? Double2ObjectArrayMap.this.get(k).equals(e.getValue()) : (e.getValue() == null));
        }
        ...
        public boolean remove(final Object o) {
            ...
            if (oldPos != -1) {
                if (v == null) {
                    if (Double2ObjectArrayMap.this.value[oldPos] != null) {
                        return false;
                    }
                }
                else if (!v.equals(Double2ObjectArrayMap.this.value[oldPos])) {
                    return false;
                }
