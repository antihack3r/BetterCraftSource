...
public class Double2ShortOpenHashMap extends AbstractDouble2ShortMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Double2ShortMap.Entry, Map.Entry<Double, Short>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey()) && Double2ShortOpenHashMap.this.value[this.index] == e.getValue();
        }
