...
public class Double2ObjectOpenCustomHashMap<V> extends AbstractDouble2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Double2ObjectMap.Entry<V>, Map.Entry<Double, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double2ObjectOpenCustomHashMap.this.strategy.equals(Double2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Double2ObjectOpenCustomHashMap.this.value[this.index] != null) ? Double2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Double2ObjectOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                return Double2ObjectOpenCustomHashMap.this.containsNullKey && ((Double2ObjectOpenCustomHashMap.this.value[Double2ObjectOpenCustomHashMap.this.n] != null) ? Double2ObjectOpenCustomHashMap.this.value[Double2ObjectOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final double[] key = Double2ObjectOpenCustomHashMap.this.key;
            int pos;
            double curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Double2ObjectOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                if (Double2ObjectOpenCustomHashMap.this.containsNullKey) {
                    if (Double2ObjectOpenCustomHashMap.this.value[Double2ObjectOpenCustomHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Double2ObjectOpenCustomHashMap.this.value[Double2ObjectOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Double2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double2ObjectOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Double2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
