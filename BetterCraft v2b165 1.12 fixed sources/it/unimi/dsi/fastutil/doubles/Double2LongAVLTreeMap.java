...
public class Double2LongAVLTreeMap extends AbstractDouble2LongSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof DoubleComparator) {
            ...
            this.actualComparator = new DoubleComparator() {
                ...
                public int compare(final double k1, final double k2) {
                    return Double2LongAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Long put(final Double ok, final Long ov) {
        final long oldValue = this.put((double)ok, (long)ov);
    ...
    public Long remove(final Object ok) {
        final long oldValue = this.remove((double)ok);
