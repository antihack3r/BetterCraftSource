...
public class Double2ObjectAVLTreeMap<V> extends AbstractDouble2ObjectSortedMap<V> implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof DoubleComparator) {
            ...
            this.actualComparator = new DoubleComparator() {
                ...
                public int compare(final double k1, final double k2) {
                    return Double2ObjectAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Double2ObjectAVLTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
    ...
    private static final class Entry<V> implements Cloneable, Double2ObjectMap.Entry<V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits(e.getKey()) && ((this.value != null) ? this.value.equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry<V> locateKey = Double2ObjectAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractDouble2ObjectSortedMap<V> implements Serializable
    {
        ...
        protected transient DoubleSortedSet keys;
        protected transient ObjectCollection<V> values;
        final /* synthetic */ Double2ObjectAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2ObjectAVLTreeMap.Entry<V> f = Double2ObjectAVLTreeMap.this.findKey((double)e.getKey());
        ...
        @Override
        public double firstDoubleKey() {
            final Double2ObjectAVLTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public double lastDoubleKey() {
            final Double2ObjectAVLTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2ObjectAVLTreeMap this$0 = submap.this$0;
                            final Double2ObjectAVLTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
