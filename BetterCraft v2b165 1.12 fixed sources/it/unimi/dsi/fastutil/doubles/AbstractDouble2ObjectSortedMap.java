...
public abstract class AbstractDouble2ObjectSortedMap<V> extends AbstractDouble2ObjectMap<V> implements Double2ObjectSortedMap<V>
{
    ...
    protected class KeySet extends AbstractDoubleSortedSet
    {
        ...
        public DoubleBidirectionalIterator iterator(final double from) {
            return new KeySetIterator<Object>((ObjectBidirectionalIterator<Map.Entry<Double, ?>>)AbstractDouble2ObjectSortedMap.this.entrySet().iterator(new BasicEntry<V>(from, null)));
        }
        
        @Override
        public DoubleBidirectionalIterator iterator() {
            return new KeySetIterator<Object>((ObjectBidirectionalIterator<Map.Entry<Double, ?>>)AbstractDouble2ObjectSortedMap.this.entrySet().iterator());
        }
    }
    ...
    protected class ValuesCollection extends AbstractObjectCollection<V>
    {
        ...
        public ObjectIterator<V> iterator() {
            return new ValuesIterator<V>(AbstractDouble2ObjectSortedMap.this.entrySet().iterator());
        }
