...
public class Double2CharOpenCustomHashMap extends AbstractDouble2CharMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Double2CharMap.Entry, Map.Entry<Double, Character>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Double2CharOpenCustomHashMap.this.strategy.equals(Double2CharOpenCustomHashMap.this.key[this.index], e.getKey()) && Double2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
