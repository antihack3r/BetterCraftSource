...
public class Short2ObjectLinkedOpenHashMap<V> extends AbstractShort2ObjectSortedMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Short2ObjectMap.Entry<V>, Map.Entry<Short, V>
    {
        ...
        public V setValue(final V v) {
            final V oldValue = Short2ObjectLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Short2ObjectLinkedOpenHashMap.this.key[this.index] == e.getKey() && ((Short2ObjectLinkedOpenHashMap.this.value[this.index] != null) ? Short2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final short from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Short2ObjectLinkedOpenHashMap.this.mask; Short2ObjectLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Short2ObjectLinkedOpenHashMap this$0 = Short2ObjectLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Short2ObjectLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Short2ObjectLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Short2ObjectLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Short2ObjectLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Short2ObjectLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Short2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Short2ObjectLinkedOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2ObjectLinkedOpenHashMap.this.mask;
                    Label_0380: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0380;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Short2ObjectMap.Entry<V>> implements Short2ObjectSortedMap.FastSortedEntrySet<V>
    {
        ...
        @Override
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(final Short2ObjectMap.Entry<V> fromElement, final Short2ObjectMap.Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(final Short2ObjectMap.Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(final Short2ObjectMap.Entry<V> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean contains(final Object o) {
            ...
            if (k == 0) {
                return Short2ObjectLinkedOpenHashMap.this.containsNullKey && ((Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n] != null) ? Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n].equals(v) : (v == null));
            }
            final short[] key = Short2ObjectLinkedOpenHashMap.this.key;
            int pos;
            short curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                if (Short2ObjectLinkedOpenHashMap.this.containsNullKey) {
                    if (Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Short2ObjectLinkedOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Short2ObjectLinkedOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
    ...
    private final class KeySet extends AbstractShortSortedSet
    {
        ...
        public boolean rem(final short k) {
            final int oldSize = Short2ObjectLinkedOpenHashMap.this.size;
