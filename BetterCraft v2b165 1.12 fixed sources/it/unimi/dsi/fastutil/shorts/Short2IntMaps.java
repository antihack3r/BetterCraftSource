    ...
    public static class Singleton extends Short2IntFunctions.Singleton implements Short2IntMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Short2IntMap.Entry, Map.Entry<Short, Integer>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Short && e.getValue() != null && e.getValue() instanceof Integer && Singleton.this.key == (short)e.getKey() && Singleton.this.value == (int)e.getValue();
            }
