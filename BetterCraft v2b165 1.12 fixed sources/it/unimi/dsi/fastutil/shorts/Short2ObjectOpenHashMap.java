...
public class Short2ObjectOpenHashMap<V> extends AbstractShort2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Short2ObjectMap.Entry<V>, Map.Entry<Short, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2ObjectOpenHashMap.this.key[this.index] == e.getKey() && ((Short2ObjectOpenHashMap.this.value[this.index] != null) ? Short2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == 0) {
                return Short2ObjectOpenHashMap.this.containsNullKey && ((Short2ObjectOpenHashMap.this.value[Short2ObjectOpenHashMap.this.n] != null) ? Short2ObjectOpenHashMap.this.value[Short2ObjectOpenHashMap.this.n].equals(v) : (v == null));
            }
            final short[] key = Short2ObjectOpenHashMap.this.key;
            int pos;
            short curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                if (Short2ObjectOpenHashMap.this.containsNullKey) {
                    if (Short2ObjectOpenHashMap.this.value[Short2ObjectOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Short2ObjectOpenHashMap.this.value[Short2ObjectOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Short2ObjectOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Short2ObjectOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
