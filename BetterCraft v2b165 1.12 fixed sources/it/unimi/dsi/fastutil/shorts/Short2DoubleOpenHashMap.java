...
public class Short2DoubleOpenHashMap extends AbstractShort2DoubleMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Short2DoubleMap.Entry, Map.Entry<Short, Double>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2DoubleOpenHashMap.this.key[this.index] == e.getKey() && Short2DoubleOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet
    {
        ...
        public boolean rem(final Object o) {
            ...
            if (k == 0) {
                ...
                if (curr != k) {
                    while ((curr = key[pos = (pos + 1 & Short2DoubleOpenHashMap.this.mask)]) != 0) {
                        if (curr == k && Short2DoubleOpenHashMap.this.value[pos] == v) {
