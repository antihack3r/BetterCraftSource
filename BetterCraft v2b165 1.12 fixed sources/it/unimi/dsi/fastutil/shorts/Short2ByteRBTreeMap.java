...
public class Short2ByteRBTreeMap extends AbstractShort2ByteSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2ByteRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Byte put(final Short ok, final Byte ov) {
        final byte oldValue = this.put((short)ok, (byte)ov);
    ...
    public Byte remove(final Object ok) {
        final byte oldValue = this.remove((short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2ByteRBTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2ByteSortedMap implements Serializable
    {
        ...
        protected transient ShortSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Short2ByteRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2ByteRBTreeMap.Entry f = Short2ByteRBTreeMap.this.findKey((short)e.getKey());
        ...
        @Override
        public short firstShortKey() {
            final Short2ByteRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public short lastShortKey() {
            final Short2ByteRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2ByteRBTreeMap this$0 = submap.this$0;
                            final Short2ByteRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
