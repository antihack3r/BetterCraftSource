...
public class Short2BooleanAVLTreeMap extends AbstractShort2BooleanSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2BooleanAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Boolean put(final Short ok, final Boolean ov) {
        final boolean oldValue = this.put((short)ok, (boolean)ov);
    ...
    public Boolean remove(final Object ok) {
        final boolean oldValue = this.remove((short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2BooleanAVLTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2BooleanAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2BooleanSortedMap implements Serializable
    {
        ...
        protected transient ShortSortedSet keys;
        protected transient BooleanCollection values;
        final /* synthetic */ Short2BooleanAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2BooleanAVLTreeMap.Entry f = Short2BooleanAVLTreeMap.this.findKey((short)e.getKey());
        ...
        @Override
        public short firstShortKey() {
            final Short2BooleanAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public short lastShortKey() {
            final Short2BooleanAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2BooleanAVLTreeMap this$0 = submap.this$0;
                            final Short2BooleanAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
