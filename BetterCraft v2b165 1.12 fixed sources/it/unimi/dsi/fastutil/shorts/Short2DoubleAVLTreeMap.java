...
public class Short2DoubleAVLTreeMap extends AbstractShort2DoubleSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2DoubleAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Double put(final Short ok, final Double ov) {
        final double oldValue = this.put((short)ok, (double)ov);
    ...
    public Double remove(final Object ok) {
        final double oldValue = this.remove((short)ok);
