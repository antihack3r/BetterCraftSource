...
public class Short2FloatAVLTreeMap extends AbstractShort2FloatSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2FloatAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Float put(final Short ok, final Float ov) {
        final float oldValue = this.put((short)ok, (float)ov);
    ...
    public Float remove(final Object ok) {
        final float oldValue = this.remove((short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2FloatAVLTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2FloatAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2FloatSortedMap implements Serializable
    {
        ...
        protected transient ShortSortedSet keys;
        protected transient FloatCollection values;
        final /* synthetic */ Short2FloatAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey((short)e.getKey());
        ...
        @Override
        public short firstShortKey() {
            final Short2FloatAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public short lastShortKey() {
            final Short2FloatAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2FloatAVLTreeMap this$0 = submap.this$0;
                            final Short2FloatAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
