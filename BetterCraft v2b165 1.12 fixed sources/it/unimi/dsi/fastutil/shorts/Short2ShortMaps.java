    ...
    public static class Singleton extends Short2ShortFunctions.Singleton implements Short2ShortMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Short && e.getValue() != null && e.getValue() instanceof Short && Singleton.this.key == (short)e.getKey() && Singleton.this.value == (short)e.getValue();
            }
