...
public class Short2CharRBTreeMap extends AbstractShort2CharSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2CharRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Character put(final Short ok, final Character ov) {
        final char oldValue = this.put((short)ok, (char)ov);
    ...
    public Character remove(final Object ok) {
        final char oldValue = this.remove((short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2CharRBTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2CharRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2CharSortedMap implements Serializable
    {
        ...
        protected transient ShortSortedSet keys;
        protected transient CharCollection values;
        final /* synthetic */ Short2CharRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2CharRBTreeMap.Entry f = Short2CharRBTreeMap.this.findKey((short)e.getKey());
        ...
        @Override
        public short firstShortKey() {
            final Short2CharRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public short lastShortKey() {
            final Short2CharRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2CharRBTreeMap this$0 = submap.this$0;
                            final Short2CharRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
