...
public class ShortLists
{
    ...
    public static class EmptyList extends ShortCollections.EmptyCollection implements ShortList, Serializable, Cloneable
    {
        ...
        @Deprecated
        @Override
        public ShortListIterator shortListIterator(final int i) {
    ...
    public static class Singleton extends AbstractShortList implements Serializable, Cloneable
    {
        private static final long serialVersionUID = -7046029254386353129L;
