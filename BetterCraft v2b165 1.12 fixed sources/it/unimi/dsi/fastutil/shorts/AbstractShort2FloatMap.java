...
public abstract class AbstractShort2FloatMap extends AbstractShort2FloatFunction implements Short2FloatMap, Serializable
{
    ...
    public void putAll(final Map<? extends Short, ? extends Float> m) {
        ...
        if (m instanceof Short2FloatMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Short, ? extends Float> e2 = (Map.Entry<? extends Short, ? extends Float>)i.next();
        ...
        return new AbstractShortSet() {
            ...
            public ShortIterator iterator() {
                return new AbstractShortIterator() {
                    final ObjectIterator<Map.Entry<Short, Float>> i = AbstractShort2FloatMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Short, Float>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry implements Entry
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Short && e.getValue() != null && e.getValue() instanceof Float && this.key == (short)e.getKey() && this.value == (float)e.getValue();
        }
