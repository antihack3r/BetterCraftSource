...
public class Short2ObjectArrayMap<V> extends AbstractShort2ObjectMap<V> implements Serializable, Cloneable
{
    ...
    private final class EntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectMap.FastEntrySet<V>
    {
        ...
        public ObjectIterator<Short2ObjectMap.Entry<V>> iterator() {
            return new AbstractObjectIterator<Short2ObjectMap.Entry<V>>() {
                ...
                public Short2ObjectMap.Entry<V> next() {
                    ...
                    final short[] access$100 = Short2ObjectArrayMap.this.key;
                    final int next = this.next;
                    this.curr = next;
                    return new BasicEntry<V>(access$100[next], Short2ObjectArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    final int tail = Short2ObjectArrayMap.this.size-- - this.next--;
        ...
        public boolean contains(final Object o) {
            ...
            return Short2ObjectArrayMap.this.containsKey(k) && ((Short2ObjectArrayMap.this.get(k) != null) ? Short2ObjectArrayMap.this.get(k).equals(e.getValue()) : (e.getValue() == null));
        }
        ...
        public boolean remove(final Object o) {
            ...
            if (oldPos != -1) {
                if (v == null) {
                    if (Short2ObjectArrayMap.this.value[oldPos] != null) {
                        return false;
                    }
                }
                else if (!v.equals(Short2ObjectArrayMap.this.value[oldPos])) {
                    return false;
                }
                final int tail = Short2ObjectArrayMap.this.size - oldPos - 1;
