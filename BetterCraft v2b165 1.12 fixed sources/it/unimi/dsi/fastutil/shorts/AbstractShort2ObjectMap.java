...
public abstract class AbstractShort2ObjectMap<V> extends AbstractShort2ObjectFunction<V> implements Short2ObjectMap<V>, Serializable
{
        ...
        return new AbstractShortSet() {
            ...
            public ShortIterator iterator() {
                return new AbstractShortIterator() {
                    final ObjectIterator<Map.Entry<Short, V>> i = AbstractShort2ObjectMap.this.entrySet().iterator();
    ...
    public static class BasicEntry<V> implements Entry<V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Short && this.key == (short)e.getKey() && ((this.value != null) ? this.value.equals(e.getValue()) : (e.getValue() == null));
        }
