...
public class Short2IntRBTreeMap extends AbstractShort2IntSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2IntRBTreeMap.this.storedComparator.compare(k1, k2);
                }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2IntRBTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2IntSortedMap implements Serializable
    {
        ...
        protected transient ShortSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Short2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2IntRBTreeMap.Entry f = Short2IntRBTreeMap.this.findKey((short)e.getKey());
        ...
        @Override
        public short firstShortKey() {
            final Short2IntRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public short lastShortKey() {
            final Short2IntRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2IntRBTreeMap this$0 = submap.this$0;
                            final Short2IntRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
