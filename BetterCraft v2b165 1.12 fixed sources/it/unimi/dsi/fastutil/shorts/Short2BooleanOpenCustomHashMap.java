...
public class Short2BooleanOpenCustomHashMap extends AbstractShort2BooleanMap implements Serializable, Cloneable, Hash
{
    ...
    private int insert(final short k, final boolean v) {
        int pos;
    ...
    final class MapEntry implements Short2BooleanMap.Entry, Map.Entry<Short, Boolean>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[this.index], e.getKey()) && Short2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
