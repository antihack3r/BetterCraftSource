    ...
    public static class Singleton<V> extends Short2ObjectFunctions.Singleton<V> implements Short2ObjectMap<V>, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Short2ObjectMap.Entry<V>, Map.Entry<Short, V>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Short && Singleton.this.key == (short)e.getKey() && ((Singleton.this.value != null) ? Singleton.this.value.equals(e.getValue()) : (e.getValue() == null));
            }
