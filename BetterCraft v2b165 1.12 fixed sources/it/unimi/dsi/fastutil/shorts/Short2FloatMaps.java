    ...
    public static class Singleton extends Short2FloatFunctions.Singleton implements Short2FloatMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Short2FloatMap.Entry, Map.Entry<Short, Float>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Short && e.getValue() != null && e.getValue() instanceof Float && Singleton.this.key == (short)e.getKey() && Singleton.this.value == (float)e.getValue();
            }
