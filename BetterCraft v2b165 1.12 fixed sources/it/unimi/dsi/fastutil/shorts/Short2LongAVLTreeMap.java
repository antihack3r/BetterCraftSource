...
public class Short2LongAVLTreeMap extends AbstractShort2LongSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof ShortComparator) {
            ...
            this.actualComparator = new ShortComparator() {
                ...
                public int compare(final short k1, final short k2) {
                    return Short2LongAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Long put(final Short ok, final Long ov) {
        final long oldValue = this.put((short)ok, (long)ov);
    ...
    public Long remove(final Object ok) {
        final long oldValue = this.remove((short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2LongAVLTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2LongSortedMap implements Serializable
    {
        ...
        protected transient ShortSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Short2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey((short)e.getKey());
        ...
        @Override
        public short firstShortKey() {
            final Short2LongAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public short lastShortKey() {
            final Short2LongAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2LongAVLTreeMap this$0 = submap.this$0;
                            final Short2LongAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
