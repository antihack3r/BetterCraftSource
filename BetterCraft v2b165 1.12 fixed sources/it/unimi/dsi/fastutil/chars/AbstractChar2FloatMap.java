...
public abstract class AbstractChar2FloatMap extends AbstractChar2FloatFunction implements Char2FloatMap, Serializable
{
    ...
    public void putAll(final Map<? extends Character, ? extends Float> m) {
        ...
        if (m instanceof Char2FloatMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Character, ? extends Float> e2 = (Map.Entry<? extends Character, ? extends Float>)i.next();
        ...
        return new AbstractCharSet() {
            ...
            public CharIterator iterator() {
                return new AbstractCharIterator() {
                    final ObjectIterator<Map.Entry<Character, Float>> i = AbstractChar2FloatMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Character, Float>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry implements Entry
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Character && e.getValue() != null && e.getValue() instanceof Float && this.key == (char)e.getKey() && this.value == (float)e.getValue();
        }
