...
public abstract class AbstractChar2ObjectSortedMap<V> extends AbstractChar2ObjectMap<V> implements Char2ObjectSortedMap<V>
{
    ...
    protected class KeySet extends AbstractCharSortedSet
    {
        ...
        public CharBidirectionalIterator iterator(final char from) {
            return new KeySetIterator<Object>((ObjectBidirectionalIterator<Map.Entry<Character, ?>>)AbstractChar2ObjectSortedMap.this.entrySet().iterator(new BasicEntry<V>(from, null)));
        }
        
        @Override
        public CharBidirectionalIterator iterator() {
            return new KeySetIterator<Object>((ObjectBidirectionalIterator<Map.Entry<Character, ?>>)AbstractChar2ObjectSortedMap.this.entrySet().iterator());
        }
    }
    ...
    protected class ValuesCollection extends AbstractObjectCollection<V>
    {
        ...
        public ObjectIterator<V> iterator() {
            return new ValuesIterator<V>(AbstractChar2ObjectSortedMap.this.entrySet().iterator());
        }
