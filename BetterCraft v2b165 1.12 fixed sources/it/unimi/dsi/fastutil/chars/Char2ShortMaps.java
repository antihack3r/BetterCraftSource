    ...
    public static class Singleton extends Char2ShortFunctions.Singleton implements Char2ShortMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Char2ShortMap.Entry, Map.Entry<Character, Short>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Character && e.getValue() != null && e.getValue() instanceof Short && Singleton.this.key == (char)e.getKey() && Singleton.this.value == (short)e.getValue();
            }
