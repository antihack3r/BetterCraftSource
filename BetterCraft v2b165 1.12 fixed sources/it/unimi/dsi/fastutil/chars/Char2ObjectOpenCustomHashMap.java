...
public class Char2ObjectOpenCustomHashMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Char2ObjectOpenCustomHashMap.this.value[this.index] != null) ? Char2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, '\0')) {
                return Char2ObjectOpenCustomHashMap.this.containsNullKey && ((Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n] != null) ? Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final char[] key = Char2ObjectOpenCustomHashMap.this.key;
            int pos;
            char curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, '\0')) {
                if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
                    if (Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Char2ObjectOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Char2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
