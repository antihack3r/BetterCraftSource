...
public class Char2CharLinkedOpenHashMap extends AbstractChar2CharSortedMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Char2CharMap.Entry, Map.Entry<Character, Character>
    {
        ...
        public char setValue(final char v) {
            final char oldValue = Char2CharLinkedOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final char from) {
            ...
            if (from == '\0') {
                ...
                for (int pos = HashCommon.mix(from) & Char2CharLinkedOpenHashMap.this.mask; Char2CharLinkedOpenHashMap.this.key[pos] != '\0'; pos = (pos + 1 & Char2CharLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Char2CharLinkedOpenHashMap this$0 = Char2CharLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Char2CharLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Char2CharLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Char2CharLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Char2CharLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Char2CharLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Char2CharLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Char2CharLinkedOpenHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(curr) & Char2CharLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Char2CharMap.Entry> implements Char2CharSortedMap.FastSortedEntrySet
    {
        ...
        @Override
        public ObjectSortedSet<Char2CharMap.Entry> subSet(final Char2CharMap.Entry fromElement, final Char2CharMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Char2CharMap.Entry> headSet(final Char2CharMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Char2CharMap.Entry> tailSet(final Char2CharMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractCharSortedSet
    {
        ...
        public boolean rem(final char k) {
            final int oldSize = Char2CharLinkedOpenHashMap.this.size;
