...
public class Char2ObjectArrayMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable
{
    ...
    private final class EntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V>
    {
        ...
        public ObjectIterator<Char2ObjectMap.Entry<V>> iterator() {
            return new AbstractObjectIterator<Char2ObjectMap.Entry<V>>() {
                ...
                public Char2ObjectMap.Entry<V> next() {
                    ...
                    final char[] access$100 = Char2ObjectArrayMap.this.key;
                    final int next = this.next;
                    this.curr = next;
                    return new BasicEntry<V>(access$100[next], Char2ObjectArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    final int tail = Char2ObjectArrayMap.this.size-- - this.next--;
        ...
        public boolean contains(final Object o) {
            ...
            return Char2ObjectArrayMap.this.containsKey(k) && ((Char2ObjectArrayMap.this.get(k) != null) ? Char2ObjectArrayMap.this.get(k).equals(e.getValue()) : (e.getValue() == null));
        }
        ...
        public boolean remove(final Object o) {
            ...
            if (oldPos != -1) {
                if (v == null) {
                    if (Char2ObjectArrayMap.this.value[oldPos] != null) {
                        return false;
                    }
                }
                else if (!v.equals(Char2ObjectArrayMap.this.value[oldPos])) {
                    return false;
                }
                final int tail = Char2ObjectArrayMap.this.size - oldPos - 1;
