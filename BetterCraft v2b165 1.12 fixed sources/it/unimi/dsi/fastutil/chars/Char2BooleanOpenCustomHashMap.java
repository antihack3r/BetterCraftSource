...
public class Char2BooleanOpenCustomHashMap extends AbstractChar2BooleanMap implements Serializable, Cloneable, Hash
{
    ...
    public Char2BooleanOpenCustomHashMap(final int expected, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2BooleanOpenCustomHashMap(final int expected, final CharHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Char2BooleanOpenCustomHashMap(final CharHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Char2BooleanOpenCustomHashMap(final Map<? extends Character, ? extends Boolean> m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2BooleanOpenCustomHashMap(final Map<? extends Character, ? extends Boolean> m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2BooleanOpenCustomHashMap(final Char2BooleanMap m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2BooleanOpenCustomHashMap(final Char2BooleanMap m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2BooleanOpenCustomHashMap(final char[] k, final boolean[] v, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2BooleanOpenCustomHashMap(final char[] k, final boolean[] v, final CharHash.Strategy strategy) {
    ...
    final class MapEntry implements Char2BooleanMap.Entry, Map.Entry<Character, Boolean>
    {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Char2BooleanOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2BooleanOpenCustomHashMap.this.strategy.equals(Char2BooleanOpenCustomHashMap.this.key[this.index], e.getKey()) && Char2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            char k;
            int p;
            for (k = this.wrapped.getChar(-this.pos - 1), p = (HashCommon.mix(Char2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Char2BooleanOpenCustomHashMap.this.mask); !Char2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Char2BooleanOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Char2BooleanOpenCustomHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(Char2BooleanOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2BooleanOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Char2BooleanOpenCustomHashMap this$0 = Char2BooleanOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractCharSet
    {
        ...
        public boolean rem(final char k) {
            final int oldSize = Char2BooleanOpenCustomHashMap.this.size;
