...
public class Char2ShortAVLTreeMap extends AbstractChar2ShortSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof CharComparator) {
            ...
            this.actualComparator = new CharComparator() {
                ...
                public int compare(final char k1, final char k2) {
                    return Char2ShortAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Short put(final Character ok, final Short ov) {
        final short oldValue = this.put((char)ok, (short)ov);
    ...
    public Short remove(final Object ok) {
        final short oldValue = this.remove((char)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2ShortAVLTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2ShortAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2ShortSortedMap implements Serializable
    {
        ...
        protected transient CharSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Char2ShortAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey((char)e.getKey());
        ...
        @Override
        public char firstCharKey() {
            final Char2ShortAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public char lastCharKey() {
            final Char2ShortAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2ShortAVLTreeMap this$0 = submap.this$0;
                            final Char2ShortAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
