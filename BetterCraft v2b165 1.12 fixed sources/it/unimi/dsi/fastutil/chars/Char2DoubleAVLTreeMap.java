...
public class Char2DoubleAVLTreeMap extends AbstractChar2DoubleSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof CharComparator) {
            ...
            this.actualComparator = new CharComparator() {
                ...
                public int compare(final char k1, final char k2) {
                    return Char2DoubleAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Double put(final Character ok, final Double ov) {
        final double oldValue = this.put((char)ok, (double)ov);
    ...
    public Double remove(final Object ok) {
        final double oldValue = this.remove((char)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2DoubleAVLTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2DoubleSortedMap implements Serializable
    {
        ...
        protected transient CharSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Char2DoubleAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey((char)e.getKey());
        ...
        @Override
        public char firstCharKey() {
            final Char2DoubleAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public char lastCharKey() {
            final Char2DoubleAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2DoubleAVLTreeMap this$0 = submap.this$0;
                            final Char2DoubleAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
