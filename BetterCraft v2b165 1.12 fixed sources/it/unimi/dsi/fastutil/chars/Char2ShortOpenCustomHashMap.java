...
public class Char2ShortOpenCustomHashMap extends AbstractChar2ShortMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Char2ShortMap.Entry, Map.Entry<Character, Short>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Char2ShortOpenCustomHashMap.this.strategy.equals(Char2ShortOpenCustomHashMap.this.key[this.index], e.getKey()) && Char2ShortOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
