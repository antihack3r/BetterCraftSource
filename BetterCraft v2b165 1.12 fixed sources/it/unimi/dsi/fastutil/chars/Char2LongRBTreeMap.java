...
public class Char2LongRBTreeMap extends AbstractChar2LongSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof CharComparator) {
            ...
            this.actualComparator = new CharComparator() {
                ...
                public int compare(final char k1, final char k2) {
                    return Char2LongRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Long put(final Character ok, final Long ov) {
        final long oldValue = this.put((char)ok, (long)ov);
    ...
    public Long remove(final Object ok) {
        final long oldValue = this.remove((char)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2LongRBTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2LongSortedMap implements Serializable
    {
        ...
        protected transient CharSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Char2LongRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2LongRBTreeMap.Entry f = Char2LongRBTreeMap.this.findKey((char)e.getKey());
        ...
        @Override
        public char firstCharKey() {
            final Char2LongRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public char lastCharKey() {
            final Char2LongRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2LongRBTreeMap this$0 = submap.this$0;
                            final Char2LongRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
