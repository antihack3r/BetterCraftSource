...
public class Char2FloatRBTreeMap extends AbstractChar2FloatSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof CharComparator) {
            ...
            this.actualComparator = new CharComparator() {
                ...
                public int compare(final char k1, final char k2) {
                    return Char2FloatRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Float put(final Character ok, final Float ov) {
        final float oldValue = this.put((char)ok, (float)ov);
    ...
    public Float remove(final Object ok) {
        final float oldValue = this.remove((char)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2FloatRBTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2FloatRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2FloatSortedMap implements Serializable
    {
        ...
        protected transient CharSortedSet keys;
        protected transient FloatCollection values;
        final /* synthetic */ Char2FloatRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey((char)e.getKey());
        ...
        @Override
        public char firstCharKey() {
            final Char2FloatRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public char lastCharKey() {
            final Char2FloatRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2FloatRBTreeMap this$0 = submap.this$0;
                            final Char2FloatRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
