...
public abstract class AbstractChar2DoubleMap extends AbstractChar2DoubleFunction implements Char2DoubleMap, Serializable
{
    ...
    public void putAll(final Map<? extends Character, ? extends Double> m) {
        ...
        if (m instanceof Char2DoubleMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Character, ? extends Double> e2 = (Map.Entry<? extends Character, ? extends Double>)i.next();
        ...
        return new AbstractCharSet() {
            ...
            public CharIterator iterator() {
                return new AbstractCharIterator() {
                    final ObjectIterator<Map.Entry<Character, Double>> i = AbstractChar2DoubleMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Character, Double>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry implements Entry
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Character && e.getValue() != null && e.getValue() instanceof Double && this.key == (char)e.getKey() && this.value == (double)e.getValue();
        }
