...
public class Char2ObjectRBTreeMap<V> extends AbstractChar2ObjectSortedMap<V> implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof CharComparator) {
            ...
            this.actualComparator = new CharComparator() {
                ...
                public int compare(final char k1, final char k2) {
                    return Char2ObjectRBTreeMap.this.storedComparator.compare(k1, k2);
                }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Char2ObjectRBTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry<V> locateKey = Char2ObjectRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2ObjectSortedMap<V> implements Serializable
    {
        ...
        protected transient CharSortedSet keys;
        protected transient ObjectCollection<V> values;
        final /* synthetic */ Char2ObjectRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey((char)e.getKey());
        ...
        @Override
        public char firstCharKey() {
            final Char2ObjectRBTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public char lastCharKey() {
            final Char2ObjectRBTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2ObjectRBTreeMap this$0 = submap.this$0;
                            final Char2ObjectRBTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
