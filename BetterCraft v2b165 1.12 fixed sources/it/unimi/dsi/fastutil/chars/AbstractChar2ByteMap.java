...
public abstract class AbstractChar2ByteMap extends AbstractChar2ByteFunction implements Char2ByteMap, Serializable
{
    ...
    public void putAll(final Map<? extends Character, ? extends Byte> m) {
        ...
        if (m instanceof Char2ByteMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Character, ? extends Byte> e2 = (Map.Entry<? extends Character, ? extends Byte>)i.next();
        ...
        return new AbstractCharSet() {
            ...
            public CharIterator iterator() {
                return new AbstractCharIterator() {
                    final ObjectIterator<Map.Entry<Character, Byte>> i = AbstractChar2ByteMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Character, Byte>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry implements Entry
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Character && e.getValue() != null && e.getValue() instanceof Byte && this.key == (char)e.getKey() && this.value == (byte)e.getValue();
        }
