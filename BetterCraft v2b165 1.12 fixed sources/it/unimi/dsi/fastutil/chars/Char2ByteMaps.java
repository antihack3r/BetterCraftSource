    ...
    public static class Singleton extends Char2ByteFunctions.Singleton implements Char2ByteMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Char2ByteMap.Entry, Map.Entry<Character, Byte>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Character && e.getValue() != null && e.getValue() instanceof Byte && Singleton.this.key == (char)e.getKey() && Singleton.this.value == (byte)e.getValue();
            }
