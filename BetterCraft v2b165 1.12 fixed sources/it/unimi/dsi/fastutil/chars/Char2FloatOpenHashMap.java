...
public class Char2FloatOpenHashMap extends AbstractChar2FloatMap implements Serializable, Cloneable, Hash
{
    ...
    private int insert(final char k, final float v) {
        int pos;
        if (k == '\0') {
    ...
    final class MapEntry implements Char2FloatMap.Entry, Map.Entry<Character, Float>
    {
        ...
        public float setValue(final float v) {
            final float oldValue = Char2FloatOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2FloatOpenHashMap.this.key[this.index] == e.getKey() && Char2FloatOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            char k;
            int p;
            for (k = this.wrapped.getChar(-this.pos - 1), p = (HashCommon.mix(k) & Char2FloatOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Char2FloatOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Char2FloatOpenHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(curr) & Char2FloatOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Char2FloatOpenHashMap this$0 = Char2FloatOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet
    {
        ...
        public boolean rem(final Object o) {
            ...
            if (k == '\0') {
                ...
                if (curr != k) {
                    while ((curr = key[pos = (pos + 1 & Char2FloatOpenHashMap.this.mask)]) != '\0') {
                        if (curr == k && Char2FloatOpenHashMap.this.value[pos] == v) {
    ...
    private final class KeySet extends AbstractCharSet
    {
        ...
        public boolean rem(final char k) {
            final int oldSize = Char2FloatOpenHashMap.this.size;
