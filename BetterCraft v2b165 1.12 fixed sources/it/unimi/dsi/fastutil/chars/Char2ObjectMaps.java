...
public class Char2ObjectMaps
{
    ...
    public static <V> Char2ObjectMap<V> singleton(final char key, final V value) {
    ...
    public static class Singleton<V> extends Char2ObjectFunctions.Singleton<V> implements Char2ObjectMap<V>, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Character && Singleton.this.key == (char)e.getKey() && ((Singleton.this.value != null) ? Singleton.this.value.equals(e.getValue()) : (e.getValue() == null));
            }
