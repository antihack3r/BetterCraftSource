...
public class Char2BooleanAVLTreeMap extends AbstractChar2BooleanSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof CharComparator) {
            ...
            this.actualComparator = new CharComparator() {
                ...
                public int compare(final char k1, final char k2) {
                    return Char2BooleanAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Boolean put(final Character ok, final Boolean ov) {
        final boolean oldValue = this.put((char)ok, (boolean)ov);
    ...
    public Boolean remove(final Object ok) {
        final boolean oldValue = this.remove((char)ok);
