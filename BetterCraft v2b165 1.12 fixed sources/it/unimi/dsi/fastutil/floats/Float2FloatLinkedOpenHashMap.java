...
public class Float2FloatLinkedOpenHashMap extends AbstractFloat2FloatSortedMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Float2FloatMap.Entry, Map.Entry<Float, Float>
    {
        ...
        public float setValue(final float v) {
            final float oldValue = Float2FloatLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2FloatLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey()) && Float2FloatLinkedOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final float from) {
            ...
            if (Float.floatToIntBits(from) == 0) {
                ...
                for (int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2FloatLinkedOpenHashMap.this.mask; Float.floatToIntBits(Float2FloatLinkedOpenHashMap.this.key[pos]) != 0; pos = (pos + 1 & Float2FloatLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Float2FloatLinkedOpenHashMap this$0 = Float2FloatLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Float2FloatLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Float2FloatLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Float2FloatLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Float2FloatLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Float2FloatLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Float2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Float2FloatLinkedOpenHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2FloatLinkedOpenHashMap.this.mask;
                    Label_0360: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0360;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Float2FloatMap.Entry> implements Float2FloatSortedMap.FastSortedEntrySet
    {
        ...
        @Override
        public ObjectSortedSet<Float2FloatMap.Entry> subSet(final Float2FloatMap.Entry fromElement, final Float2FloatMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Float2FloatMap.Entry> headSet(final Float2FloatMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Float2FloatMap.Entry> tailSet(final Float2FloatMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean rem(final Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                ...
                if (Float.floatToIntBits(curr) != Float.floatToIntBits(k)) {
                    while (Float.floatToIntBits(curr = key[pos = (pos + 1 & Float2FloatLinkedOpenHashMap.this.mask)]) != 0) {
                        if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && Float2FloatLinkedOpenHashMap.this.value[pos] == v) {
    ...
    private final class KeySet extends AbstractFloatSortedSet
    {
        ...
        public boolean rem(final float k) {
            final int oldSize = Float2FloatLinkedOpenHashMap.this.size;
