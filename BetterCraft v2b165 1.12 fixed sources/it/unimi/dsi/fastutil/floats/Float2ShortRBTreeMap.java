...
public class Float2ShortRBTreeMap extends AbstractFloat2ShortSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof FloatComparator) {
            ...
            this.actualComparator = new FloatComparator() {
                ...
                public int compare(final float k1, final float k2) {
                    return Float2ShortRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Short put(final Float ok, final Short ov) {
        final short oldValue = this.put((float)ok, (short)ov);
    ...
    public Short remove(final Object ok) {
        final short oldValue = this.remove((float)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2ShortRBTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2ShortSortedMap implements Serializable
    {
        ...
        protected transient FloatSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Float2ShortRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2ShortRBTreeMap.Entry f = Float2ShortRBTreeMap.this.findKey((float)e.getKey());
        ...
        @Override
        public float firstFloatKey() {
            final Float2ShortRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public float lastFloatKey() {
            final Float2ShortRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2ShortRBTreeMap this$0 = submap.this$0;
                            final Float2ShortRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
