...
public class Float2LongOpenHashMap extends AbstractFloat2LongMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Float2LongMap.Entry, Map.Entry<Float, Long>
    {
        ...
        public long setValue(final long v) {
            final long oldValue = Float2LongOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2LongOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey()) && Float2LongOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            float k;
            int p;
            for (k = this.wrapped.getFloat(-this.pos - 1), p = (HashCommon.mix(HashCommon.float2int(k)) & Float2LongOpenHashMap.this.mask); Float.floatToIntBits(k) != Float.floatToIntBits(key[p]); p = (p + 1 & Float2LongOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Float2LongOpenHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2LongOpenHashMap.this.mask;
                    Label_0105: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0105;
        ...
        public void remove() {
            ...
            final Float2LongOpenHashMap this$0 = Float2LongOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractFloatSet
    {
        ...
        public boolean rem(final float k) {
            final int oldSize = Float2LongOpenHashMap.this.size;
