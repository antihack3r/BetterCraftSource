...
public class Float2ObjectOpenHashMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Float2ObjectMap.Entry<V>, Map.Entry<Float, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey()) && ((Float2ObjectOpenHashMap.this.value[this.index] != null) ? Float2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                return Float2ObjectOpenHashMap.this.containsNullKey && ((Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n] != null) ? Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n].equals(v) : (v == null));
            }
            final float[] key = Float2ObjectOpenHashMap.this.key;
            int pos;
            float curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                if (Float2ObjectOpenHashMap.this.containsNullKey) {
                    if (Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
                if (Float2ObjectOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Float2ObjectOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
