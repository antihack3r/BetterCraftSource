...
public class Float2ObjectOpenCustomHashMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Float2ObjectMap.Entry<V>, Map.Entry<Float, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Float2ObjectOpenCustomHashMap.this.value[this.index] != null) ? Float2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Float2ObjectOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2ObjectOpenCustomHashMap.this.containsNullKey && ((Float2ObjectOpenCustomHashMap.this.value[Float2ObjectOpenCustomHashMap.this.n] != null) ? Float2ObjectOpenCustomHashMap.this.value[Float2ObjectOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final float[] key = Float2ObjectOpenCustomHashMap.this.key;
            int pos;
            float curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Float2ObjectOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                    if (Float2ObjectOpenCustomHashMap.this.value[Float2ObjectOpenCustomHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Float2ObjectOpenCustomHashMap.this.value[Float2ObjectOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Float2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float2ObjectOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Float2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
