...
public class Float2ByteOpenCustomHashMap extends AbstractFloat2ByteMap implements Serializable, Cloneable, Hash
{
    ...
    public Float2ByteOpenCustomHashMap(final int expected, final float f, final FloatHash.Strategy strategy) {
    ...
    public Float2ByteOpenCustomHashMap(final int expected, final FloatHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Float2ByteOpenCustomHashMap(final FloatHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Float2ByteOpenCustomHashMap(final Map<? extends Float, ? extends Byte> m, final float f, final FloatHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Float2ByteOpenCustomHashMap(final Map<? extends Float, ? extends Byte> m, final FloatHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Float2ByteOpenCustomHashMap(final Float2ByteMap m, final float f, final FloatHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Float2ByteOpenCustomHashMap(final Float2ByteMap m, final FloatHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Float2ByteOpenCustomHashMap(final float[] k, final byte[] v, final float f, final FloatHash.Strategy strategy) {
    ...
    public Float2ByteOpenCustomHashMap(final float[] k, final byte[] v, final FloatHash.Strategy strategy) {
    ...
    final class MapEntry implements Float2ByteMap.Entry, Map.Entry<Float, Byte>
    {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Float2ByteOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float2ByteOpenCustomHashMap.this.strategy.equals(Float2ByteOpenCustomHashMap.this.key[this.index], e.getKey()) && Float2ByteOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            float k;
            int p;
            for (k = this.wrapped.getFloat(-this.pos - 1), p = (HashCommon.mix(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ByteOpenCustomHashMap.this.mask); !Float2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Float2ByteOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Float2ByteOpenCustomHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Float2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Float2ByteOpenCustomHashMap.this.mask;
                    Label_0114: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0114;
        ...
        public void remove() {
            ...
            final Float2ByteOpenCustomHashMap this$0 = Float2ByteOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet
    {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            float curr;
            if (Float.floatToIntBits(curr = key[pos = (HashCommon.mix(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ByteOpenCustomHashMap.this.mask)]) == 0) {
                return false;
            }
    ...
    private final class KeySet extends AbstractFloatSet
    {
        ...
        public boolean rem(final float k) {
            final int oldSize = Float2ByteOpenCustomHashMap.this.size;
