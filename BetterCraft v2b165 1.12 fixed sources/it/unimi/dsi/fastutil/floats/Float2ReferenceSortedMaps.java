...
public class Float2ReferenceSortedMaps
{
    ...
    public static <V> Float2ReferenceSortedMap<V> singleton(final Float key, final V value, final FloatComparator comparator) {
    ...
    public static class EmptySortedMap<V> extends Float2ReferenceMaps.EmptyMap<V> implements Float2ReferenceSortedMap<V>, Serializable, Cloneable
    {
        ...
        @Deprecated
        @Override
        public Float2ReferenceSortedMap<V> headMap(final Float oto) {
            return this.headMap((float)oto);
        }
        
        @Deprecated
        @Override
        public Float2ReferenceSortedMap<V> tailMap(final Float ofrom) {
            return this.tailMap((float)ofrom);
        }
        
        @Deprecated
        @Override
        public Float2ReferenceSortedMap<V> subMap(final Float ofrom, final Float oto) {
    ...
    public static class Singleton<V> extends Float2ReferenceMaps.Singleton<V> implements Float2ReferenceSortedMap<V>, Serializable, Cloneable
    {
        ...
        public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = (ObjectSet<Float2ReferenceMap.Entry<V>>)ObjectSortedSets.singleton(new SingletonEntry(), Float2ReferenceSortedMaps.entryComparator(this.comparator));
            }
    ...
    public static class SynchronizedSortedMap<V> extends Float2ReferenceMaps.SynchronizedMap<V> implements Float2ReferenceSortedMap<V>, Serializable
    {
        ...
        @Override
        public Float2ReferenceSortedMap<V> subMap(final float from, final float to) {
            return new SynchronizedSortedMap((Float2ReferenceSortedMap<Object>)this.sortedMap.subMap(from, to), this.sync);
        }
        
        @Override
        public Float2ReferenceSortedMap<V> headMap(final float to) {
            return new SynchronizedSortedMap((Float2ReferenceSortedMap<Object>)this.sortedMap.headMap(to), this.sync);
        }
        
        @Override
        public Float2ReferenceSortedMap<V> tailMap(final float from) {
            return new SynchronizedSortedMap((Float2ReferenceSortedMap<Object>)this.sortedMap.tailMap(from), this.sync);
        }
    ...
    public static class UnmodifiableSortedMap<V> extends Float2ReferenceMaps.UnmodifiableMap<V> implements Float2ReferenceSortedMap<V>, Serializable
    {
        ...
        @Override
        public Float2ReferenceSortedMap<V> subMap(final float from, final float to) {
            return new UnmodifiableSortedMap((Float2ReferenceSortedMap<Object>)this.sortedMap.subMap(from, to));
        }
        
        @Override
        public Float2ReferenceSortedMap<V> headMap(final float to) {
            return new UnmodifiableSortedMap((Float2ReferenceSortedMap<Object>)this.sortedMap.headMap(to));
        }
        
        @Override
        public Float2ReferenceSortedMap<V> tailMap(final float from) {
            return new UnmodifiableSortedMap((Float2ReferenceSortedMap<Object>)this.sortedMap.tailMap(from));
        }
