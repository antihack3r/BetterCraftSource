...
public class Float2LongAVLTreeMap extends AbstractFloat2LongSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof FloatComparator) {
            ...
            this.actualComparator = new FloatComparator() {
                ...
                public int compare(final float k1, final float k2) {
                    return Float2LongAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Long put(final Float ok, final Long ov) {
        final long oldValue = this.put((float)ok, (long)ov);
    ...
    public Long remove(final Object ok) {
        final long oldValue = this.remove((float)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2LongAVLTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2LongSortedMap implements Serializable
    {
        ...
        protected transient FloatSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Float2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey((float)e.getKey());
        ...
        @Override
        public float firstFloatKey() {
            final Float2LongAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public float lastFloatKey() {
            final Float2LongAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2LongAVLTreeMap this$0 = submap.this$0;
                            final Float2LongAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
