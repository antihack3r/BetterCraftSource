...
public class Float2ByteAVLTreeMap extends AbstractFloat2ByteSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof FloatComparator) {
            ...
            this.actualComparator = new FloatComparator() {
                ...
                public int compare(final float k1, final float k2) {
                    return Float2ByteAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Byte put(final Float ok, final Byte ov) {
        final byte oldValue = this.put((float)ok, (byte)ov);
    ...
    public Byte remove(final Object ok) {
        final byte oldValue = this.remove((float)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2ByteAVLTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2ByteSortedMap implements Serializable
    {
        ...
        protected transient FloatSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Float2ByteAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey((float)e.getKey());
        ...
        @Override
        public float firstFloatKey() {
            final Float2ByteAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public float lastFloatKey() {
            final Float2ByteAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2ByteAVLTreeMap this$0 = submap.this$0;
                            final Float2ByteAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
