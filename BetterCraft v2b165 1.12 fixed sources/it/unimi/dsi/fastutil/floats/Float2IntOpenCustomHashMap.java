...
public class Float2IntOpenCustomHashMap extends AbstractFloat2IntMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Float2IntMap.Entry, Map.Entry<Float, Integer>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[this.index], e.getKey()) && Float2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
