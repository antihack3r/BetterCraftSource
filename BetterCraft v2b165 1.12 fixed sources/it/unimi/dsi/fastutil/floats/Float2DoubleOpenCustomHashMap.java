...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements Serializable, Cloneable, Hash
{
    ...
    private int insert(final float k, final double v) {
        int pos;
    ...
    final class MapEntry implements Float2DoubleMap.Entry, Map.Entry<Float, Double>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Float2DoubleOpenCustomHashMap.this.strategy.equals(Float2DoubleOpenCustomHashMap.this.key[this.index], e.getKey()) && Float2DoubleOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public boolean rem(final Object o) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                ...
                if (!Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (Float.floatToIntBits(curr = key[pos = (pos + 1 & Float2DoubleOpenCustomHashMap.this.mask)]) != 0) {
                        if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Float2DoubleOpenCustomHashMap.this.value[pos] == v) {
