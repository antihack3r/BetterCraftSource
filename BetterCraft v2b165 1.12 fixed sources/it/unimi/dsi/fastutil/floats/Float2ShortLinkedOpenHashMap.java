...
public class Float2ShortLinkedOpenHashMap extends AbstractFloat2ShortSortedMap implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Float2ShortMap.Entry, Map.Entry<Float, Short>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey()) && Float2ShortLinkedOpenHashMap.this.value[this.index] == e.getValue();
        }
