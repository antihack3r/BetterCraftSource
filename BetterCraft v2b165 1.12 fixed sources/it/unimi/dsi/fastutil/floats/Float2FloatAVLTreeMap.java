...
public class Float2FloatAVLTreeMap extends AbstractFloat2FloatSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof FloatComparator) {
            ...
            this.actualComparator = new FloatComparator() {
                ...
                public int compare(final float k1, final float k2) {
                    return Float2FloatAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Float put(final Float ok, final Float ov) {
        final float oldValue = this.put((float)ok, (float)ov);
    ...
    public Float remove(final Object ok) {
        final float oldValue = this.remove((float)ok);
