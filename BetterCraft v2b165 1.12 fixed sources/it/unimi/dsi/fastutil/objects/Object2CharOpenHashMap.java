...
public class Object2CharOpenHashMap<K> extends AbstractObject2CharMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2CharOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2CharOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2CharOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Object2CharOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2CharOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
