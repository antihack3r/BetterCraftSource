...
public class Object2BooleanOpenHashMap<K> extends AbstractObject2BooleanMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2BooleanOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2BooleanOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2BooleanOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Object2BooleanOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2BooleanOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
                this.shiftKeys(this.last);
            }
            final Object2BooleanOpenHashMap this$0 = Object2BooleanOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
