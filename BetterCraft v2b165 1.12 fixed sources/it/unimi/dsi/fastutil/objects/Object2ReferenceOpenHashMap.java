...
public class Object2ReferenceOpenHashMap<K, V> extends AbstractObject2ReferenceMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ReferenceOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ReferenceOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2ReferenceOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
