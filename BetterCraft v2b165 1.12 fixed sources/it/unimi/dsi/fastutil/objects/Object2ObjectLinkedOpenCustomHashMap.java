...
public class Object2ObjectLinkedOpenCustomHashMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(Object2ObjectLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Object2ObjectLinkedOpenCustomHashMap.this.value[this.index] != null) ? Object2ObjectLinkedOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectSortedMap.FastSortedEntrySet<K, V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey && ((Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n] != null) ? Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final K[] key = Object2ObjectLinkedOpenCustomHashMap.this.key;
            int pos;
            K curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey) {
                    ...
                    else if (!Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Object2ObjectLinkedOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Object2ObjectLinkedOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
