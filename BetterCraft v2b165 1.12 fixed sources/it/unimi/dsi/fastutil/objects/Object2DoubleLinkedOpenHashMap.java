...
public class Object2DoubleLinkedOpenHashMap<K> extends AbstractObject2DoubleSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2DoubleLinkedOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2DoubleLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2DoubleLinkedOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.last].equals(from)) {
                        break Label_0147;
                    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2DoubleMap.Entry<K>> implements Object2DoubleSortedMap.FastSortedEntrySet<K>
    {
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                ...
                if (!curr.equals(k)) {
                    while ((curr = key[pos = (pos + 1 & Object2DoubleLinkedOpenHashMap.this.mask)]) != null) {
                        if (curr.equals(k) && Object2DoubleLinkedOpenHashMap.this.value[pos] == v) {
