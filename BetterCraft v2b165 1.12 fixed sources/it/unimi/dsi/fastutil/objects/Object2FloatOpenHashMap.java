...
public class Object2FloatOpenHashMap<K> extends AbstractObject2FloatMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2FloatMap.Entry<K>, Map.Entry<K, Float>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2FloatOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2FloatOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2FloatOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Object2FloatOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2FloatOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<K>> implements Object2FloatMap.FastEntrySet<K>
    {
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                ...
                if (!curr.equals(k)) {
                    while ((curr = key[pos = (pos + 1 & Object2FloatOpenHashMap.this.mask)]) != null) {
                        if (curr.equals(k) && Object2FloatOpenHashMap.this.value[pos] == v) {
