...
public class Object2ObjectOpenHashMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ObjectOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ObjectOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if ((Object2ObjectOpenHashMap.this.value[this.index] != null) ? Object2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null)) {
                return true;
            }
            return false;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectMap.FastEntrySet<K, V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == null) {
                return Object2ObjectOpenHashMap.this.containsNullKey && ((Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n] != null) ? Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n].equals(v) : (v == null));
            }
            final K[] key = Object2ObjectOpenHashMap.this.key;
            int pos;
            K curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                if (Object2ObjectOpenHashMap.this.containsNullKey) {
                    if (Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr.equals(k)) {
                if (Object2ObjectOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Object2ObjectOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
