...
public class ObjectLinkedOpenHashSet<K> extends AbstractObjectSortedSet<K> implements Serializable, Cloneable, Hash
{
    ...
    private class SetIterator extends AbstractObjectListIterator<K>
    {
        ...
        SetIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (ObjectLinkedOpenHashSet.this.key[ObjectLinkedOpenHashSet.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!ObjectLinkedOpenHashSet.this.key[ObjectLinkedOpenHashSet.this.last].equals(from)) {
                        break Label_0147;
                    }
