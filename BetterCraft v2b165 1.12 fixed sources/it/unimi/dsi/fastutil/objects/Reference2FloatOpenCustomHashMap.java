...
public class Reference2FloatOpenCustomHashMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2FloatMap.Entry<K>, Map.Entry<K, Float>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2FloatOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Reference2FloatOpenCustomHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Reference2FloatOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
        ...
        public boolean rem(final Object o) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                ...
                if (!Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Reference2FloatOpenCustomHashMap.this.mask)]) != null) {
                        if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && Reference2FloatOpenCustomHashMap.this.value[pos] == v) {
