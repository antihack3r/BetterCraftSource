...
public abstract class AbstractReference2ShortMap<K> extends AbstractReference2ShortFunction<K> implements Reference2ShortMap<K>, Serializable
{
        ...
        return new AbstractReferenceSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new AbstractObjectIterator<K>() {
                    final ObjectIterator<Map.Entry<K, Short>> i = AbstractReference2ShortMap.this.entrySet().iterator();
    ...
    public static class BasicEntry<K> implements Entry<K>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getValue() != null && e.getValue() instanceof Short && this.key == e.getKey() && this.value == (short)e.getValue();
        }
