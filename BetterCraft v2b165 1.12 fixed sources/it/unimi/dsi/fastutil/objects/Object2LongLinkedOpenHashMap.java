...
public class Object2LongLinkedOpenHashMap<K> extends AbstractObject2LongSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2LongMap.Entry<K>, Map.Entry<K, Long>
    {
        ...
        public boolean equals(final Object o) {
            ...
            else if (!Object2LongLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2LongLinkedOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (Object2LongLinkedOpenHashMap.this.key[Object2LongLinkedOpenHashMap.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!Object2LongLinkedOpenHashMap.this.key[Object2LongLinkedOpenHashMap.this.last].equals(from)) {
                        break Label_0147;
                    }
