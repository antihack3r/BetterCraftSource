...
public class Reference2ObjectOpenCustomHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2ObjectOpenCustomHashMap.this.strategy.equals(Reference2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && ((Reference2ObjectOpenCustomHashMap.this.value[this.index] != null) ? Reference2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Reference2ObjectOpenCustomHashMap.this.containsNullKey && ((Reference2ObjectOpenCustomHashMap.this.value[Reference2ObjectOpenCustomHashMap.this.n] != null) ? Reference2ObjectOpenCustomHashMap.this.value[Reference2ObjectOpenCustomHashMap.this.n].equals(v) : (v == null));
            }
            final K[] key = Reference2ObjectOpenCustomHashMap.this.key;
            int pos;
            K curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
                    if (Reference2ObjectOpenCustomHashMap.this.value[Reference2ObjectOpenCustomHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Reference2ObjectOpenCustomHashMap.this.value[Reference2ObjectOpenCustomHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Reference2ObjectOpenCustomHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Reference2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
                    return false;
                }
