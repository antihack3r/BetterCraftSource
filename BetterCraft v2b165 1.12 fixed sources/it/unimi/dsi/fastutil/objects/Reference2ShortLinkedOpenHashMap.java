...
public class Reference2ShortLinkedOpenHashMap<K> extends AbstractReference2ShortSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2ShortMap.Entry<K>, Map.Entry<K, Short>
    {
        ...
        public short setValue(final short v) {
            final short oldValue = Reference2ShortLinkedOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2ShortLinkedOpenHashMap.this.mask; Reference2ShortLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Reference2ShortLinkedOpenHashMap this$0 = Reference2ShortLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Reference2ShortLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Reference2ShortLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Reference2ShortLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Reference2ShortLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Reference2ShortLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ShortLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ShortLinkedOpenHashMap.this.mask;
                    Label_0374: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0374;
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Reference2ShortMap.Entry<K>>
    {
        ...
        @Override
        public void set(final Reference2ShortMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Reference2ShortMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ShortMap.Entry<K>> implements Reference2ShortSortedMap.FastSortedEntrySet<K>
    {
        ...
        @Override
        public ObjectSortedSet<Reference2ShortMap.Entry<K>> subSet(final Reference2ShortMap.Entry<K> fromElement, final Reference2ShortMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2ShortMap.Entry<K>> headSet(final Reference2ShortMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2ShortMap.Entry<K>> tailSet(final Reference2ShortMap.Entry<K> fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Reference2ShortLinkedOpenHashMap.this.size;
