...
public class Object2ByteLinkedOpenHashMap<K> extends AbstractObject2ByteSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ByteMap.Entry<K>, Map.Entry<K, Byte>
    {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Object2ByteLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ByteLinkedOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ByteLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2ByteLinkedOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (Object2ByteLinkedOpenHashMap.this.key[Object2ByteLinkedOpenHashMap.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!Object2ByteLinkedOpenHashMap.this.key[Object2ByteLinkedOpenHashMap.this.last].equals(from)) {
                        break Label_0147;
                    }
                ...
                for (int pos = HashCommon.mix(from.hashCode()) & Object2ByteLinkedOpenHashMap.this.mask; Object2ByteLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Object2ByteLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2ByteLinkedOpenHashMap this$0 = Object2ByteLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2ByteLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2ByteLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2ByteLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2ByteLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2ByteLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2ByteLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2ByteLinkedOpenHashMap.this.mask;
                    Label_0373: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0373;
    ...
    private final class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2ByteLinkedOpenHashMap.this.size;
