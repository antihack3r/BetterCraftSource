...
public class Object2ByteAVLTreeMap<K> extends AbstractObject2ByteSortedMap<K> implements Serializable, Cloneable
{
    ...
    public Byte put(final K ok, final Byte ov) {
        final byte oldValue = this.put(ok, (byte)ov);
    ...
    public Byte remove(final Object ok) {
        final byte oldValue = this.removeByte(ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2ByteAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(final Object2ByteMap.Entry<K> from, final Object2ByteMap.Entry<K> to) {
                    return Object2ByteAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(final Object2ByteMap.Entry<K> to) {
                    return Object2ByteAVLTreeMap.this.headMap(to.getKey()).object2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(final Object2ByteMap.Entry<K> from) {
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private class KeySet extends AbstractObject2ByteSortedMap.KeySet
    {
        @Override
    ...
    private final class Submap extends AbstractObject2ByteSortedMap<K> implements Serializable
    {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient ByteCollection values;
        final /* synthetic */ Object2ByteAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2ByteAVLTreeMap.Entry<K> f = (Object2ByteAVLTreeMap.Entry<K>)Object2ByteAVLTreeMap.this.findKey(e.getKey());
        ...
        @Override
        public K firstKey() {
            final Object2ByteAVLTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public K lastKey() {
            final Object2ByteAVLTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2ByteAVLTreeMap this$0 = submap.this$0;
                            final Object2ByteAVLTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
