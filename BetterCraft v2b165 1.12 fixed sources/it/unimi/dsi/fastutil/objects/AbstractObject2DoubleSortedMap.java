...
public abstract class AbstractObject2DoubleSortedMap<K> extends AbstractObject2DoubleMap<K> implements Object2DoubleSortedMap<K>
{
    ...
    protected class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public ObjectBidirectionalIterator<K> iterator(final K from) {
            return new KeySetIterator<K>((ObjectBidirectionalIterator<Map.Entry<K, Double>>)AbstractObject2DoubleSortedMap.this.entrySet().iterator(new BasicEntry<K>(from, 0.0)));
        }
        
        @Override
        public ObjectBidirectionalIterator<K> iterator() {
            return new KeySetIterator<K>(AbstractObject2DoubleSortedMap.this.entrySet().iterator());
        }
    }
    ...
    protected class ValuesCollection extends AbstractDoubleCollection
    {
        ...
        public DoubleIterator iterator() {
            return new ValuesIterator<Object>((ObjectBidirectionalIterator<Map.Entry<?, Double>>)AbstractObject2DoubleSortedMap.this.entrySet().iterator());
        }
