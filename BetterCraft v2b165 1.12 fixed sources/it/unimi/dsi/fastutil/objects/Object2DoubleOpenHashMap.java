...
public class Object2DoubleOpenHashMap<K> extends AbstractObject2DoubleMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double>
    {
        ...
        public double setValue(final double v) {
            final double oldValue = Object2DoubleOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2DoubleOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2DoubleOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2DoubleOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(k.hashCode()) & Object2DoubleOpenHashMap.this.mask); !k.equals(key[p]); p = (p + 1 & Object2DoubleOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Object2DoubleOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2DoubleOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            if (this.last == Object2DoubleOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2DoubleOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
                this.shiftKeys(this.last);
            }
            final Object2DoubleOpenHashMap this$0 = Object2DoubleOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>> implements Object2DoubleMap.FastEntrySet<K>
    {
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                ...
                if (!curr.equals(k)) {
                    while ((curr = key[pos = (pos + 1 & Object2DoubleOpenHashMap.this.mask)]) != null) {
                        if (curr.equals(k) && Object2DoubleOpenHashMap.this.value[pos] == v) {
    ...
    private final class KeySet extends AbstractObjectSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2DoubleOpenHashMap.this.size;
