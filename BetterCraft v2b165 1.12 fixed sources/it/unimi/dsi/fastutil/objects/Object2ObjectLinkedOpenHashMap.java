...
public class Object2ObjectLinkedOpenHashMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ObjectLinkedOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ObjectLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if ((Object2ObjectLinkedOpenHashMap.this.value[this.index] != null) ? Object2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null)) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last].equals(from)) {
                        break Label_0147;
                    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectSortedMap.FastSortedEntrySet<K, V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == null) {
                return Object2ObjectLinkedOpenHashMap.this.containsNullKey && ((Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n] != null) ? Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n].equals(v) : (v == null));
            }
            final K[] key = Object2ObjectLinkedOpenHashMap.this.key;
            int pos;
            K curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                if (Object2ObjectLinkedOpenHashMap.this.containsNullKey) {
                    if (Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr.equals(k)) {
                if (Object2ObjectLinkedOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Object2ObjectLinkedOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
