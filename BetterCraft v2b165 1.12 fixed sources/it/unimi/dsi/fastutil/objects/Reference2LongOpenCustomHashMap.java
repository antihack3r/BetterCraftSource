...
public class Reference2LongOpenCustomHashMap<K> extends AbstractReference2LongMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2LongMap.Entry<K>, Map.Entry<K, Long>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2LongOpenCustomHashMap.this.strategy.equals(Reference2LongOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2LongOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Reference2LongOpenCustomHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Reference2LongOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
