...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2IntMap.Entry<K>, Map.Entry<K, Integer>
    {
        ...
        public boolean equals(final Object o) {
            ...
            else if (!Object2IntOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2IntOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Object2IntOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2IntOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
