...
public class Object2IntLinkedOpenCustomHashMap<K> extends AbstractObject2IntSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2IntMap.Entry<K>, Map.Entry<K, Integer>
    {
        ...
        public int setValue(final int v) {
            final int oldValue = Object2IntLinkedOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2IntLinkedOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
                ...
                for (int pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2IntLinkedOpenCustomHashMap.this.mask; Object2IntLinkedOpenCustomHashMap.this.key[pos] != null; pos = (pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2IntLinkedOpenCustomHashMap this$0 = Object2IntLinkedOpenCustomHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2IntLinkedOpenCustomHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2IntLinkedOpenCustomHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2IntLinkedOpenCustomHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2IntLinkedOpenCustomHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2IntLinkedOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2IntLinkedOpenCustomHashMap.this.mask;
                    Label_0382: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0382;
    ...
    private final class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2IntLinkedOpenCustomHashMap.this.size;
