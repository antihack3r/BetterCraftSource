...
public class Object2ShortOpenHashMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ShortMap.Entry<K>, Map.Entry<K, Short>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ShortOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ShortOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2ShortOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Object2ShortOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2ShortOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
