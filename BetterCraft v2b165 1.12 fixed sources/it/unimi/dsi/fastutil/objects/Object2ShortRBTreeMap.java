...
public class Object2ShortRBTreeMap<K> extends AbstractObject2ShortSortedMap<K> implements Serializable, Cloneable
{
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2ShortRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2ShortSortedMap<K> implements Serializable
    {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient ShortCollection values;
        final /* synthetic */ Object2ShortRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2ShortRBTreeMap.Entry<K> f = (Object2ShortRBTreeMap.Entry<K>)Object2ShortRBTreeMap.this.findKey(e.getKey());
        ...
        @Override
        public K firstKey() {
            final Object2ShortRBTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public K lastKey() {
            final Object2ShortRBTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2ShortRBTreeMap this$0 = submap.this$0;
                            final Object2ShortRBTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
