...
public abstract class AbstractReference2BooleanMap<K> extends AbstractReference2BooleanFunction<K> implements Reference2BooleanMap<K>, Serializable
{
        ...
        return new AbstractReferenceSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new AbstractObjectIterator<K>() {
                    final ObjectIterator<Map.Entry<K, Boolean>> i = AbstractReference2BooleanMap.this.entrySet().iterator();
    ...
    public static class BasicEntry<K> implements Entry<K>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getValue() != null && e.getValue() instanceof Boolean && this.key == e.getKey() && this.value == (boolean)e.getValue();
        }
