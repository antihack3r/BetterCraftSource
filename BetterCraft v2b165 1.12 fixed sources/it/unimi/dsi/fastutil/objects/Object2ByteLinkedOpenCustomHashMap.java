...
public class Object2ByteLinkedOpenCustomHashMap<K> extends AbstractObject2ByteSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ByteMap.Entry<K>, Map.Entry<K, Byte>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2ByteLinkedOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            final Object2ByteLinkedOpenCustomHashMap this$0 = Object2ByteLinkedOpenCustomHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2ByteLinkedOpenCustomHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2ByteLinkedOpenCustomHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2ByteLinkedOpenCustomHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2ByteLinkedOpenCustomHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2ByteLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ByteLinkedOpenCustomHashMap.this.mask;
                    Label_0382: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0382;
