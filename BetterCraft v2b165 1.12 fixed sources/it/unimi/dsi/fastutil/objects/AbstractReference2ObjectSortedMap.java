...
public abstract class AbstractReference2ObjectSortedMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Reference2ObjectSortedMap<K, V>
{
    ...
    protected class KeySet extends AbstractReferenceSortedSet<K>
    {
        ...
        public ObjectBidirectionalIterator<K> iterator(final K from) {
            return (ObjectBidirectionalIterator<K>)new KeySetIterator((ObjectBidirectionalIterator<Map.Entry<Object, Object>>)AbstractReference2ObjectSortedMap.this.entrySet().iterator(new BasicEntry<K, V>(from, null)));
        }
        
        @Override
        public ObjectBidirectionalIterator<K> iterator() {
            return (ObjectBidirectionalIterator<K>)new KeySetIterator((ObjectBidirectionalIterator<Map.Entry<Object, Object>>)AbstractReference2ObjectSortedMap.this.entrySet().iterator());
        }
    }
    ...
    protected class ValuesCollection extends AbstractObjectCollection<V>
    {
        ...
        public ObjectIterator<V> iterator() {
            return (ObjectIterator<V>)new ValuesIterator((ObjectBidirectionalIterator<Map.Entry<Object, Object>>)AbstractReference2ObjectSortedMap.this.entrySet().iterator());
        }
