...
public class Object2DoubleAVLTreeMap<K> extends AbstractObject2DoubleSortedMap<K> implements Serializable, Cloneable
{
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2DoubleAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2DoubleSortedMap<K> implements Serializable
    {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Object2DoubleAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2DoubleAVLTreeMap.Entry<K> f = (Object2DoubleAVLTreeMap.Entry<K>)Object2DoubleAVLTreeMap.this.findKey(e.getKey());
        ...
        @Override
        public K firstKey() {
            final Object2DoubleAVLTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public K lastKey() {
            final Object2DoubleAVLTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2DoubleAVLTreeMap this$0 = submap.this$0;
                            final Object2DoubleAVLTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
