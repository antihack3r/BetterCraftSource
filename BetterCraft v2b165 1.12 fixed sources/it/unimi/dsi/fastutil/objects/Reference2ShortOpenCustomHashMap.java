...
public class Reference2ShortOpenCustomHashMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2ShortMap.Entry<K>, Map.Entry<K, Short>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2ShortOpenCustomHashMap.this.strategy.equals(Reference2ShortOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2ShortOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Reference2ShortOpenCustomHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Reference2ShortOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
