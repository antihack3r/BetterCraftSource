...
public class Object2DoubleOpenCustomHashMap<K> extends AbstractObject2DoubleMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double>
    {
        ...
        public double setValue(final double v) {
            final double oldValue = Object2DoubleOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2DoubleOpenCustomHashMap.this.strategy.equals(Object2DoubleOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2DoubleOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Object2DoubleOpenCustomHashMap.this.mask); !Object2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Object2DoubleOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Object2DoubleOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2DoubleOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            if (this.last == Object2DoubleOpenCustomHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2DoubleOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
                this.shiftKeys(this.last);
            }
            final Object2DoubleOpenCustomHashMap this$0 = Object2DoubleOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
        ...
        public boolean rem(final Object o) {
            ...
            if (Object2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
                ...
                if (!Object2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Object2DoubleOpenCustomHashMap.this.mask)]) != null) {
                        if (Object2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Object2DoubleOpenCustomHashMap.this.value[pos] == v) {
    ...
    private final class KeySet extends AbstractObjectSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2DoubleOpenCustomHashMap.this.size;
