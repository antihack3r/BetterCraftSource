...
public class Reference2FloatLinkedOpenHashMap<K> extends AbstractReference2FloatSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2FloatMap.Entry<K>, Map.Entry<K, Float>
    {
        ...
        public float setValue(final float v) {
            final float oldValue = Reference2FloatLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2FloatLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2FloatLinkedOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2FloatLinkedOpenHashMap.this.mask; Reference2FloatLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Reference2FloatLinkedOpenHashMap this$0 = Reference2FloatLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Reference2FloatLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Reference2FloatLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Reference2FloatLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Reference2FloatLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Reference2FloatLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Reference2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Reference2FloatLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2FloatLinkedOpenHashMap.this.mask;
                    Label_0374: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0374;
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Reference2FloatMap.Entry<K>>
    {
        ...
        @Override
        public void set(final Reference2FloatMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Reference2FloatMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2FloatMap.Entry<K>> implements Reference2FloatSortedMap.FastSortedEntrySet<K>
    {
        ...
        @Override
        public ObjectSortedSet<Reference2FloatMap.Entry<K>> subSet(final Reference2FloatMap.Entry<K> fromElement, final Reference2FloatMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2FloatMap.Entry<K>> headSet(final Reference2FloatMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2FloatMap.Entry<K>> tailSet(final Reference2FloatMap.Entry<K> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                ...
                if (curr != k) {
                    while ((curr = key[pos = (pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask)]) != null) {
                        if (curr == k && Reference2FloatLinkedOpenHashMap.this.value[pos] == v) {
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Reference2FloatLinkedOpenHashMap.this.size;
