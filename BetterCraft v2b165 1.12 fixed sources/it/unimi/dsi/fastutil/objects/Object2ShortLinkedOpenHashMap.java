...
public class Object2ShortLinkedOpenHashMap<K> extends AbstractObject2ShortSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ShortMap.Entry<K>, Map.Entry<K, Short>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ShortLinkedOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ShortLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2ShortLinkedOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last].equals(from)) {
                        break Label_0147;
                    }
