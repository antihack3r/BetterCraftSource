...
public class Object2LongSortedMaps
{
    ...
    public static <K> Object2LongSortedMap<K> singleton(final K key, final Long value, final Comparator<? super K> comparator) {
    ...
    public static class Singleton<K> extends Object2LongMaps.Singleton<K> implements Object2LongSortedMap<K>, Serializable, Cloneable
    {
        ...
        public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
            if (this.entries == null) {
                this.entries = (ObjectSet<Object2LongMap.Entry<K>>)ObjectSortedSets.singleton(new SingletonEntry(), (Comparator<? super SingletonEntry>)Object2LongSortedMaps.entryComparator(this.comparator));
            }
    ...
    public static class SynchronizedSortedMap<K> extends Object2LongMaps.SynchronizedMap<K> implements Object2LongSortedMap<K>, Serializable
    {
        ...
        @Override
        public Object2LongSortedMap<K> subMap(final K from, final K to) {
            return new SynchronizedSortedMap((Object2LongSortedMap<Object>)this.sortedMap.subMap(from, to), this.sync);
        }
        
        @Override
        public Object2LongSortedMap<K> headMap(final K to) {
            return new SynchronizedSortedMap((Object2LongSortedMap<Object>)this.sortedMap.headMap(to), this.sync);
        }
        
        @Override
        public Object2LongSortedMap<K> tailMap(final K from) {
            return new SynchronizedSortedMap((Object2LongSortedMap<Object>)this.sortedMap.tailMap(from), this.sync);
        }
    ...
    public static class UnmodifiableSortedMap<K> extends Object2LongMaps.UnmodifiableMap<K> implements Object2LongSortedMap<K>, Serializable
    {
        ...
        @Override
        public Object2LongSortedMap<K> subMap(final K from, final K to) {
            return new UnmodifiableSortedMap((Object2LongSortedMap<Object>)this.sortedMap.subMap(from, to));
        }
        
        @Override
        public Object2LongSortedMap<K> headMap(final K to) {
            return new UnmodifiableSortedMap((Object2LongSortedMap<Object>)this.sortedMap.headMap(to));
        }
        
        @Override
        public Object2LongSortedMap<K> tailMap(final K from) {
            return new UnmodifiableSortedMap((Object2LongSortedMap<Object>)this.sortedMap.tailMap(from));
        }
