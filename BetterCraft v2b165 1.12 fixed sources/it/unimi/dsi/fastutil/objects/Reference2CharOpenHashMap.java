...
public class Reference2CharOpenHashMap<K> extends AbstractReference2CharMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2CharMap.Entry<K>, Map.Entry<K, Character>
    {
        ...
        public char setValue(final char v) {
            final char oldValue = Reference2CharOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(System.identityHashCode(k)) & Reference2CharOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Reference2CharOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2CharOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2CharOpenHashMap.this.mask;
                    Label_0103: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0103;
        ...
        public void remove() {
            ...
            if (this.last == Reference2CharOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Reference2CharOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
                this.shiftKeys(this.last);
            }
            final Reference2CharOpenHashMap this$0 = Reference2CharOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Reference2CharOpenHashMap.this.size;
