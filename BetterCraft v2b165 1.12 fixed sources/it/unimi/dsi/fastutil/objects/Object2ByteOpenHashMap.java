...
public class Object2ByteOpenHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ByteMap.Entry<K>, Map.Entry<K, Byte>
    {
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ByteOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ByteOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2ByteOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        public void remove() {
            ...
            if (this.last == Object2ByteOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2ByteOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
