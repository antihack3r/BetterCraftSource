...
public class Reference2ObjectLinkedOpenHashMap<K, V> extends AbstractReference2ObjectSortedMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2ObjectLinkedOpenHashMap.this.key[this.index] == e.getKey() && ((Reference2ObjectLinkedOpenHashMap.this.value[this.index] != null) ? Reference2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectSortedMap.FastSortedEntrySet<K, V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == null) {
                return Reference2ObjectLinkedOpenHashMap.this.containsNullKey && ((Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n] != null) ? Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n].equals(v) : (v == null));
            }
            final K[] key = Reference2ObjectLinkedOpenHashMap.this.key;
            int pos;
            K curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                if (Reference2ObjectLinkedOpenHashMap.this.containsNullKey) {
                    if (Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Reference2ObjectLinkedOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Reference2ObjectLinkedOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
