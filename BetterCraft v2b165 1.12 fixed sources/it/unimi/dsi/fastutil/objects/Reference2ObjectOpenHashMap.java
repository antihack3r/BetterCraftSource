...
public class Reference2ObjectOpenHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2ObjectOpenHashMap.this.key[this.index] == e.getKey() && ((Reference2ObjectOpenHashMap.this.value[this.index] != null) ? Reference2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()) : (e.getValue() == null));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V>
    {
        ...
        public boolean contains(final Object o) {
            ...
            if (k == null) {
                return Reference2ObjectOpenHashMap.this.containsNullKey && ((Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n] != null) ? Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n].equals(v) : (v == null));
            }
            final K[] key = Reference2ObjectOpenHashMap.this.key;
            int pos;
            K curr;
        ...
        public boolean rem(final Object o) {
            ...
            if (k == null) {
                if (Reference2ObjectOpenHashMap.this.containsNullKey) {
                    if (Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n] == null) {
                        if (v != null) {
                            return false;
                        }
                    }
                    else if (!Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n].equals(v)) {
                        return false;
                    }
            ...
            if (curr == k) {
                if (Reference2ObjectOpenHashMap.this.value[pos] == null) {
                    if (v != null) {
                        return false;
                    }
                }
                else if (!Reference2ObjectOpenHashMap.this.value[pos].equals(v)) {
                    return false;
                }
