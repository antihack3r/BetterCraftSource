...
public class Object2ByteRBTreeMap<K> extends AbstractObject2ByteSortedMap<K> implements Serializable, Cloneable
{
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2ByteRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2ByteSortedMap<K> implements Serializable
    {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient ByteCollection values;
        final /* synthetic */ Object2ByteRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2ByteRBTreeMap.Entry<K> f = (Object2ByteRBTreeMap.Entry<K>)Object2ByteRBTreeMap.this.findKey(e.getKey());
        ...
        @Override
        public K firstKey() {
            final Object2ByteRBTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public K lastKey() {
            final Object2ByteRBTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2ByteRBTreeMap this$0 = submap.this$0;
                            final Object2ByteRBTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
