...
public class Reference2ByteOpenHashMap<K> extends AbstractReference2ByteMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2ByteMap.Entry<K>, Map.Entry<K, Byte>
    {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Reference2ByteOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Reference2ByteOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ByteOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ByteOpenHashMap.this.mask;
                    Label_0103: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0103;
        ...
        public void remove() {
            ...
            if (this.last == Reference2ByteOpenHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Reference2ByteOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
                this.shiftKeys(this.last);
            }
            final Reference2ByteOpenHashMap this$0 = Reference2ByteOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Reference2ByteOpenHashMap.this.size;
