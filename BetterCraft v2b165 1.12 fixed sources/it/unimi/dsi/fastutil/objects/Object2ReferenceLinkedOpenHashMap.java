...
public class Object2ReferenceLinkedOpenHashMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
    {
        ...
        public V setValue(final V v) {
            final V oldValue = Object2ReferenceLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            if (Object2ReferenceLinkedOpenHashMap.this.key[this.index] == null) {
                if (e.getKey() != null) {
                    return false;
                }
            }
            else if (!Object2ReferenceLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) {
                return false;
            }
            if (Object2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue()) {
                return true;
            }
            return false;
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from != null) {
                Label_0147: {
                    if (Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.last] == null) {
                        if (from != null) {
                            break Label_0147;
                        }
                    }
                    else if (!Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.last].equals(from)) {
                        break Label_0147;
                    }
                ...
                for (int pos = HashCommon.mix(from.hashCode()) & Object2ReferenceLinkedOpenHashMap.this.mask; Object2ReferenceLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Object2ReferenceLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2ReferenceLinkedOpenHashMap this$0 = Object2ReferenceLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2ReferenceLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2ReferenceLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2ReferenceLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2ReferenceLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0296:
            while (true) {
                pos = ((last = pos) + 1 & Object2ReferenceLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2ReferenceLinkedOpenHashMap.this.mask;
                    Label_0399: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0399;
    ...
    private final class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2ReferenceLinkedOpenHashMap.this.size;
