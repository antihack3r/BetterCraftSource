...
public class Object2BooleanOpenCustomHashMap<K> extends AbstractObject2BooleanMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
    {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Object2BooleanOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2BooleanOpenCustomHashMap.this.strategy.equals(Object2BooleanOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Object2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Object2BooleanOpenCustomHashMap.this.mask); !Object2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Object2BooleanOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Object2BooleanOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2BooleanOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2BooleanOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            if (this.last == Object2BooleanOpenCustomHashMap.this.n) {
                ...
                if (this.pos < 0) {
                    Object2BooleanOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
                    this.last = -1;
                    return;
                }
                this.shiftKeys(this.last);
            }
            final Object2BooleanOpenCustomHashMap this$0 = Object2BooleanOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractObjectSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2BooleanOpenCustomHashMap.this.size;
