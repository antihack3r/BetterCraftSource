...
public class Object2BooleanLinkedOpenCustomHashMap<K> extends AbstractObject2BooleanSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Object2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
    {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Object2BooleanLinkedOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(Object2BooleanLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2BooleanLinkedOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
                ...
                for (int pos = HashCommon.mix(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2BooleanLinkedOpenCustomHashMap.this.mask; Object2BooleanLinkedOpenCustomHashMap.this.key[pos] != null; pos = (pos + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2BooleanLinkedOpenCustomHashMap this$0 = Object2BooleanLinkedOpenCustomHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2BooleanLinkedOpenCustomHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2BooleanLinkedOpenCustomHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2BooleanLinkedOpenCustomHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2BooleanLinkedOpenCustomHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2BooleanLinkedOpenCustomHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2BooleanLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2BooleanLinkedOpenCustomHashMap.this.mask;
                    Label_0382: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0382;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2BooleanMap.Entry<K>> implements Object2BooleanSortedMap.FastSortedEntrySet<K>
    {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2BooleanLinkedOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Object2BooleanLinkedOpenCustomHashMap.this.size;
