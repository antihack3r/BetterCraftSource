...
public class Reference2IntLinkedOpenHashMap<K> extends AbstractReference2IntSortedMap<K> implements Serializable, Cloneable, Hash
{
    ...
    final class MapEntry implements Reference2IntMap.Entry<K>, Map.Entry<K, Integer>
    {
        ...
        public int setValue(final int v) {
            final int oldValue = Reference2IntLinkedOpenHashMap.this.value[this.index];
    ...
    private class MapIterator
    {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2IntLinkedOpenHashMap.this.mask; Reference2IntLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Reference2IntLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Reference2IntLinkedOpenHashMap this$0 = Reference2IntLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Reference2IntLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Reference2IntLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Reference2IntLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Reference2IntLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Reference2IntLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Reference2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Reference2IntLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2IntLinkedOpenHashMap.this.mask;
                    Label_0374: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0374;
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Reference2IntMap.Entry<K>>
    {
        ...
        @Override
        public void set(final Reference2IntMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Reference2IntMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2IntMap.Entry<K>> implements Reference2IntSortedMap.FastSortedEntrySet<K>
    {
        ...
        @Override
        public ObjectSortedSet<Reference2IntMap.Entry<K>> subSet(final Reference2IntMap.Entry<K> fromElement, final Reference2IntMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2IntMap.Entry<K>> headSet(final Reference2IntMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2IntMap.Entry<K>> tailSet(final Reference2IntMap.Entry<K> fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K>
    {
        ...
        public boolean rem(final Object k) {
            final int oldSize = Reference2IntLinkedOpenHashMap.this.size;
