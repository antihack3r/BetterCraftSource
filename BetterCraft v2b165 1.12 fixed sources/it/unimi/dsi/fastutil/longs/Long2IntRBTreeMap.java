...
public class Long2IntRBTreeMap extends AbstractLong2IntSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof LongComparator) {
            ...
            this.actualComparator = new LongComparator() {
                ...
                public int compare(final long k1, final long k2) {
                    return Long2IntRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Integer put(final Long ok, final Integer ov) {
        final int oldValue = this.put((long)ok, (int)ov);
    ...
    public Integer remove(final Object ok) {
        final int oldValue = this.remove((long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2IntRBTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2IntSortedMap implements Serializable
    {
        ...
        protected transient LongSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Long2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey((long)e.getKey());
        ...
        @Override
        public long firstLongKey() {
            final Long2IntRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public long lastLongKey() {
            final Long2IntRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2IntRBTreeMap this$0 = submap.this$0;
                            final Long2IntRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
