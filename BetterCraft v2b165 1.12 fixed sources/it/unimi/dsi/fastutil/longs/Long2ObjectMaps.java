    ...
    public static class Singleton<V> extends Long2ObjectFunctions.Singleton<V> implements Long2ObjectMap<V>, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Long2ObjectMap.Entry<V>, Map.Entry<Long, V>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Long && Singleton.this.key == (long)e.getKey() && ((Singleton.this.value != null) ? Singleton.this.value.equals(e.getValue()) : (e.getValue() == null));
            }
