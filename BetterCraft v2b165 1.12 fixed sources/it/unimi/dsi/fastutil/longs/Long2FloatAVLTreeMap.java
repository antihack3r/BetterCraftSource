...
public class Long2FloatAVLTreeMap extends AbstractLong2FloatSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof LongComparator) {
            ...
            this.actualComparator = new LongComparator() {
                ...
                public int compare(final long k1, final long k2) {
                    return Long2FloatAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Float put(final Long ok, final Float ov) {
        final float oldValue = this.put((long)ok, (float)ov);
    ...
    public Float remove(final Object ok) {
        final float oldValue = this.remove((long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2FloatAVLTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2FloatAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2FloatSortedMap implements Serializable
    {
        ...
        protected transient LongSortedSet keys;
        protected transient FloatCollection values;
        final /* synthetic */ Long2FloatAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey((long)e.getKey());
        ...
        @Override
        public long firstLongKey() {
            final Long2FloatAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public long lastLongKey() {
            final Long2FloatAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2FloatAVLTreeMap this$0 = submap.this$0;
                            final Long2FloatAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
