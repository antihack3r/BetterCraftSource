...
public abstract class AbstractLong2LongSortedMap extends AbstractLong2LongMap implements Long2LongSortedMap
{
    ...
    protected class KeySet extends AbstractLongSortedSet
    {
        ...
        public LongBidirectionalIterator iterator(final long from) {
            return new KeySetIterator((ObjectBidirectionalIterator<Map.Entry<Long, Long>>)AbstractLong2LongSortedMap.this.entrySet().iterator(new BasicEntry(from, 0L)));
        }
    ...
    protected static class KeySetIterator extends AbstractLongBidirectionalIterator
    {
        ...
        public KeySetIterator(final ObjectBidirectionalIterator<Map.Entry<Long, Long>> i) {
            this.i = i;
        }
    ...
    protected static class ValuesIterator extends AbstractLongIterator
    {
        ...
        public ValuesIterator(final ObjectBidirectionalIterator<Map.Entry<Long, Long>> i) {
            this.i = i;
        }
