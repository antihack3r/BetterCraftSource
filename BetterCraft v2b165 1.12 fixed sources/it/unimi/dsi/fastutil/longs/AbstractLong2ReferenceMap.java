...
public abstract class AbstractLong2ReferenceMap<V> extends AbstractLong2ReferenceFunction<V> implements Long2ReferenceMap<V>, Serializable
{
    ...
    public void putAll(final Map<? extends Long, ? extends V> m) {
        ...
        if (m instanceof Long2ReferenceMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Long, ? extends V> e2 = (Map.Entry<? extends Long, ? extends V>)i.next();
        ...
        return new AbstractLongSet() {
            ...
            public LongIterator iterator() {
                return new AbstractLongIterator() {
                    final ObjectIterator<Map.Entry<Long, V>> i = AbstractLong2ReferenceMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Long, V>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry<V> implements Entry<V>
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Long && this.key == (long)e.getKey() && this.value == e.getValue();
        }
