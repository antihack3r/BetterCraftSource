...
public class Long2ObjectRBTreeMap<V> extends AbstractLong2ObjectSortedMap<V> implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof LongComparator) {
            ...
            this.actualComparator = new LongComparator() {
                ...
                public int compare(final long k1, final long k2) {
                    return Long2ObjectRBTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public V put(final Long ok, final V ov) {
        final V oldValue = this.put((long)ok, ov);
    ...
    public V remove(final Object ok) {
        final V oldValue = this.remove((long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Long2ObjectRBTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry<V> locateKey = Long2ObjectRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2ObjectSortedMap<V> implements Serializable
    {
        ...
        protected transient LongSortedSet keys;
        protected transient ObjectCollection<V> values;
        final /* synthetic */ Long2ObjectRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey((long)e.getKey());
        ...
        @Override
        public long firstLongKey() {
            final Long2ObjectRBTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public long lastLongKey() {
            final Long2ObjectRBTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2ObjectRBTreeMap this$0 = submap.this$0;
                            final Long2ObjectRBTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
