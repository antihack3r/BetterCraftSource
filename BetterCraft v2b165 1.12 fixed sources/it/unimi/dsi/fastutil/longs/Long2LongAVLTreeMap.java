...
public class Long2LongAVLTreeMap extends AbstractLong2LongSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof LongComparator) {
            ...
            this.actualComparator = new LongComparator() {
                ...
                public int compare(final long k1, final long k2) {
                    return Long2LongAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Long put(final Long ok, final Long ov) {
        final long oldValue = this.put((long)ok, (long)ov);
    ...
    public Long remove(final Object ok) {
        final long oldValue = this.remove((long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2LongAVLTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator
    {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2LongSortedMap implements Serializable
    {
        ...
        protected transient LongSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Long2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey((long)e.getKey());
        ...
        @Override
        public long firstLongKey() {
            final Long2LongAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        @Override
        public long lastLongKey() {
            final Long2LongAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2LongAVLTreeMap this$0 = submap.this$0;
                            final Long2LongAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
