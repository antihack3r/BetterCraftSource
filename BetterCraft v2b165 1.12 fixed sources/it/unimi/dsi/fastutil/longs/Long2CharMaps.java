...
public class Long2CharMaps
{
    ...
    public static Long2CharMap singleton(final long key, final char value) {
    ...
    public static class Singleton extends Long2CharFunctions.Singleton implements Long2CharMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Long2CharMap.Entry, Map.Entry<Long, Character>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Long && e.getValue() != null && e.getValue() instanceof Character && Singleton.this.key == (long)e.getKey() && Singleton.this.value == (char)e.getValue();
            }
