    ...
    public static class Singleton extends Long2ShortFunctions.Singleton implements Long2ShortMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Long2ShortMap.Entry, Map.Entry<Long, Short>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Long && e.getValue() != null && e.getValue() instanceof Short && Singleton.this.key == (long)e.getKey() && Singleton.this.value == (short)e.getValue();
            }
