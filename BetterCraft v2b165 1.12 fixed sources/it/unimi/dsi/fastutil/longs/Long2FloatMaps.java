    ...
    public static class Singleton extends Long2FloatFunctions.Singleton implements Long2FloatMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Long2FloatMap.Entry, Map.Entry<Long, Float>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Long && e.getValue() != null && e.getValue() instanceof Float && Singleton.this.key == (long)e.getKey() && Singleton.this.value == (float)e.getValue();
            }
