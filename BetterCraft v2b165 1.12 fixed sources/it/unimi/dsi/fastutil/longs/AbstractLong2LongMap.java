...
public abstract class AbstractLong2LongMap extends AbstractLong2LongFunction implements Long2LongMap, Serializable
{
    ...
    public void putAll(final Map<? extends Long, ? extends Long> m) {
        ...
        if (m instanceof Long2LongMap) {
            ...
            while (n-- != 0) {
                final Map.Entry<? extends Long, ? extends Long> e2 = (Map.Entry<? extends Long, ? extends Long>)i.next();
        ...
        return new AbstractLongSet() {
            ...
            public LongIterator iterator() {
                return new AbstractLongIterator() {
                    final ObjectIterator<Map.Entry<Long, Long>> i = AbstractLong2LongMap.this.entrySet().iterator();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<? extends Map.Entry<Long, Long>> i = this.entrySet().iterator();
        while (n-- != 0) {
            h += i.next().hashCode();
        }
        return h;
    ...
    public static class BasicEntry implements Entry
    {
        ...
        public boolean equals(final Object o) {
            ...
            return e.getKey() != null && e.getKey() instanceof Long && e.getValue() != null && e.getValue() instanceof Long && this.key == (long)e.getKey() && this.value == (long)e.getValue();
        }
