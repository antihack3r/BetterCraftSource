...
public class Long2DoubleAVLTreeMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable
{
        ...
        if (this.storedComparator == null || this.storedComparator instanceof LongComparator) {
            ...
            this.actualComparator = new LongComparator() {
                ...
                public int compare(final long k1, final long k2) {
                    return Long2DoubleAVLTreeMap.this.storedComparator.compare(k1, k2);
                }
    ...
    public Double put(final Long ok, final Double ov) {
        final double oldValue = this.put((long)ok, (double)ov);
    ...
    public Double remove(final Object ok) {
        final double oldValue = this.remove((long)ok);
