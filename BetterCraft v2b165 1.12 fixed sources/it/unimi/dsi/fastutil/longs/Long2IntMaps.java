    ...
    public static class Singleton extends Long2IntFunctions.Singleton implements Long2IntMap, Serializable, Cloneable
    {
        ...
        protected class SingletonEntry implements Long2IntMap.Entry, Map.Entry<Long, Integer>
        {
            ...
            public boolean equals(final Object o) {
                ...
                return e.getKey() != null && e.getKey() instanceof Long && e.getValue() != null && e.getValue() instanceof Integer && Singleton.this.key == (long)e.getKey() && Singleton.this.value == (int)e.getValue();
            }
