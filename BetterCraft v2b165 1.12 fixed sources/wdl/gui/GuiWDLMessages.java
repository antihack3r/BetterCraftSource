    ...
    private class GuiMessageTypeList extends GuiListExtended
    {
        ...
        private class CategoryEntry implements IGuiListEntry
        {
            ...
            public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
                Gui.drawCenteredString(GuiWDLMessages.this.fontRendererObj, this.category.getDisplayName(), GuiWDLMessages.width / 2 - 40, p_192634_3_ + GuiMessageTypeList.this.slotHeight - GuiMessageTypeList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
                ...
                this.button.drawButton(GuiMessageTypeList.this.mc, GuiMessageTypeList.this.mouseX, GuiMessageTypeList.this.mouseY, p_192634_9_);
            }
        }
