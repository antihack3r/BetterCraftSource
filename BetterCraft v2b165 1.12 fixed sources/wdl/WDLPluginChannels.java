...
public class WDLPluginChannels
{
    ...
    public static void sendRequests() {
        ...
        final CPacketCustomPayload requestPacket = new CPacketCustomPayload("WDL|REQUEST", requestBuffer);
    }
    ...
    static void onWorldLoad() {
        ...
        final CPacketCustomPayload registerPacket = new CPacketCustomPayload("REGISTER", registerPacketBuffer);
        try {
            final CPacketCustomPayload initPacket = new CPacketCustomPayload("WDL|INIT", new PacketBuffer(Unpooled.copiedBuffer("1.11a-beta1".getBytes("UTF-8"))));
        }
        catch (final UnsupportedEncodingException e) {
            WDLMessages.chatMessageTranslated(WDLMessageTypes.ERROR, "wdl.messages.generalError.noUTF8", e);
            final CPacketCustomPayload initPacket = new CPacketCustomPayload("WDL|INIT", new PacketBuffer(Unpooled.buffer()));
        }
    }
