...
public class WDLHooks
{
    ...
    public static void onNHPCHandleChat(final NetHandlerPlayClient sender, final SPacketChat packet) {
        try {
    ...
    public static void onNHPCHandleMaps(final NetHandlerPlayClient sender, final SPacketMaps packet) {
        try {
            if (!Minecraft.getMinecraft().isCallingFromMinecraftThread()) {
                return;
            }
    ...
    public static void onNHPCHandleCustomPayload(final NetHandlerPlayClient sender, final SPacketCustomPayload packet) {
    }
    
    public static void onNHPCHandleBlockAction(final NetHandlerPlayClient sender, final SPacketBlockAction packet) {
        try {
            if (!Minecraft.getMinecraft().isCallingFromMinecraftThread()) {
                return;
            }
    ...
    public static void onCrashReportPopulateEnvironment(final CrashReport report) {
        report.makeCategory("World Downloader Mod").setDetail("Info", new ICrashReportDetail<String>() {
            @Override
            public String call() {
    ...
    public static void injectWDLButtons(final GuiIngameMenu gui, final List buttonList) {
        ...
        final GuiButton wdlDownload = new GuiButton(1464093811, GuiIngameMenu.width / 2 - 100, insertAtYPos, 168, 20, null);
