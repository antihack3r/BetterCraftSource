...
class GuiSlotShaders extends GuiSlot
{
    ...
    @Override
    protected void func_192637_a(final int index, final int posX, final int posY, final int contentY, final int mouseX, final int mouseY, final float partialTicks) {
