...
public class FBPRenderUtil
{
    ...
    public static Vector3f rotatef_f(final Vector3f pos, final float AngleX, final float AngleY, final float AngleZ, final EnumFacing facing) {
        ...
        if (facing == EnumFacing.EAST) {
            final FBPVector3d fbpVector3d9;
            final FBPVector3d fbpVector3d = fbpVector3d9 = pos2;
            --fbpVector3d9.x;
        }
        else if (facing == EnumFacing.WEST) {
            final FBPVector3d fbpVector3d10;
            final FBPVector3d fbpVector3d2 = fbpVector3d10 = pos2;
            ++fbpVector3d10.x;
        }
        else if (facing == EnumFacing.SOUTH) {
            final FBPVector3d fbpVector3d11;
            final FBPVector3d fbpVector3d3 = fbpVector3d11 = pos2;
            --fbpVector3d11.z;
            final FBPVector3d fbpVector3d12;
            final FBPVector3d fbpVector3d4 = fbpVector3d12 = pos2;
            --fbpVector3d12.x;
        }
        ...
        if (facing == EnumFacing.EAST) {
            final FBPVector3d fbpVector3d13;
            final FBPVector3d fbpVector3d5 = fbpVector3d13 = pos3;
            ++fbpVector3d13.x;
        }
        else if (facing == EnumFacing.WEST) {
            final FBPVector3d fbpVector3d14;
            final FBPVector3d fbpVector3d6 = fbpVector3d14 = pos3;
            --fbpVector3d14.x;
        }
        else if (facing == EnumFacing.SOUTH) {
            final FBPVector3d fbpVector3d15;
            final FBPVector3d fbpVector3d7 = fbpVector3d15 = pos3;
            ++fbpVector3d15.z;
            final FBPVector3d fbpVector3d16;
            final FBPVector3d fbpVector3d8 = fbpVector3d16 = pos3;
            ++fbpVector3d16.x;
        }
