            ...
            if (!this.killToggle) {
                if (!FBP.randomRotation) {
                    ...
                    if (allowedToMove) {
                        ...
                        if (this.motionX > 0.0) {
                            if (this.motionZ > 0.0) {
                                final FBPVector3d rot5;
                                final FBPVector3d rot = rot5 = this.rot;
                                rot5.x -= x;
                            }
                            else if (this.motionZ < 0.0) {
                                final FBPVector3d rot6;
                                final FBPVector3d rot2 = rot6 = this.rot;
                                rot6.x += x;
                            }
                        }
                        else if (this.motionX < 0.0) {
                            if (this.motionZ < 0.0) {
                                final FBPVector3d rot7;
                                final FBPVector3d rot3 = rot7 = this.rot;
                                rot7.x += x;
                            }
                            else if (this.motionZ > 0.0) {
                                final FBPVector3d rot8;
                                final FBPVector3d rot4 = rot8 = this.rot;
                                rot8.x -= x;
                            }
                        }
                    }
    ...
    public void renderParticle(final WorldRenderer buf, final Entity entityIn, final float partialTicks, final float rotationX, final float rotationZ, final float rotationYZ, final float rotationXY, final float rotationXZ) {
        ...
        if (this.particleIcon != null) {
            if (this.uvMin == null && this.uvMax == null) {
                ...
                final float startX = (this.particleTextureJitterX + 1.0f) * 4.0f - 4.0f;
                final float startY = (this.particleTextureJitterY + 1.0f) * 4.0f - 4.0f;
