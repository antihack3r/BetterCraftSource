...
public class GuiNBTTree extends Gui
{
    ...
    protected void overlayBackground(final int startY, final int endY, final int startAlpha, final int endAlpha) {
        ...
        worldrenderer.pos(0 + this.width, endY, 0.0).tex(this.width / 32.0f, endY / 32.0f).color(64, 64, 64, endAlpha).endVertex();
        worldrenderer.pos(0 + this.width, startY, 0.0).tex(this.width / 32.0f, startY / 32.0f).color(64, 64, 64, startAlpha).endVertex();
