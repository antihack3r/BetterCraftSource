        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    RealmsUploadScreen.this.errorMessage = RealmsScreen.getLocalizedString("mco.upload.failed", e3.getMessage());
                }
                catch (final RealmsServiceException e4) {
                    RealmsUploadScreen.this.errorMessage = RealmsScreen.getLocalizedString("mco.upload.failed", e4.toString());
                }
                    ...
                    catch (final RealmsServiceException e6) {
                        RealmsUploadScreen.LOGGER.error("Failed to request upload-finished to Realms", e6.toString());
                    }
                }
            }
        }.start();
