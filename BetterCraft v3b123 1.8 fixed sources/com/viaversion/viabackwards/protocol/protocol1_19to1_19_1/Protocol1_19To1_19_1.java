...
public final class Protocol1_19To1_19_1 extends BackwardsProtocol<ClientboundPackets1_19_1, ClientboundPackets1_19, ServerboundPackets1_19_1, ServerboundPackets1_19>
{
    ...
    public Protocol1_19To1_19_1() {
        ...
        this.translatableRewriter = new TranslatableRewriter<ClientboundPackets1_19_1>(this);
    }
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_19_1, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_19_1.JOIN_GAME, new PacketHandlers() {
        ...
        ((Protocol<ClientboundPackets1_19_1, ClientboundPackets1_19, SM, SU>)this).registerClientbound(ClientboundPackets1_19_1.PLAYER_CHAT, ClientboundPackets1_19.SYSTEM_CHAT, wrapper -> {
            ...
            final JsonElement decoratedMessage2 = decorateChatMessage(wrapper.user().get(ChatRegistryStorage1_19_1.class), chatTypeId, senderName, targetName, message);
            if (decoratedMessage2 == null) {
                wrapper.cancel();
                return;
            }
            else {
                this.translatableRewriter.processText(decoratedMessage2);
                wrapper.write(Type.COMPONENT, decoratedMessage2);
                wrapper.write(Type.VAR_INT, 1);
                return;
            }
        });
        ((AbstractProtocol<ClientboundPackets1_19_1, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_19_1.SYSTEM_CHAT, wrapper -> {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_19>)this).registerServerbound(ServerboundPackets1_19.CHAT_COMMAND, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
                this.map((Type<Object>)Type.LONG);
                this.map((Type<Object>)Type.LONG);
        ...
        ((AbstractProtocol<ClientboundPackets1_19_1, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_19_1.CUSTOM_CHAT_COMPLETIONS);
    ...
    public static JsonElement decorateChatMessage(final ChatRegistryStorage chatRegistryStorage, final int chatTypeId, final JsonElement senderName, final JsonElement targetName, final JsonElement message) {
        ...
        if (style != null) {
            ...
            for (final String key : TextDecoration.NAMES.keys()) {
                if (style.contains(key)) {
                    styleBuilder.decoration((TextDecoration)TextDecoration.NAMES.value(key), style.get(key).asByte() == 1);
                }
            }
