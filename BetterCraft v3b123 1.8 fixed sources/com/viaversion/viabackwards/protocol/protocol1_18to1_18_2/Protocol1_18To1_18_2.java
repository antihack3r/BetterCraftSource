...
public final class Protocol1_18To1_18_2 extends BackwardsProtocol<ClientboundPackets1_18, ClientboundPackets1_18, ServerboundPackets1_17, ServerboundPackets1_17>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.ENTITY_EFFECT, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(entityEffectIdHandler);
            }
        });
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.REMOVE_ENTITY_EFFECT, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(entityEffectIdHandler);
            }
        });
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.JOIN_GAME, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.RESPAWN, wrapper -> this.removeTagPrefix(wrapper.passthrough(Type.NBT)));
    }
