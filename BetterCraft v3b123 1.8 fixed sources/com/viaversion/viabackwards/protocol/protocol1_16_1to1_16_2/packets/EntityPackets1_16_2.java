...
public class EntityPackets1_16_2 extends EntityRewriter<ClientboundPackets1_16_2, Protocol1_16_1To1_16_2>
{
    ...
    protected void registerPackets() {
        ((EntityRewriter<ClientboundPackets1_16_2, T>)this).registerTrackerWithData(ClientboundPackets1_16_2.SPAWN_ENTITY, Entity1_16_2Types.FALLING_BLOCK);
        ((EntityRewriter<ClientboundPackets1_16_2, T>)this).registerSpawnTracker(ClientboundPackets1_16_2.SPAWN_MOB);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16_2, T>)this).registerTracker(ClientboundPackets1_16_2.SPAWN_EXPERIENCE_ORB, Entity1_16_2Types.EXPERIENCE_ORB);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16_2, T>)this).registerTracker(ClientboundPackets1_16_2.SPAWN_PAINTING, Entity1_16_2Types.PAINTING);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16_2, T>)this).registerTracker(ClientboundPackets1_16_2.SPAWN_PLAYER, Entity1_16_2Types.PLAYER);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16_2, T>)this).registerRemoveEntities(ClientboundPackets1_16_2.DESTROY_ENTITIES);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16_2, T>)this).registerMetadataRewriter(ClientboundPackets1_16_2.ENTITY_METADATA, Types1_16.METADATA_LIST);
