...
public final class BlockItemPackets1_17 extends ItemRewriter<ClientboundPackets1_17, ServerboundPackets1_16_2, Protocol1_16_4To1_17>
{
    ...
    protected void registerPackets() {
        final BlockRewriter<ClientboundPackets1_17> blockRewriter = new BlockRewriter<ClientboundPackets1_17>(this.protocol, Type.POSITION1_14);
        new RecipeRewriter<ClientboundPackets1_17>(this.protocol).register(ClientboundPackets1_17.DECLARE_RECIPES);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_17, S, T>)this).registerSetCooldown(ClientboundPackets1_17.COOLDOWN);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_17, S, T>)this).registerWindowItems(ClientboundPackets1_17.WINDOW_ITEMS, Type.FLAT_VAR_INT_ITEM_ARRAY);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_17, S, T>)this).registerEntityEquipmentArray(ClientboundPackets1_17.ENTITY_EQUIPMENT);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_17, S, T>)this).registerTradeList(ClientboundPackets1_17.TRADE_LIST);
        ((ItemRewriter<ClientboundPackets1_17, S, T>)this).registerAdvancements(ClientboundPackets1_17.ADVANCEMENTS, Type.FLAT_VAR_INT_ITEM);
        ...
        ((com.viaversion.viaversion.rewriter.ItemRewriter<C, ServerboundPackets1_16_2, T>)this).registerCreativeInvAction(ServerboundPackets1_16_2.CREATIVE_INVENTORY_ACTION, Type.FLAT_VAR_INT_ITEM);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_16_2>)this.protocol).registerServerbound(ServerboundPackets1_16_2.CLICK_WINDOW, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.SET_SLOT, wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.SPAWN_PARTICLE, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.UPDATE_LIGHT, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.MULTI_BLOCK_CHANGE, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.BLOCK_CHANGE, new PacketHandlers() {
            public void register() {
                this.map(Type.POSITION1_14);
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(wrapper -> {
                    final int y = wrapper.get(Type.POSITION1_14, 0).y();
                    if (y < 0 || y > 255) {
                        wrapper.cancel();
                    }
                    else {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.CHUNK_DATA, wrapper -> {
            final EntityTracker tracker = wrapper.user().getEntityTracker(Protocol1_16_4To1_17.class);
            ...
            for (int i = 0; i < 16; ++i) {
                ...
                if (section != null) {
                    ...
                    for (int j = 0; j < palette.size(); ++j) {
                        final int mappedBlockStateId = ((Protocol1_16_4To1_17)this.protocol).getMappingData().getNewBlockStateId(palette.idByIndex(j));
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.BLOCK_ENTITY_DATA, wrapper -> {
            final int y = wrapper.passthrough(Type.POSITION1_14).y();
            if (y < 0 || y > 255) {
                wrapper.cancel();
            }
            return;
        });
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.BLOCK_BREAK_ANIMATION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(wrapper -> {
                    final int y = wrapper.passthrough(Type.POSITION1_14).y();
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.MAP_DATA, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
