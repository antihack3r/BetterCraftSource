...
public final class EntityPackets1_17 extends EntityRewriter<ClientboundPackets1_17, Protocol1_16_4To1_17>
{
    ...
    protected void registerPackets() {
        ((EntityRewriter<ClientboundPackets1_17, T>)this).registerTrackerWithData(ClientboundPackets1_17.SPAWN_ENTITY, Entity1_17Types.FALLING_BLOCK);
        ((EntityRewriter<ClientboundPackets1_17, T>)this).registerSpawnTracker(ClientboundPackets1_17.SPAWN_MOB);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_17, T>)this).registerTracker(ClientboundPackets1_17.SPAWN_EXPERIENCE_ORB, Entity1_17Types.EXPERIENCE_ORB);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_17, T>)this).registerTracker(ClientboundPackets1_17.SPAWN_PAINTING, Entity1_17Types.PAINTING);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_17, T>)this).registerTracker(ClientboundPackets1_17.SPAWN_PLAYER, Entity1_17Types.PLAYER);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_17, T>)this).registerMetadataRewriter(ClientboundPackets1_17.ENTITY_METADATA, Types1_17.METADATA_LIST, Types1_16.METADATA_LIST);
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.JOIN_GAME, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.RESPAWN, new PacketHandlers() {
            public void register() {
                this.map(Type.NBT);
                this.map(Type.STRING);
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.PLAYER_POSITION, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_17, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_17.ENTITY_PROPERTIES, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
