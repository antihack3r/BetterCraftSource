...
public class Protocol1_11_1To1_12 extends BackwardsProtocol<ClientboundPackets1_12, ClientboundPackets1_9_3, ServerboundPackets1_12, ServerboundPackets1_9_3>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_12, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_12.TITLE, wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_12, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_12.ADVANCEMENTS);
        ((AbstractProtocol<ClientboundPackets1_12, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_12.UNLOCK_RECIPES);
        ((AbstractProtocol<ClientboundPackets1_12, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_12.SELECT_ADVANCEMENTS_TAB);
    }
    ...
    static {
        MAPPINGS = new BackwardsMappings("1.12", "1.11");
    }
}
