...
public class SoundPackets1_12 extends LegacySoundRewriter<Protocol1_11_1To1_12>
{
    ...
    protected void registerPackets() {
        ((AbstractProtocol<ClientboundPackets1_12, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_12.NAMED_SOUND, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_12, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_12.SOUND, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.INT);
