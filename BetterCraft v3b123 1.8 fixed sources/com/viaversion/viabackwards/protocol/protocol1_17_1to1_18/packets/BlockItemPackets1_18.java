...
public final class BlockItemPackets1_18 extends ItemRewriter<ClientboundPackets1_18, ServerboundPackets1_17, Protocol1_17_1To1_18>
{
    ...
    protected void registerPackets() {
        ...
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_18, S, T>)this).registerSetCooldown(ClientboundPackets1_18.COOLDOWN);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_18, S, T>)this).registerWindowItems1_17_1(ClientboundPackets1_18.WINDOW_ITEMS);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_18, S, T>)this).registerSetSlot1_17_1(ClientboundPackets1_18.SET_SLOT);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_18, S, T>)this).registerEntityEquipmentArray(ClientboundPackets1_18.ENTITY_EQUIPMENT);
        ((com.viaversion.viaversion.rewriter.ItemRewriter<ClientboundPackets1_18, S, T>)this).registerTradeList(ClientboundPackets1_18.TRADE_LIST);
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.EFFECT, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.BLOCK_ENTITY_DATA, new PacketHandlers() {
            public void register() {
                this.map(Type.POSITION1_14);
                this.handler(wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.CHUNK_DATA, wrapper -> {
            final EntityTracker tracker = ((Protocol1_17_1To1_18)this.protocol).getEntityRewriter().tracker(wrapper.user());
            final Chunk1_18Type chunkType = new Chunk1_18Type(tracker.currentWorldSectionHeight(), MathUtil.ceilLog2(((Protocol1_17_1To1_18)this.protocol).getMappingData().getBlockStateMappings().mappedSize()), MathUtil.ceilLog2(tracker.biomesSent()));
            ...
            while (iterator.hasNext()) {
                ...
                final String id = ((Protocol1_17_1To1_18)this.protocol).getMappingData().blockEntities().get(blockEntity.typeId());
                if (id == null) {
                    continue;
                }
                else {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).cancelClientbound(ClientboundPackets1_18.SET_SIMULATION_DISTANCE);
    }
