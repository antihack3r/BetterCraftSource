...
public class BlockItemPackets1_11 extends LegacyBlockItemRewriter<ClientboundPackets1_9_3, ServerboundPackets1_9_3, Protocol1_10To1_11>
{
    ...
    protected void registerPackets() {
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_9_3.SET_SLOT, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_9_3.WINDOW_ITEMS, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                ...
                this.handler(wrapper -> {
                    ...
                    if (BlockItemPackets1_11.this.isLlama(wrapper.user())) {
                        final Optional horse = BlockItemPackets1_11.this.getChestedHorse(wrapper.user());
                        if (!(!horse.isPresent())) {
                            final ChestedHorseStorage storage = (ChestedHorseStorage)horse.get();
                            final Item[] stacks2 = Arrays.copyOf(stacks, storage.isChested() ? 53 : 38);
                            for (int j = stacks2.length - 1; j >= 0; --j) {
                                stacks2[BlockItemPackets1_11.this.getNewSlotId(storage, j)] = stacks2[j];
                                stacks2[j] = BlockItemPackets1_11.this.getNewItem(storage, j, stacks2[j]);
                            }
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_9_3.BLOCK_ENTITY_DATA, new PacketHandlers() {
            public void register() {
                this.map(Type.POSITION);
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                this.map(Type.NBT);
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_9_3.OPEN_WINDOW, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                this.map(Type.STRING);
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_9_3.CLOSE_WINDOW, new PacketHandlers() {
            public void register() {
                this.handler(wrapper -> {
                    final WindowTracker windowTracker = wrapper.user().get(WindowTracker.class);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_9_3>)this.protocol).registerServerbound(ServerboundPackets1_9_3.CLOSE_WINDOW, new PacketHandlers() {
            public void register() {
                this.handler(wrapper -> {
                    final WindowTracker windowTracker = wrapper.user().get(WindowTracker.class);
                    windowTracker.setInventory(null);
