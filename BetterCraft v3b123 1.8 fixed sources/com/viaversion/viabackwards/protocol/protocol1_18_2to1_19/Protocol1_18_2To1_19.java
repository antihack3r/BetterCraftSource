...
public final class Protocol1_18_2To1_19 extends BackwardsProtocol<ClientboundPackets1_19, ClientboundPackets1_18, ServerboundPackets1_19, ServerboundPackets1_17>
{
    ...
    public Protocol1_18_2To1_19() {
        ...
        this.translatableRewriter = new TranslatableRewriter<ClientboundPackets1_19>(this);
    }
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_19.SOUND, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_19.ENTITY_SOUND, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_19.NAMED_SOUND, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_19.DECLARE_COMMANDS, wrapper -> {
            for (int size = wrapper.passthrough((Type<Integer>)Type.VAR_INT), i = 0; i < size; ++i) {
                ...
                if (nodeType == 2) {
                    ...
                    String argumentType = Protocol1_18_2To1_19.MAPPINGS.getArgumentTypeMappings().identifier(argumentTypeId);
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_19.SERVER_DATA);
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_19.CHAT_PREVIEW);
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_19.SET_DISPLAY_CHAT_PREVIEW);
        ((Protocol<ClientboundPackets1_19, ClientboundPackets1_18, SM, SU>)this).registerClientbound(ClientboundPackets1_19.PLAYER_CHAT, ClientboundPackets1_18.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
        ...
        ((Protocol<ClientboundPackets1_19, ClientboundPackets1_18, SM, SU>)this).registerClientbound(ClientboundPackets1_19.SYSTEM_CHAT, ClientboundPackets1_18.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
                this.handler(wrapper -> {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_17>)this).registerServerbound(ServerboundPackets1_17.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
