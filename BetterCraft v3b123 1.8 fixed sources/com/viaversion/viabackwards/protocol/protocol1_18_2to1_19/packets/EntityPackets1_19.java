...
public final class EntityPackets1_19 extends EntityRewriter<ClientboundPackets1_19, Protocol1_18_2To1_19>
{
    ...
    protected void registerPackets() {
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_19, T>)this).registerTracker(ClientboundPackets1_19.SPAWN_EXPERIENCE_ORB, Entity1_19Types.EXPERIENCE_ORB);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_19, T>)this).registerTracker(ClientboundPackets1_19.SPAWN_PLAYER, Entity1_19Types.PLAYER);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_19, T>)this).registerMetadataRewriter(ClientboundPackets1_19.ENTITY_METADATA, Types1_19.METADATA_LIST, Types1_18.METADATA_LIST);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_19, T>)this).registerRemoveEntities(ClientboundPackets1_19.REMOVE_ENTITIES);
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_19.SPAWN_ENTITY, new PacketHandlers() {
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    final EntityType entityType = EntityRewriter.this.trackAndMapEntity(wrapper);
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_19.ENTITY_EFFECT, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.BYTE);
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_19.JOIN_GAME, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_19.RESPAWN, new PacketHandlers() {
            public void register() {
                this.handler(wrapper -> {
                    final String dimensionKey = wrapper.read(Type.STRING);
        ...
        ((AbstractProtocol<ClientboundPackets1_19, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_19.PLAYER_INFO, wrapper -> {
