...
public class SoundPackets1_14 extends RewriterBase<Protocol1_13_2To1_14>
{
    ...
    protected void registerPackets() {
        final SoundRewriter<ClientboundPackets1_14> soundRewriter = new SoundRewriter<ClientboundPackets1_14>((BackwardsProtocol<ClientboundPackets1_14, ?, ?, ?>)this.protocol);
        ...
        this.protocol.registerClientbound(ClientboundPackets1_14.ENTITY_SOUND, null, wrapper -> {
            wrapper.cancel();
            final int soundId = wrapper.read((Type<Integer>)Type.VAR_INT);
            final int newId = ((Protocol1_13_2To1_14)this.protocol).getMappingData().getSoundMappings().getNewId(soundId);
            if (newId != -1) {
                final int category = wrapper.read((Type<Integer>)Type.VAR_INT);
                final int entityId = wrapper.read((Type<Integer>)Type.VAR_INT);
                final StoredEntityData storedEntity = wrapper.user().getEntityTracker(this.protocol.getClass()).entityData(entityId);
