...
public class EntityPackets1_14 extends LegacyEntityRewriter<ClientboundPackets1_14, Protocol1_13_2To1_14>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.ENTITY_STATUS, wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.ENTITY_TELEPORT, new PacketHandlers() {
        ...
        final PacketHandlers relativeMoveHandler = new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.ENTITY_POSITION, relativeMoveHandler);
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.ENTITY_POSITION_AND_ROTATION, relativeMoveHandler);
                ...
                this.handler(wrapper -> {
                    ...
                    if (objectType != null) {
                        ...
                        if (objectType == Entity1_13Types.ObjectType.FALLING_BLOCK) {
                            ...
                            wrapper.set(Type.INT, 0, data2 + 1);
                        }
                    }
                });
            }
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.SPAWN_EXPERIENCE_ORB, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.DOUBLE);
                this.map((Type<Object>)Type.DOUBLE);
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.SPAWN_GLOBAL_ENTITY, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.BYTE);
                this.map((Type<Object>)Type.DOUBLE);
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.SPAWN_PAINTING, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map(Type.UUID);
                this.map((Type<Object>)Type.VAR_INT);
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.SPAWN_PLAYER, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map(Type.UUID);
                this.map((Type<Object>)Type.DOUBLE);
        ...
        ((LegacyEntityRewriter<ClientboundPackets1_14, T>)this).registerMetadataRewriter(ClientboundPackets1_14.ENTITY_METADATA, Types1_14.METADATA_LIST, Types1_13_2.METADATA_LIST);
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.JOIN_GAME, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.INT);
        ...
        ((AbstractProtocol<ClientboundPackets1_14, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_14.RESPAWN, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.INT);
                this.handler(wrapper -> {
    ...
    protected void registerRewrites() {
        ...
        this.filter().handler((event, meta) -> {
            final EntityType type = event.entityType();
            if (type == null) {
                return;
            }
            else {
