...
public class EntityPackets1_16 extends EntityRewriter<ClientboundPackets1_16, Protocol1_15_2To1_16>
{
    ...
    protected void registerPackets() {
        ((AbstractProtocol<ClientboundPackets1_16, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_16.SPAWN_ENTITY, new PacketHandlers() {
        ...
        ((EntityRewriter<ClientboundPackets1_16, T>)this).registerSpawnTracker(ClientboundPackets1_16.SPAWN_MOB);
        ((AbstractProtocol<ClientboundPackets1_16, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_16.RESPAWN, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_16, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_16.JOIN_GAME, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.INT);
        ...
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16, T>)this).registerTracker(ClientboundPackets1_16.SPAWN_EXPERIENCE_ORB, Entity1_16Types.EXPERIENCE_ORB);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16, T>)this).registerTracker(ClientboundPackets1_16.SPAWN_PAINTING, Entity1_16Types.PAINTING);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16, T>)this).registerTracker(ClientboundPackets1_16.SPAWN_PLAYER, Entity1_16Types.PLAYER);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16, T>)this).registerRemoveEntities(ClientboundPackets1_16.DESTROY_ENTITIES);
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_16, T>)this).registerMetadataRewriter(ClientboundPackets1_16.ENTITY_METADATA, Types1_16.METADATA_LIST, Types1_14.METADATA_LIST);
        ((AbstractProtocol<ClientboundPackets1_16, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_16.ENTITY_PROPERTIES, wrapper -> {
            wrapper.passthrough((Type<Object>)Type.VAR_INT);
            for (int size = wrapper.passthrough((Type<Integer>)Type.INT), i = 0; i < size; ++i) {
                ...
                final String oldKey = ((Protocol1_15_2To1_16)this.protocol).getMappingData().getAttributeMappings().get(attributeIdentifier);
        ...
        ((AbstractProtocol<ClientboundPackets1_16, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_16.PLAYER_INFO, new PacketHandlers() {
            public void register() {
