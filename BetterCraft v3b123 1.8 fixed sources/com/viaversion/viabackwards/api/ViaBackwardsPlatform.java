...
public interface ViaBackwardsPlatform
{
    ...
    public static final String IMPL_VERSION = "git-ViaBackwards-4.7.0-1.20-pre3-SNAPSHOT:d271d3d6";
    ...
    default void init(final File dataFolder) {
        ...
        Via.getManager().getSubPlatforms().add("git-ViaBackwards-4.7.0-1.20-pre3-SNAPSHOT:d271d3d6");
    ...
    default boolean isOutdated() {
        ...
        if (vvVersion != null && new Version(vvVersion).compareTo(new Version("4.7.0--")) < 0) {
