...
public abstract class LegacyEntityRewriter<C extends ClientboundPacketType, T extends BackwardsProtocol<C, ?, ?, ?>> extends EntityRewriterBase<C, T>
{
    ...
    protected EntityObjectData mapObjectType(final ObjectType oldObjectType, final ObjectType replacement, final int data) {
        final EntityObjectData entData = new EntityObjectData((BackwardsProtocol<?, ?, ?, ?>)this.protocol, oldObjectType.getType().name(), oldObjectType.getId(), replacement.getId(), data);
    ...
    protected void registerRespawn(final C packetType) {
    ...
    protected void registerJoinGame(final C packetType, final EntityType playerType) {
        ((BackwardsProtocol)this.protocol).registerClientbound(packetType, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.INT);
