...
@Plugin(id = "viaversion", name = "ViaVersion", version = "4.7.0-1.20-pre4-SNAPSHOT", authors = { "_MylesC", "creeper123123321", "Gerrygames", "kennytv", "Matsv" }, description = "Allow newer Minecraft versions to connect to an older server version.", url = "https://viaversion.com")
public class VelocityPlugin implements ViaServerProxyPlatform<Player>
{
    ...
    public PlatformTask runSync(final Runnable runnable, final long delay) {
        return new VelocityViaTask(VelocityPlugin.PROXY.getScheduler().buildTask((Object)this, runnable).delay(delay * 50L, TimeUnit.MILLISECONDS).schedule());
    }
