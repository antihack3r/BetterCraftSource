...
public class ProtocolManagerImpl implements ProtocolManager
{
    ...
    public ProtocolManagerImpl() {
        ...
        this.protocols = new HashMap<Class<? extends Protocol>, Protocol<?, ?, ?, ?>>(64);
        ...
        (this.mappingLoaderExecutor = new ThreadPoolExecutor(12, Integer.MAX_VALUE, 30L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), threadFactory)).allowCoreThreadTimeOut(true);
    }
    ...
    public Collection<Protocol<?, ?, ?, ?>> getProtocols() {
        return Collections.unmodifiableCollection((Collection<? extends Protocol<?, ?, ?, ?>>)this.protocols.values());
    }
