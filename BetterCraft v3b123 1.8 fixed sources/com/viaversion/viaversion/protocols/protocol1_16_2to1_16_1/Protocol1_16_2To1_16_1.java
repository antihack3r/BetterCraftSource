...
public class Protocol1_16_2To1_16_1 extends AbstractProtocol<ClientboundPackets1_16, ClientboundPackets1_16_2, ServerboundPackets1_16, ServerboundPackets1_16_2>
{
    ...
    private final MetadataRewriter1_16_2To1_16_1 metadataRewriter;
    ...
    protected void registerPackets() {
        ...
        (this.tagRewriter = new TagRewriter<ClientboundPackets1_16>(this)).register(ClientboundPackets1_16.TAGS, RegistryType.ENTITY);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_16_2>)this).registerServerbound(ServerboundPackets1_16_2.RECIPE_BOOK_DATA, wrapper -> {
        ...
        ((Protocol<CU, CM, ServerboundPackets1_16, ServerboundPackets1_16_2>)this).registerServerbound(ServerboundPackets1_16_2.SEEN_RECIPE, ServerboundPackets1_16.RECIPE_BOOK_DATA, wrapper -> {
