...
public class Protocol1_11To1_10 extends AbstractProtocol<ClientboundPackets1_9_3, ClientboundPackets1_9_3, ServerboundPackets1_9_3, ServerboundPackets1_9_3>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_9_3.COLLECT_ITEM, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
        ...
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_9_3, T>)this.entityRewriter).registerMetadataRewriter(ClientboundPackets1_9_3.ENTITY_METADATA, Types1_9.METADATA_LIST);
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_9_3.ENTITY_TELEPORT, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.DOUBLE);
                this.map((Type<Object>)Type.DOUBLE);
        ...
        ((com.viaversion.viaversion.rewriter.EntityRewriter<ClientboundPackets1_9_3, T>)this.entityRewriter).registerRemoveEntities(ClientboundPackets1_9_3.DESTROY_ENTITIES);
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_9_3.TITLE, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_9_3.BLOCK_ACTION, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_9_3, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_9_3.EFFECT, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.INT);
                this.map(Type.POSITION);
                this.map((Type<Object>)Type.INT);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_9_3>)this).registerServerbound(ServerboundPackets1_9_3.PLAYER_BLOCK_PLACEMENT, new PacketHandlers() {
            public void register() {
                this.map(Type.POSITION);
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_9_3>)this).registerServerbound(ServerboundPackets1_9_3.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
