...
public class EntityPackets
{
    ...
    public static void register(final Protocol1_16To1_15_2 protocol) {
        ...
        ((Protocol<ClientboundPackets1_15, ClientboundPackets1_16, SM, SU>)protocol).registerClientbound(ClientboundPackets1_15.SPAWN_GLOBAL_ENTITY, ClientboundPackets1_16.SPAWN_ENTITY, wrapper -> {
        ...
        ((EntityRewriter<ClientboundPackets1_15, T>)metadataRewriter).registerTrackerWithData(ClientboundPackets1_15.SPAWN_ENTITY, Entity1_16Types.FALLING_BLOCK);
        ((EntityRewriter<ClientboundPackets1_15, T>)metadataRewriter).registerTracker(ClientboundPackets1_15.SPAWN_MOB);
        ((EntityRewriter<ClientboundPackets1_15, T>)metadataRewriter).registerTracker(ClientboundPackets1_15.SPAWN_PLAYER, Entity1_16Types.PLAYER);
        ((EntityRewriter<ClientboundPackets1_15, T>)metadataRewriter).registerMetadataRewriter(ClientboundPackets1_15.ENTITY_METADATA, Types1_14.METADATA_LIST, Types1_16.METADATA_LIST);
        ((EntityRewriter<ClientboundPackets1_15, T>)metadataRewriter).registerRemoveEntities(ClientboundPackets1_15.DESTROY_ENTITIES);
        ((AbstractProtocol<ClientboundPackets1_15, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_15.RESPAWN, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_15, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_15.JOIN_GAME, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_15, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_15.ENTITY_PROPERTIES, wrapper -> {
            wrapper.passthrough((Type<Object>)Type.VAR_INT);
            int actualSize;
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_16>)protocol).registerServerbound(ServerboundPackets1_16.ANIMATION, wrapper -> {
