...
public final class Protocol1_19To1_18_2 extends AbstractProtocol<ClientboundPackets1_18, ClientboundPackets1_19, ServerboundPackets1_17, ServerboundPackets1_19>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_18.ADD_VIBRATION_SIGNAL);
        final SoundRewriter<ClientboundPackets1_18> soundRewriter = new SoundRewriter<ClientboundPackets1_18>(this);
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.SOUND, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.ENTITY_SOUND, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.NAMED_SOUND, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.TITLE_TEXT, titleHandler);
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.TITLE_SUBTITLE, titleHandler);
        final CommandRewriter<ClientboundPackets1_18> commandRewriter = new CommandRewriter<ClientboundPackets1_18>(this);
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_18.DECLARE_COMMANDS, wrapper -> {
        ...
        ((Protocol<ClientboundPackets1_18, ClientboundPackets1_19, SM, SU>)this).registerClientbound(ClientboundPackets1_18.CHAT_MESSAGE, ClientboundPackets1_19.SYSTEM_CHAT, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_19>)this).registerServerbound(ServerboundPackets1_19.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
                this.read(Type.LONG);
                this.read(Type.LONG);
        ...
        ((Protocol<CU, CM, ServerboundPackets1_17, ServerboundPackets1_19>)this).registerServerbound(ServerboundPackets1_19.CHAT_COMMAND, ServerboundPackets1_17.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
                this.read(Type.LONG);
                this.read(Type.LONG);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_19>)this).cancelServerbound(ServerboundPackets1_19.CHAT_PREVIEW);
