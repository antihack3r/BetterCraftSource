...
public final class EntityPackets extends EntityRewriter<ClientboundPackets1_18, Protocol1_19To1_18_2>
{
    ...
    public void registerPackets() {
        ((EntityRewriter<ClientboundPackets1_18, T>)this).registerTracker(ClientboundPackets1_18.SPAWN_PLAYER, Entity1_19Types.PLAYER);
        ((EntityRewriter<ClientboundPackets1_18, T>)this).registerMetadataRewriter(ClientboundPackets1_18.ENTITY_METADATA, Types1_18.METADATA_LIST, Types1_19.METADATA_LIST);
        ((EntityRewriter<ClientboundPackets1_18, T>)this).registerRemoveEntities(ClientboundPackets1_18.REMOVE_ENTITIES);
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.SPAWN_ENTITY, new PacketHandlers() {
        ...
        this.protocol.registerClientbound(ClientboundPackets1_18.SPAWN_PAINTING, ClientboundPackets1_19.SPAWN_ENTITY, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map(Type.UUID);
                this.handler(wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.ENTITY_EFFECT, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.VAR_INT);
                this.map((Type<Object>)Type.BYTE);
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.JOIN_GAME, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.RESPAWN, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_18, CM, SM, SU>)this.protocol).registerClientbound(ClientboundPackets1_18.PLAYER_INFO, wrapper -> {
            ...
            for (int entries = wrapper.passthrough((Type<Integer>)Type.VAR_INT), i = 0; i < entries; ++i) {
                ...
                if (action == 0) {
                    ...
                    final JsonElement displayName2 = wrapper.read(Type.OPTIONAL_COMPONENT);
                    if (!Protocol1_19To1_18_2.isTextComponentNull(displayName2)) {
                        wrapper.write(Type.OPTIONAL_COMPONENT, displayName2);
                    }
                    else {
                        wrapper.write(Type.OPTIONAL_COMPONENT, null);
                    }
    ...
    protected void registerRewrites() {
        ...
        this.registerMetaTypeHandler(Types1_19.META_TYPES.itemType, Types1_19.META_TYPES.blockStateType, null, Types1_19.META_TYPES.particleType);
