...
public class WorldPackets
{
    ...
    public static void register(final Protocol1_13To1_12_2 protocol) {
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.SPAWN_PAINTING, new PacketHandlers() {
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.BLOCK_ENTITY_DATA, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.BLOCK_ACTION, new PacketHandlers() {
            public void register() {
                this.map(Type.POSITION);
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                ...
                this.handler(wrapper -> {
                    ...
                    if (blockId == 73) {
                        final PacketWrapper blockChange = wrapper.create(ClientboundPackets1_13.BLOCK_CHANGE);
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.BLOCK_CHANGE, new PacketHandlers() {
            public void register() {
                this.map(Type.POSITION);
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.MULTI_BLOCK_CHANGE, new PacketHandlers() {
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (int length = array.length; i < length; ++i) {
                        ...
                        final Position position = new Position(record.getSectionX() + (chunkX << 4), record.getY(), record.getSectionZ() + (chunkZ << 4));
                    ...
                    if (Via.getConfig().isServersideBlockConnections()) {
                        ...
                        for (int length2 = array2.length; j < length2; ++j) {
                            ...
                            if (handler != null) {
                                ...
                                ConnectionData.updateBlockStorage(userConnection, position2.x(), position2.y(), position2.z(), blockState2);
                            }
                        }
                        wrapper.send(Protocol1_13To1_12_2.class);
                        wrapper.cancel();
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.EXPLOSION, new PacketHandlers() {
            public void register() {
                if (!Via.getConfig().isServersideBlockConnections()) {
                    return;
                }
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.UNLOAD_CHUNK, new PacketHandlers() {
            public void register() {
                if (Via.getConfig().isServersideBlockConnections()) {
                    this.handler(wrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.NAMED_SOUND, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.CHUNK_DATA, wrapper -> {
                ...
                if (section != null) {
                    ...
                    Label_0351_1: {
                        ...
                        for (int idx = 0; idx < 4096; ++idx) {
                            ...
                            final Position position = new Position(ChunkSection.xFromIndex(idx) + (chunk.getX() << 4), ChunkSection.yFromIndex(idx) + (s << 4), ChunkSection.zFromIndex(idx) + (chunk.getZ() << 4));
            ...
            while (iterator.hasNext()) {
                ...
                if (newId2 != -1) {
                    ...
                    final BlockStorage.ReplacementData replacementData = storage.get(position2);
                    if (replacementData != null) {
                        replacementData.setReplacement(newId2);
                    }
                    chunk.getSections()[y >> 4].palette(PaletteType.BLOCKS).setIdAt(x & 0xF, y & 0xF, z & 0xF, newId2);
                }
            ...
            if (Via.getConfig().isServersideBlockConnections()) {
                ...
                wrapper.send(Protocol1_13To1_12_2.class);
                wrapper.cancel();
                final ConnectionData.NeighbourUpdater updater = new ConnectionData.NeighbourUpdater(wrapper.user());
                for (int j = 0; j < chunk.getSections().length; ++j) {
                    final ChunkSection section2 = chunk.getSections()[j];
                    if (section2 != null) {
                        updater.updateChunkSectionNeighbours(chunk.getX(), chunk.getZ(), j);
                    }
                }
            }
            return;
        });
        ((AbstractProtocol<ClientboundPackets1_12_1, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_12_1.SPAWN_PARTICLE, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.INT);
