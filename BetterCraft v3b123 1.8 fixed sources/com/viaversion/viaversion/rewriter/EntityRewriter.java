...
public abstract class EntityRewriter<C extends ClientboundPacketType, T extends Protocol<C, ?, ?, ?>> extends RewriterBase<T> implements com.viaversion.viaversion.api.rewriter.EntityRewriter<T>
{
    ...
    public void registerMetaTypeHandler(final MetaType itemType, final MetaType blockStateType, final MetaType optionalBlockStateType, final MetaType particleType) {
        this.filter().handler((event, meta) -> {
            ...
            if (type == itemType) {
                ...
                if (data2 != 0) {
                    meta.setValue(this.protocol.getMappingData().getNewBlockStateId(data2));
                }
            }
    ...
    public void registerTracker(final C packetType) {
    ...
    public void registerTracker(final C packetType, final EntityType entityType, final Type<Integer> intType) {
    ...
    public void registerTracker(final C packetType, final EntityType entityType) {
        this.registerTracker(packetType, entityType, Type.VAR_INT);
    }
    
    public void registerRemoveEntities(final C packetType) {
        this.protocol.registerClientbound(packetType, wrapper -> {
            final int[] entityIds = wrapper.passthrough(Type.VAR_INT_ARRAY_PRIMITIVE);
            final EntityTracker entityTracker = this.tracker(wrapper.user());
            final int[] array;
            int i = 0;
    ...
    public void registerRemoveEntity(final C packetType) {
        this.protocol.registerClientbound(packetType, wrapper -> {
    ...
    public void registerMetadataRewriter(final C packetType, final Type<List<Metadata>> oldMetaType, final Type<List<Metadata>> newMetaType) {
        this.protocol.registerClientbound(packetType, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                if (oldMetaType != null) {
                    ...
                    this.map((Type<Object>)newMetaType);
                }
                this.handler(wrapper -> {
    ...
    public void registerMetadataRewriter(final C packetType, final Type<List<Metadata>> metaType) {
    ...
    public PacketHandler dimensionDataHandler() {
        return wrapper -> {
            ...
            final Map<String, DimensionData> dimensionDataMap = new HashMap<String, DimensionData>(dimensions.size());
            dimensions.iterator();
