...
public final class CharStreams
{
    ...
    @Deprecated
    public static <W extends Appendable & Closeable> void write(final CharSequence from, final OutputSupplier<W> to) throws IOException {
        asCharSink(to).write(from);
    }
    
    @Deprecated
    public static <R extends Readable & Closeable, W extends Appendable & Closeable> long copy(final InputSupplier<R> from, final OutputSupplier<W> to) throws IOException {
        return asCharSource(from).copyTo(asCharSink(to));
    }
    
    @Deprecated
    public static <R extends Readable & Closeable> long copy(final InputSupplier<R> from, final Appendable to) throws IOException {
    ...
    @Deprecated
    public static <R extends Readable & Closeable> String toString(final InputSupplier<R> supplier) throws IOException {
    ...
    @Deprecated
    public static <R extends Readable & Closeable> String readFirstLine(final InputSupplier<R> supplier) throws IOException {
        return asCharSource(supplier).readFirstLine();
    }
    
    @Deprecated
    public static <R extends Readable & Closeable> List<String> readLines(final InputSupplier<R> supplier) throws IOException {
    ...
    @Deprecated
    public static <R extends Readable & Closeable, T> T readLines(final InputSupplier<R> supplier, final LineProcessor<T> callback) throws IOException {
