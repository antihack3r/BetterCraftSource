...
public final class Files
{
    ...
    @Deprecated
    public static <R extends Readable & Closeable> void copy(final InputSupplier<R> from, final File to, final Charset charset) throws IOException {
    ...
    @Deprecated
    public static <W extends Appendable & Closeable> void copy(final File from, final Charset charset, final OutputSupplier<W> to) throws IOException {
