    ...
    public String toLanguageTag() {
        ...
        if (base.getVariant().equalsIgnoreCase("POSIX")) {
            ...
            if (exts.getUnicodeLocaleType("va") == null) {
                ...
                catch (final LocaleSyntaxException e) {
            ...
            if (kwitr == null) {
                ...
                while (kwitr.hasNext()) {
                    ...
                    if (key.equals("attribute")) {
                        ...
                        catch (final LocaleSyntaxException ex2) {}
                    }
                    else {
                        ...
                        catch (final LocaleSyntaxException ex3) {}
                    }
                }
    ...
    private static final class JDKLocaleHelper
    {
        ...
        static {
            ...
            try {
                ...
                final Class[] arr$;
                final Class<?>[] classes = arr$ = Locale.class.getDeclaredClasses();
