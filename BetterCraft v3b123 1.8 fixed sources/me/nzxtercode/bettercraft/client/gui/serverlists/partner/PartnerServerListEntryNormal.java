...
public class PartnerServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public PartnerServerListEntryNormal(final GuiPartnerMultiplayer owner, final ServerData data) {
        this.owner = owner;
    ...
    public void ping() {
        ...
        PartnerServerListEntryNormal.field_148302_b.submit(() -> {
            try {
    ...
    public void drawEntry(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_) {
        ...
        if (this.field_148305_h != null) {
            ...
            this.func_178012_a(p_192634_2_, p_192634_3_, PartnerServerListEntryNormal.UNKNOWN_SERVER);
        }
        ...
        if (this.mc.gameSettings.touchscreen || p_192634_8_) {
            this.mc.getTextureManager().bindTexture(PartnerServerListEntryNormal.SERVER_SELECTION_BUTTONS);
        ...
        if (this.serverData.getBase64EncodedIconData() == null) {
            ...
            Label_0234: {
                try {
                    ...
                    PartnerServerListEntryNormal.logger.error("Invalid icon for server " + this.serverData.serverName + " (" + this.serverData.serverIP + ")", throwable);
