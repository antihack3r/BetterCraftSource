...
public class GuiPasswordField extends Gui
{
    ...
    public GuiPasswordField(final FontRenderer par1FontRenderer, final int par2, final int par3, final int par4, final int par5) {
        this.text = "";
    ...
    public void writeText(final String par1Str) {
        ...
        this.func_73784_d(var4 - this.selectionEnd + var7);
    }
