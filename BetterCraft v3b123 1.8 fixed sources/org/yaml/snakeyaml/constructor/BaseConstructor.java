...
public abstract class BaseConstructor
{
    ...
    protected Construct getConstructor(final Node node) {
        ...
        final Construct constructor = this.yamlConstructors.get(tag);
        if (constructor == null) {
    ...
    protected final Object newInstance(final Class<?> ancestor, final Node node) {
    ...
    protected Object newInstance(final Class<?> ancestor, final Node node, final boolean tryDefault) {
        ...
        return BaseConstructor.NOT_INSTANTIATED_OBJECT;
    }
    
    protected Set<Object> newSet(final CollectionNode<?> node) {
        final Object instance = this.newInstance(Set.class, node);
    ...
    protected List<Object> newList(final SequenceNode node) {
        final Object instance = this.newInstance(List.class, node);
        if (instance != BaseConstructor.NOT_INSTANTIATED_OBJECT) {
    ...
    protected Map<Object, Object> newMap(final MappingNode node) {
        final Object instance = this.newInstance(Map.class, node);
        if (instance != BaseConstructor.NOT_INSTANTIATED_OBJECT) {
            return (Map)instance;
        }
