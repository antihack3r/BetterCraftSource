...
public class SafeConstructor extends BaseConstructor
{
    ...
    protected void flattenMapping(final MappingNode node, final boolean forceStringKeys) {
    ...
    protected void processDuplicateKeys(final MappingNode node, final boolean forceStringKeys) {
    ...
    private List<NodeTuple> mergeNode(final MappingNode node, final boolean isPreffered, final Map<Object, Integer> key2index, final List<NodeTuple> values, final boolean forceStringKeys) {
    ...
    public class ConstructYamlBinary extends AbstractConstruct
    {
        @Override
        public Object construct(final Node node) {
            final String noWhiteSpaces = SafeConstructor.this.constructScalar((ScalarNode)node).replaceAll("\\s", "");
