...
public class MappedObjectTransformer
{
    ...
    static byte[] transformMappedAPI(final String className, byte[] bytecode) {
        ...
        ClassVisitor cv;
        final TransformationAdapter ta = (TransformationAdapter)(cv = (ClassVisitor)new TransformationAdapter(cw, className));
    ...
    private static InsnList generateCopyRangeInstructions(final MappedSubtypeInfo mappedType) {
        ...
        list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "copy", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";I)V"));
        return list;
    }
    ...
    private static InsnList generateSliceInstructions(final MethodInsnNode methodInsn) {
        ...
        list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "slice", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";)L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";"));
        return list;
    }
    ...
    private static InsnList generateDupInstructions(final MethodInsnNode methodInsn) {
        ...
        list.add(new InsnNode(89));
        list.add(new MethodInsnNode(183, methodInsn.owner, "<init>", "()V"));
        list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "dup", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";)L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";"));
        return list;
    }
    ...
    private static InsnList generateMapInstructions(final MappedSubtypeInfo mappedType, final String className, final boolean mapDirectMethod, final boolean mallocMethod) {
        ...
        if (mallocMethod) {
            ...
            trg.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "newBuffer", "(JI)L" + jvmClassName(ByteBuffer.class) + ";"));
        }
        ...
        trg.add(getIntNode(mappedType.sizeof));
        trg.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "setup", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";Ljava/nio/ByteBuffer;II)V"));
        return trg;
    }
    ...
    private static InsnList generateSetViewInstructions(final FieldInsnNode fieldInsn) {
        ...
        if (MappedObjectTransformer.MAPPED_SET2_JVM.equals(fieldInsn.owner)) {
            list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "put_views", "(L" + MappedObjectTransformer.MAPPED_SET2_JVM + ";I)V"));
        }
        else if (MappedObjectTransformer.MAPPED_SET3_JVM.equals(fieldInsn.owner)) {
            list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "put_views", "(L" + MappedObjectTransformer.MAPPED_SET3_JVM + ";I)V"));
        }
        else {
            if (!MappedObjectTransformer.MAPPED_SET4_JVM.equals(fieldInsn.owner)) {
                throw new InternalError();
            }
            list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "put_views", "(L" + MappedObjectTransformer.MAPPED_SET4_JVM + ";I)V"));
        }
        return list;
    }
    ...
    private static InsnList generateViewInstructions(final FieldInsnNode fieldInsn, final MappedSubtypeInfo mappedSubtype) {
        ...
        if (fieldInsn.getOpcode() == 180) {
            if (mappedSubtype.sizeof_shift != 0) {
                ...
                list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "get_view_shift", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";I)I"));
            }
            else {
                list.add(getIntNode(mappedSubtype.sizeof));
                list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "get_view", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";I)I"));
            }
            return list;
        }
        if (fieldInsn.getOpcode() == 181) {
            if (mappedSubtype.sizeof_shift != 0) {
                list.add(getIntNode(mappedSubtype.sizeof_shift));
                list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "put_view_shift", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";II)V"));
            }
            else {
                list.add(getIntNode(mappedSubtype.sizeof));
                list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "put_view", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";II)V"));
            }
            return list;
        }
        throw new InternalError();
    ...
    private static InsnList generateByteBufferInstructions(final FieldInsnNode fieldInsn, final MappedSubtypeInfo mappedSubtype, final long fieldOffset) {
        ...
        if (fieldInsn.getOpcode() == 180) {
            ...
            list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, "newBuffer", "(JI)L" + jvmClassName(ByteBuffer.class) + ";"));
            return list;
        }
        throw new InternalError();
    }
    ...
    private static InsnList generateFieldInstructions(final FieldInsnNode fieldInsn, final FieldInfo field) {
        ...
        if (fieldInsn.getOpcode() == 181) {
            ...
            list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, field.getAccessType() + "put", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";" + fieldInsn.desc + "I)V"));
            return list;
        }
        if (fieldInsn.getOpcode() == 180) {
            list.add(getIntNode((int)field.offset));
            list.add(new MethodInsnNode(184, MappedObjectTransformer.MAPPED_HELPER_JVM, field.getAccessType() + "get", "(L" + MappedObjectTransformer.MAPPED_OBJECT_JVM + ";I)" + fieldInsn.desc));
            return list;
        }
        throw new InternalError();
    }
    ...
    private static void printBytecode(final byte[] bytecode) {
        ...
        final ClassVisitor tracer = new TraceClassVisitor(new ClassWriter(0), new PrintWriter(sw));
                    ...
                    public void visitEnd() {
                        ...
                        if (before) {
                            ...
                            for (int count = j = CacheUtil.getCacheLineSize() / byteLength - 1; j >= 1; --j) {
                                TransformationAdapter.this.cv.visitField(this.access | 0x1 | 0x1000, this.name + "$PAD_" + j, this.desc, this.signature, null);
                            }
                        }
                        this.accept(TransformationAdapter.this.cv);
                        if (after) {
                            for (int count = CacheUtil.getCacheLineSize() / byteLength - 1, j = 1; j <= count; ++j) {
                                TransformationAdapter.this.cv.visitField(this.access | 0x1 | 0x1000, this.name + "$PAD" + j, this.desc, this.signature, null);
                            }
                        }
                    }
                };
        ...
        public MethodVisitor visitMethod(final int access, String name, final String desc, final String signature, final String[] exceptions) {
            ...
            return new MethodNode(access, name, desc, signature, exceptions) {
                ...
                private Frame<BasicValue>[] analyse() throws AnalyzerException {
                    final Analyzer<BasicValue> a = (Analyzer<BasicValue>)new Analyzer(new SimpleVerifier());
