...
public class Message
{
    ...
    public Message(final IMessagerEx.MessageType type, final CharSequence msg) {
    ...
    public Message(final IMessagerEx.MessageType type, final CharSequence msg, final Element element) {
    ...
    public Message(final IMessagerEx.MessageType type, final CharSequence msg, final Element element, final AnnotationHandle annotation) {
    ...
    public Message(final IMessagerEx.MessageType type, final CharSequence msg, final Element element, final AnnotationMirror annotation) {
    ...
    public Message(final IMessagerEx.MessageType type, final CharSequence msg, final Element element, final AnnotationHandle annotation, final AnnotationValue value) {
    ...
    public Message(final IMessagerEx.MessageType type, final CharSequence msg, final Element element, final AnnotationMirror annotation, final AnnotationValue value) {
