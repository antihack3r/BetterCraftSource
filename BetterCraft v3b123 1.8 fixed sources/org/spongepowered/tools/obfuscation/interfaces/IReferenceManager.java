...
public interface IReferenceManager
{
    ...
    void addMethodMapping(final String p0, final String p1, final ITargetSelectorRemappable p2, final ObfuscationData<MappingMethod> p3);
    
    void addFieldMapping(final String p0, final String p1, final ITargetSelectorRemappable p2, final ObfuscationData<MappingField> p3);
