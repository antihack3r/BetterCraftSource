...
class AnnotatedMixinElementHandlerShadow extends AnnotatedMixinElementHandler
{
    ...
    private void registerShadowForTarget(final AnnotatedElementShadow<?, ?> elem, final TypeHandle target) {
        ...
        if (obfData.isEmpty()) {
            ...
            final IMessagerEx.MessageType messageType = target.isSimulated() ? IMessagerEx.MessageType.NO_OBFDATA_FOR_SIMULATED_SHADOW : IMessagerEx.MessageType.NO_OBFDATA_FOR_SHADOW;
