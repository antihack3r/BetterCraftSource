...
public class ModifyArgInjector extends InvokeInjector
{
    ...
    protected void injectAtInvoke(final Target target, final InjectionNodes.InjectionNode node) {
        ...
        final Target.Extension extraLocals = target.extendLocals();
    ...
    private void injectSingleArgHandler(final Target target, final Target.Extension extraLocals, final Type[] args, final int argIndex, final InsnList insns) {
    ...
    private void injectMultiArgHandler(final Target target, final Target.Extension extraLocals, final Type[] args, final int argIndex, final InsnList insns) {
