...
public class PrettyPrinter
{
    ...
    private static int lastBreakIndex(final String line, final int width) {
        final int lineBreakPos = line.lastIndexOf(10, width);
    ...
    public PrettyPrinter trace(final ILogger logger) {
        return this.trace(System.err, logger);
    }
    
    public PrettyPrinter trace(final ILogger logger, final Level level) {
    ...
    public PrettyPrinter trace(final PrintStream stream, final ILogger logger) {
        return this.trace(stream, logger, Level.DEBUG);
    }
    
    public PrettyPrinter trace(final PrintStream stream, final ILogger logger, final Level level) {
    ...
    public PrettyPrinter log(final ILogger logger) {
    ...
    public PrettyPrinter log(final ILogger logger, final Level level) {
        this.updateWidth();
    ...
    private void logSpecial(final ILogger logger, final Level level, final ISpecialEntry line) {
        logger.log(level, "/*{}*/", line.toString());
    }
    
    private void logString(final ILogger logger, final Level level, final String line) {
        if (line != null) {
