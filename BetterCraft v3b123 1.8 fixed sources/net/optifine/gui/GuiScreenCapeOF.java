...
public class GuiScreenCapeOF extends GuiScreenOF
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRenderer, this.title, GuiScreenCapeOF.width / 2, 20, 16777215);
        if (this.message != null) {
            Gui.drawCenteredString(this.fontRenderer, this.message, GuiScreenCapeOF.width / 2, GuiScreenCapeOF.height / 6 + 60, 16777215);
