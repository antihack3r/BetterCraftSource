...
public class Item
{
    ...
    private TabsCreative tabToDisplayOn1;
    ...
    public void getSubItems(final Item itemIn, final TabsCreative tab, final List<ItemStack> subItems) {
        subItems.add(new ItemStack(itemIn, 1, 0));
    }
    
    public TabsCreative getTabCreative() {
        return this.tabToDisplayOn1;
    }
