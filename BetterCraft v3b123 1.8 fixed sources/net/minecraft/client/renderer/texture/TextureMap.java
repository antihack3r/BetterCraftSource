    ...
    public void loadTextureAtlas(final IResourceManager resourceManager) {
        ...
        for (final Map.Entry<String, TextureAtlasSprite> entry : this.mapRegisteredSprites.entrySet()) {
            ...
            if (textureatlassprite2.hasCustomLoader(resourceManager, resourcelocation1)) {
                ...
                if (j4 < l) {
                    TextureMap.logger.warn("Texture {} with size {}x{} limits mip level from {} to {}", resourcelocation2, textureatlassprite2.getIconWidth(), textureatlassprite2.getIconHeight(), MathHelper.calculateLogBaseTwo(l), MathHelper.calculateLogBaseTwo(j4));
                    l = j4;
                }
                stitcher.addSprite(textureatlassprite2);
            }
        ...
        if (k4 < this.mipmapLevels) {
            TextureMap.logger.warn("{}: dropping miplevel from {} to {}, because of minimum power of two: {}", this.basePath, this.mipmapLevels, k4, j5);
