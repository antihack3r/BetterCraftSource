...
public class Main
{
    public static void main(final String[] p_main_0_) {
        ...
        final ArgumentAcceptingOptionSpec<String> withRequiredArg = optionparser.accepts("username").withRequiredArg();
        BetterCraft.getInstance();
        final OptionSpec<String> optionspec10 = withRequiredArg.defaultsTo(String.valueOf(BetterCraft.clientName) + Minecraft.getSystemTime() % 1000L, new String[0]);
