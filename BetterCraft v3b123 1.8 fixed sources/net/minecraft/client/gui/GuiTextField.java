    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                Gui.drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, ColorUtils.rainbowEffect());
            ...
            if (flag2) {
                if (flag3) {
                    ...
                    this.fontRendererInstance.drawStringWithShadow("§4<", (float)k2, (float)i2, i);
                }
            }
            if (k != j) {
