...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), GuiStreamUnavailable.width / 2, i - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        for (final String s : this.field_152323_r) {
            Gui.drawCenteredString(this.fontRendererObj, s, GuiStreamUnavailable.width / 2, i, 10526880);
