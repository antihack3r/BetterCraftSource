...
public class GuiConnecting extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        switch ((int)(Minecraft.getSystemTime() / 300L % 4L)) {
            ...
            case 2: {
                s = "Connecting to " + EnumChatFormatting.RED.toString() + this.mc.getCurrentServerData().serverIP;
                break;
            }
            case 3: {
                s = "Send Handshake...";
        ...
        Gui.drawCenteredString(this.fontRendererObj, s, GuiConnecting.width / 2, GuiConnecting.height / 2 - 50, 16777215);
