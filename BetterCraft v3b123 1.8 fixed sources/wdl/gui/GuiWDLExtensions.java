...
public class GuiWDLExtensions extends GuiScreen
{
    ...
    static /* synthetic */ void access$2(final GuiWDLExtensions guiWDLExtensions, final int selectedModIndex) {
    ...
    private class ModList extends GuiListExtended
    {
        ...
        private class ModEntry implements IGuiListEntry
        {
            ...
            public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
                ...
                final int centerY = y + slotHeight / 2 - GuiWDLExtensions.this.fontRendererObj.FONT_HEIGHT / 2;
            ...
            public boolean mousePressed(final int slotIndex, final int x, final int y, final int mouseEvent, final int relativeX, final int relativeY) {
                ...
                if (GuiWDLExtensions.this.selectedModIndex != slotIndex) {
                    GuiWDLExtensions.access$2(GuiWDLExtensions.this, slotIndex);
