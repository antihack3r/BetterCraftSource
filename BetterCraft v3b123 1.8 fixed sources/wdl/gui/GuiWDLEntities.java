    ...
    private class GuiEntityList extends GuiListExtended
    {
        ...
        private class CategoryEntry implements IGuiListEntry
        {
            ...
            public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
                GuiEntityList.this.mc.fontRendererObj.drawString(this.group, x + 55 - this.labelWidth / 2, y + slotHeight - GuiEntityList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        ...
        private class EntityEntry implements IGuiListEntry
        {
            ...
            public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
                ...
                GuiEntityList.this.mc.fontRendererObj.drawString(this.entity, center - GuiEntityList.this.largestWidth - 10, y + slotHeight / 2 - GuiEntityList.this.mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);
