...
public class GuiWDL extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, name, this.worldname.xPosition - this.fontRendererObj.getStringWidth(String.valueOf(name) + " "), 26, 16777215);
            ...
            this.entries = new ArrayList<IGuiListEntry>() {
                {
                    ...
                    ((ArrayList<ButtonEntry>)this).add(new ButtonEntry("entityOptions", new GuiWDLEntities(GuiWDLButtonList.this.this$0), true));
