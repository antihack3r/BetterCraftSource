...
public class GuiWDLChunkOverrides extends GuiScreen
{
    ...
    private int displayXToChunkX(final int displayX) {
        return MathHelper.floor_float((displayX - (float)(GuiWDLChunkOverrides.width / 2)) / 8.0f + this.scrollX);
    }
    
    private int displayZToChunkZ(final int displayZ) {
        return MathHelper.floor_float((displayZ - (float)(GuiWDLChunkOverrides.height / 2)) / 8.0f + this.scrollZ);
    }
