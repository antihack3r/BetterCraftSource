...
public enum WDLMessageTypes implements IWDLMessageType
{
    ...
    private WDLMessageTypes(final String s, final int n, final String i18nKey, final boolean enabledByDefault) {
        this(s, n, i18nKey, EnumChatFormatting.DARK_GREEN, EnumChatFormatting.GOLD, enabledByDefault, MessageTypeCategory.CORE_DEBUG);
    }
    
    private WDLMessageTypes(final String s, final int n, final String i18nKey, final EnumChatFormatting titleColor, final EnumChatFormatting textColor, final boolean enabledByDefault, final MessageTypeCategory category) {
