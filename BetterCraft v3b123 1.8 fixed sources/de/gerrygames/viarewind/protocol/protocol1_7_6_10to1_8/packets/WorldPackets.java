...
public class WorldPackets
{
    public static void register(final Protocol1_7_6_10TO1_8 protocol) {
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.CHUNK_DATA, new PacketHandlers() {
                    ...
                    for (int length = array.length; j < length; ++j) {
                        ...
                        if (section != null) {
                            ...
                            for (int i = 0; i < palette.size(); ++i) {
                                final int block = palette.idByIndex(i);
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.MULTI_BLOCK_CHANGE, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.BLOCK_CHANGE, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.BLOCK_ACTION, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
                    final Position position = packetWrapper.read(Type.POSITION);
                    packetWrapper.write(Type.INT, position.x());
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.BLOCK_BREAK_ANIMATION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(packetWrapper -> {
                    final Position position = packetWrapper.read(Type.POSITION);
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.MAP_BULK_CHUNK, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.SPAWN_PARTICLE, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).cancelClientbound(ClientboundPackets1_8.SERVER_DIFFICULTY);
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).cancelClientbound(ClientboundPackets1_8.COMBAT_EVENT);
        ((Protocol<ClientboundPackets1_8, ClientboundPackets1_7, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.WORLD_BORDER, null, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
