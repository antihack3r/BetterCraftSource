...
public class PlayerPackets
{
    public static void register(final Protocol1_7_6_10TO1_8 protocol) {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.SPAWN_POSITION, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.UPDATE_HEALTH, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.SET_EXPERIENCE, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.FLOAT);
                this.map(Type.VAR_INT, Type.SHORT);
                this.map(Type.VAR_INT, Type.SHORT);
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.OPEN_SIGN_EDITOR, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
                    final Position position = packetWrapper.read(Type.POSITION);
                    packetWrapper.write(Type.INT, position.x());
                    ...
                    for (int i = 0; i < count; ++i) {
                        ...
                        if (action == 0) {
                            ...
                            while (true) {
                                ...
                                final Object o;
                                if (o > 0) {
                                    final String propertyName = packetWrapper.read(Type.STRING);
                                    final String propertyValue = packetWrapper.read(Type.STRING);
                                    final String propertySignature = packetWrapper.read(Type.OPTIONAL_STRING);
                            ...
                            final JsonElement displayName = packetWrapper.read(Type.OPTIONAL_COMPONENT);
                            if (displayName != null) {
                            ...
                            if (gameProfile3 != null) {
                                ...
                                packet2.write(Type.STRING, gameProfile3.getDisplayName());
                                packet2.write(Type.BOOLEAN, false);
                                packet2.write(Type.SHORT, (short)gameProfile3.ping);
                                ...
                                packet3.write(Type.STRING, gameProfile3.getDisplayName());
                                packet3.write(Type.BOOLEAN, true);
                                packet3.write(Type.SHORT, (short)ping2);
                                PacketUtil.sendPacket(packet3, Protocol1_7_6_10TO1_8.class);
                            }
                        }
                        else if (action == 3) {
                            final JsonElement displayNameComponent = packetWrapper.read(Type.OPTIONAL_COMPONENT);
                            final String displayName2 = (displayNameComponent != null) ? ChatUtil.jsonToLegacy(displayNameComponent) : null;
                            final GameProfileStorage.GameProfile gameProfile4 = gameProfileStorage.get(uuid);
                            if (gameProfile4 != null) {
                                if (gameProfile4.displayName != null || displayName2 != null) {
                                    final PacketWrapper packet4 = PacketWrapper.create(56, null, packetWrapper.user());
                                    packet4.write(Type.STRING, gameProfile4.getDisplayName());
                                    packet4.write(Type.BOOLEAN, false);
                                    packet4.write(Type.SHORT, (short)gameProfile4.ping);
                                    PacketUtil.sendPacket(packet4, Protocol1_7_6_10TO1_8.class);
                                    if ((gameProfile4.displayName == null && displayName2 != null) || (gameProfile4.displayName != null && displayName2 == null) || !gameProfile4.displayName.equals(displayName2)) {
                                        gameProfile4.setDisplayName(displayName2);
                                    }
                                    final PacketWrapper packet5 = PacketWrapper.create(56, null, packetWrapper.user());
                                    packet5.write(Type.STRING, gameProfile4.getDisplayName());
                                    packet5.write(Type.BOOLEAN, true);
                                    packet5.write(Type.SHORT, (short)gameProfile4.ping);
                                    PacketUtil.sendPacket(packet5, Protocol1_7_6_10TO1_8.class);
                                }
                            }
                        }
                        else if (action == 4) {
                            ...
                            if (gameProfile5 != null) {
                                final PacketWrapper packet6 = PacketWrapper.create(56, null, packetWrapper.user());
                                packet6.write(Type.STRING, gameProfile5.getDisplayName());
                                packet6.write(Type.BOOLEAN, false);
                                packet6.write(Type.SHORT, (short)gameProfile5.ping);
                                PacketUtil.sendPacket(packet6, Protocol1_7_6_10TO1_8.class);
                            }
                        }
                    }
                });
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.PLAYER_ABILITIES, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.BYTE);
                this.map((Type<Object>)Type.FLOAT);
                this.map((Type<Object>)Type.FLOAT);
        ...
        ((Protocol<ClientboundPackets1_8, ClientboundPackets1_7, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.CAMERA, null, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
                    packetWrapper.cancel();
                    final EntityTracker tracker = packetWrapper.user().get(EntityTracker.class);
        ...
        ((Protocol<ClientboundPackets1_8, ClientboundPackets1_7, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.TITLE, null, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
                    packetWrapper.cancel();
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).cancelClientbound(ClientboundPackets1_8.TAB_LIST);
        ((Protocol<ClientboundPackets1_8, ClientboundPackets1_7, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.RESOURCE_PACK, ClientboundPackets1_7.PLUGIN_MESSAGE, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.CHAT_MESSAGE, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.INTERACT_ENTITY, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_MOVEMENT, new PacketHandlers() {
            public void register() {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_POSITION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.DOUBLE);
                this.map((Type<Object>)Type.DOUBLE);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_ROTATION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.FLOAT);
                this.map((Type<Object>)Type.FLOAT);
                this.map((Type<Object>)Type.BOOLEAN);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_POSITION_AND_ROTATION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.DOUBLE);
                this.map((Type<Object>)Type.DOUBLE);
                this.map(Type.DOUBLE, Type.NOTHING);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_DIGGING, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.VAR_INT);
                this.handler(packetWrapper -> {
                    final int x = packetWrapper.read((Type<Integer>)Type.INT);
                    final int y = packetWrapper.read((Type<Short>)Type.UNSIGNED_BYTE);
                    final int z = packetWrapper.read((Type<Integer>)Type.INT);
                    packetWrapper.write(Type.POSITION, new Position(x, y, z));
                });
            }
        });
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_BLOCK_PLACEMENT, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
                    final int x = packetWrapper.read((Type<Integer>)Type.INT);
                    final int y = packetWrapper.read((Type<Short>)Type.UNSIGNED_BYTE);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.ANIMATION, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.ENTITY_ACTION, new PacketHandlers() {
            public void register() {
                this.map(Type.INT, Type.VAR_INT);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.STEER_VEHICLE, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.FLOAT);
                this.map((Type<Object>)Type.FLOAT);
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.UPDATE_SIGN, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
                    final int x = packetWrapper.read((Type<Integer>)Type.INT);
                    final int y = packetWrapper.read((Type<Short>)Type.SHORT);
                    final int z = packetWrapper.read((Type<Integer>)Type.INT);
                    packetWrapper.write(Type.POSITION, new Position(x, y, z));
                    for (int i = 0; i < 4; ++i) {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLAYER_ABILITIES, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.BYTE);
                this.map((Type<Object>)Type.FLOAT);
                this.map((Type<Object>)Type.FLOAT);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.TAB_COMPLETE, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.CLIENT_SETTINGS, new PacketHandlers() {
            public void register() {
                this.map(Type.STRING);
                this.map((Type<Object>)Type.BYTE);
                this.map((Type<Object>)Type.BYTE);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.PLUGIN_MESSAGE, new PacketHandlers() {
            public void register() {
                // 
