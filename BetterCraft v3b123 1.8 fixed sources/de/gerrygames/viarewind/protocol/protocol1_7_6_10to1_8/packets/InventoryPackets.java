...
public class InventoryPackets
{
    public static void register(final Protocol1_7_6_10TO1_8 protocol) {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.CLOSE_WINDOW, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                this.handler(packetWrapper -> {
                    final short windowsId = packetWrapper.get((Type<Short>)Type.UNSIGNED_BYTE, 0);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.CLICK_WINDOW, new PacketHandlers() {
            public void register() {
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.WINDOW_CONFIRMATION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.UNSIGNED_BYTE);
                this.map((Type<Object>)Type.SHORT);
        ...
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)protocol).registerServerbound(ServerboundPackets1_7.CREATIVE_INVENTORY_ACTION, new PacketHandlers() {
            public void register() {
                this.map((Type<Object>)Type.SHORT);
                this.map(Types1_7_6_10.COMPRESSED_NBT_ITEM, Type.ITEM);
                this.handler(packetWrapper -> {
