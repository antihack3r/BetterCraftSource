...
public class EntityPackets
{
    public static void register(final Protocol1_7_6_10TO1_8 protocol) {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.USE_BED, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.COLLECT_ITEM, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
                this.map(Type.VAR_INT, Type.INT);
            }
        });
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.ENTITY_VELOCITY, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
                this.map((Type<Object>)Type.SHORT);
                this.map((Type<Object>)Type.SHORT);
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.ENTITY_MOVEMENT, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
            }
        });
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.ENTITY_ROTATION, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
                this.map((Type<Object>)Type.BYTE);
                this.map((Type<Object>)Type.BYTE);
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.ENTITY_HEAD_LOOK, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
                this.map((Type<Object>)Type.BYTE);
                this.handler(packetWrapper -> {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)protocol).registerClientbound(ClientboundPackets1_8.REMOVE_ENTITY_EFFECT, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
                this.map((Type<Object>)Type.BYTE);
            }
