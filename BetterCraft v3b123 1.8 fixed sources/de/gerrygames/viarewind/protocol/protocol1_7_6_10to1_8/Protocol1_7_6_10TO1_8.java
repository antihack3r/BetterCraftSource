...
public class Protocol1_7_6_10TO1_8 extends AbstractProtocol<ClientboundPackets1_8, ClientboundPackets1_7, ServerboundPackets1_8, ServerboundPackets1_7>
{
    ...
    protected void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)this).registerClientbound(ClientboundPackets1_8.KEEP_ALIVE, new PacketHandlers() {
            public void register() {
                this.map(Type.VAR_INT, Type.INT);
            }
        });
        ((AbstractProtocol<ClientboundPackets1_8, CM, SM, SU>)this).cancelClientbound(ClientboundPackets1_8.SET_COMPRESSION);
        ((AbstractProtocol<CU, CM, SM, ServerboundPackets1_7>)this).registerServerbound(ServerboundPackets1_7.KEEP_ALIVE, new PacketHandlers() {
            public void register() {
