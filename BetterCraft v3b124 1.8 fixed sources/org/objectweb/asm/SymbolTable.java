...
final class SymbolTable {
    ...
    SymbolTable(ClassWriter classWriter, ClassReader classReader) {
        ...
        while (itemIndex < this.constantPoolCount) {
            ...
            byte itemTag = inputBytes[itemOffset - 1];
            switch (itemTag) {
                case 1: {
    ...
    private void copyBootstrapMethods(ClassReader classReader, char[] charBuffer) {
        ...
        int i2 = classReader.readUnsignedShort(currentAttributeOffset - 2);
        while (i2 > 0) {
        ...
        if (this.bootstrapMethodCount > 0) {
            ...
            int i3 = 0;
            while (i3 < this.bootstrapMethodCount) {
    ...
    Symbol addBootstrapMethod(Handle bootstrapMethodHandle, Object ... bootstrapMethodArguments) {
        ...
        Object[] objectArray = bootstrapMethodArguments;
        int n2 = bootstrapMethodArguments.length;
        int n3 = 0;
        while (n3 < n2) {
            Object bootstrapMethodArgument = objectArray[n3];
        ...
        Object[] objectArray2 = bootstrapMethodArguments;
        int n4 = bootstrapMethodArguments.length;
        int n5 = 0;
        while (n5 < n4) {
            Object bootstrapMethodArgument = objectArray2[n5];
        ...
        Object[] objectArray3 = bootstrapMethodArguments;
        int n6 = bootstrapMethodArguments.length;
        int n7 = 0;
        while (n7 < n6) {
            Object bootstrapMethodArgument = objectArray3[n7];
    ...
    private Symbol addBootstrapMethod(int offset, int length, int hashCode) {
        ...
        while (entry != null) {
            if (entry.tag == 64 && entry.hashCode == hashCode) {
                ...
                int i2 = 0;
                while (i2 < length) {
                    if (bootstrapMethodsData[offset + i2] != bootstrapMethodsData[otherOffset + i2]) {
