...
public class PropertiesUtil {
     ...
     */
    static Properties loadClose(InputStream in2, Object source) {
    ...
    public PropertiesUtil(String propsLocn) {
        ...
        InputStream in2 = loader.getResourceAsStream(propsLocn);
        this.props = PropertiesUtil.loadClose(in2, propsLocn);
    }
