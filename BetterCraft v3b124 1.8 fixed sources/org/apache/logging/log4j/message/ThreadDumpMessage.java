...
implements Message {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("ThreadDumpMessage[");
        if (this.title.length() > 0) {
            sb2.append("Title=\"").append(this.title).append("\"");
        }
        sb2.append("]");
        return sb2.toString();
    }
