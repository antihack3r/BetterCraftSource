...
public final class AMDDebugOutput {
    ...
    public static void glDebugMessageInsertAMD(int category, int severity, int id2, ByteBuffer buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsertAMD;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buf);
        AMDDebugOutput.nglDebugMessageInsertAMD(category, severity, id2, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
    }

    static native void nglDebugMessageInsertAMD(int var0, int var1, int var2, int var3, long var4, long var6);

    public static void glDebugMessageInsertAMD(int category, int severity, int id2, CharSequence buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsertAMD;
        BufferChecks.checkFunctionAddress(function_pointer);
        AMDDebugOutput.nglDebugMessageInsertAMD(category, severity, id2, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
    }
