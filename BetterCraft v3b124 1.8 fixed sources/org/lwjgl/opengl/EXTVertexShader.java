...
public final class EXTVertexShader {
    ...
    public static void glSetInvariantEXT(int id2, DoubleBuffer pAddr) {
        ...
        EXTVertexShader.nglSetInvariantEXT(id2, 5130, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id2, FloatBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id2, 5126, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id2, boolean unsigned, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id2, unsigned ? 5121 : 5120, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id2, boolean unsigned, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id2, unsigned ? 5125 : 5124, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id2, boolean unsigned, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id2, unsigned ? 5123 : 5122, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id2, DoubleBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id2, 5130, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id2, FloatBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id2, 5126, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id2, boolean unsigned, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id2, unsigned ? 5121 : 5120, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id2, boolean unsigned, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id2, unsigned ? 5125 : 5124, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id2, boolean unsigned, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id2, unsigned ? 5123 : 5122, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id2, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantbvEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id2, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantsvEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id2, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantivEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id2, FloatBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantfvEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id2, DoubleBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantdvEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantuEXT(int id2, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantubvEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantuEXT(int id2, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantusvEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantuEXT(int id2, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantuivEXT(id2, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id2, int stride, DoubleBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id2, 5130, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id2, int stride, FloatBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id2, 5126, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id2, boolean unsigned, int stride, ByteBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id2, unsigned ? 5121 : 5120, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id2, boolean unsigned, int stride, IntBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id2, unsigned ? 5125 : 5124, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id2, boolean unsigned, int stride, ShortBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id2, unsigned ? 5123 : 5122, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glGetVariantBooleanEXT(int id2, int value, ByteBuffer pbData) {
        ...
        EXTVertexShader.nglGetVariantBooleanvEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetVariantIntegerEXT(int id2, int value, IntBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetVariantIntegervEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetVariantFloatEXT(int id2, int value, FloatBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetVariantFloatvEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetInvariantBooleanEXT(int id2, int value, ByteBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetInvariantBooleanvEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetInvariantIntegerEXT(int id2, int value, IntBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetInvariantIntegervEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetInvariantFloatEXT(int id2, int value, FloatBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetInvariantFloatvEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetLocalConstantBooleanEXT(int id2, int value, ByteBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetLocalConstantBooleanvEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetLocalConstantIntegerEXT(int id2, int value, IntBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetLocalConstantIntegervEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetLocalConstantFloatEXT(int id2, int value, FloatBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetLocalConstantFloatvEXT(id2, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
