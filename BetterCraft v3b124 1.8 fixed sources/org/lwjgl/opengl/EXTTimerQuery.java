...
public final class EXTTimerQuery {
    ...
    public static void glGetQueryObjectEXT(int id2, int pname, LongBuffer params) {
        ...
        EXTTimerQuery.nglGetQueryObjecti64vEXT(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetQueryObjectuEXT(int id2, int pname, LongBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        EXTTimerQuery.nglGetQueryObjectui64vEXT(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
