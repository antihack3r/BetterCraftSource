...
public final class GL41 {
    ...
    public static void glVertexAttribL3d(int index, double x2, double y2, double z2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL3d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL41.nglVertexAttribL3d(index, x2, y2, z2, function_pointer);
    }

    static native void nglVertexAttribL3d(int var0, double var1, double var3, double var5, long var7);

    public static void glVertexAttribL4d(int index, double x2, double y2, double z2, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL4d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL41.nglVertexAttribL4d(index, x2, y2, z2, w2, function_pointer);
    }
