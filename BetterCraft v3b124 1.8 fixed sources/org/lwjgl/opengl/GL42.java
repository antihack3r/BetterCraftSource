...
public final class GL42 {
    ...
    public static void glDrawTransformFeedbackInstanced(int mode, int id2, int primcount) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL42.nglDrawTransformFeedbackInstanced(mode, id2, primcount, function_pointer);
    }
    ...
    public static void glDrawTransformFeedbackStreamInstanced(int mode, int id2, int stream, int primcount) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL42.nglDrawTransformFeedbackStreamInstanced(mode, id2, stream, primcount, function_pointer);
    }
