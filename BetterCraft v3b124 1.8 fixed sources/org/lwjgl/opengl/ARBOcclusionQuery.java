...
public final class ARBOcclusionQuery {
    ...
    public static void glDeleteQueriesARB(int id2) {
        ...
        long function_pointer = caps.glDeleteQueriesARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBOcclusionQuery.nglDeleteQueriesARB(1, APIUtil.getInt(caps, id2), function_pointer);
    }
    ...
    public static void glGetQueryObjectARB(int id2, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        ARBOcclusionQuery.nglGetQueryObjectivARB(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetQueryObjectuARB(int id2, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        ARBOcclusionQuery.nglGetQueryObjectuivARB(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
