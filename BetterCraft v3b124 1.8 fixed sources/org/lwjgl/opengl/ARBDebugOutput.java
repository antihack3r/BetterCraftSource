...
public final class ARBDebugOutput {
    ...
    public static void glDebugMessageInsertARB(int source, int type, int id2, int severity, ByteBuffer buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsertARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buf);
        ARBDebugOutput.nglDebugMessageInsertARB(source, type, id2, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
    }

    static native void nglDebugMessageInsertARB(int var0, int var1, int var2, int var3, int var4, long var5, long var7);

    public static void glDebugMessageInsertARB(int source, int type, int id2, int severity, CharSequence buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsertARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBDebugOutput.nglDebugMessageInsertARB(source, type, id2, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
    }
