...
public final class GL43 {
    ...
    public static void glDebugMessageInsert(int source, int type, int id2, int severity, ByteBuffer buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsert;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buf);
        GL43.nglDebugMessageInsert(source, type, id2, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
    }

    static native void nglDebugMessageInsert(int var0, int var1, int var2, int var3, int var4, long var5, long var7);

    public static void glDebugMessageInsert(int source, int type, int id2, int severity, CharSequence buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsert;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglDebugMessageInsert(source, type, id2, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
    }
    ...
    public static void glPushDebugGroup(int source, int id2, ByteBuffer message) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPushDebugGroup;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(message);
        GL43.nglPushDebugGroup(source, id2, message.remaining(), MemoryUtil.getAddress(message), function_pointer);
    }

    static native void nglPushDebugGroup(int var0, int var1, int var2, long var3, long var5);

    public static void glPushDebugGroup(int source, int id2, CharSequence message) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPushDebugGroup;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglPushDebugGroup(source, id2, message.length(), APIUtil.getBuffer(caps, message), function_pointer);
    }
