...
extends Item {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        String s2 = StatCollector.translateToLocal(String.valueOf(this.getUnlocalizedName()) + ".name").trim();
        String s1 = EntityList.getStringFromID(stack.getMetadata());
        if (s1 != null) {
            s2 = String.valueOf(s2) + " " + StatCollector.translateToLocal("entity." + s1 + ".name");
        }
        return s2;
    }
