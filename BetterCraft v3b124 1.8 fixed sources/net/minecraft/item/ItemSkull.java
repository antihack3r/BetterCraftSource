...
extends Item {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        return String.valueOf(super.getUnlocalizedName()) + "." + skullTypes[i2];
    }
    ...
    public boolean updateItemStackNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("SkullOwner", 8) && !nbt.getString("SkullOwner").replace(" ", "").isEmpty() && nbt.getString("SkullOwner").length() > 0) {
