...
extends TileEntity {
        ...
        if (this.patternList == null || this.colorList == null || this.patternResourceLocation == null) {
            if (!this.field_175119_g) {
                ...
                if (this.patterns != null) {
                    int i2 = 0;
                    while (i2 < this.patterns.tagCount()) {
                        ...
                        if (tileentitybanner$enumbannerpattern != null) {
                            ...
                            this.patternResourceLocation = String.valueOf(this.patternResourceLocation) + tileentitybanner$enumbannerpattern.getPatternID() + j2;
                        }
                        ++i2;
                    }
                }
    ...
    public static enum EnumBannerPattern {
        ...
        public static EnumBannerPattern getPatternByID(String id2) {
            ...
            int n3 = 0;
            while (n3 < n2) {
                EnumBannerPattern tileentitybanner$enumbannerpattern = enumBannerPatternArray[n3];
                if (tileentitybanner$enumbannerpattern.patternID.equals(id2)) {
