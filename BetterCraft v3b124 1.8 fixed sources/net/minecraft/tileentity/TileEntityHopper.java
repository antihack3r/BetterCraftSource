...
ITickable {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        while (i2 < nbttaglist.tagCount()) {
            ...
            if (j2 >= 0 && j2 < this.inventory.length) {
    ...
    private boolean transferItemsOut() {
        ...
        while (i2 < this.getSizeInventory()) {
            if (this.getStackInSlot(i2) != null) {
    ...
    private static boolean isInventoryEmpty(IInventory inventoryIn, EnumFacing side) {
        if (inventoryIn instanceof ISidedInventory) {
            ...
            while (i2 < aint.length) {
                if (isidedinventory.getStackInSlot(aint[i2]) != null) {
                    return false;
                }
                ++i2;
            }
            ...
            int k2 = 0;
            while (k2 < j2) {
                if (inventoryIn.getStackInSlot(k2) != null) {
                    return false;
                }
                ++k2;
            }
    ...
    public static boolean captureDroppedItems(IHopper p_145891_0_) {
        ...
        if (iinventory != null) {
            ...
            if (iinventory instanceof ISidedInventory) {
                ...
                int i2 = 0;
                while (i2 < aint.length) {
                    if (TileEntityHopper.pullItemFromSlot(p_145891_0_, iinventory, aint[i2], enumfacing)) {
                        return true;
                    }
                    ++i2;
                }
                ...
                int k2 = 0;
                while (k2 < j2) {
                    if (TileEntityHopper.pullItemFromSlot(p_145891_0_, iinventory, k2, enumfacing)) {
                        return true;
                    }
                    ++k2;
                }
    ...
    public static ItemStack putStackInInventoryAllSlots(IInventory inventoryIn, ItemStack stack, EnumFacing side) {
        if (inventoryIn instanceof ISidedInventory && side != null) {
            ...
            int[] aint = isidedinventory.getSlotsForFace(side);
            int k2 = 0;
            while (k2 < aint.length && stack != null && stack.stackSize > 0) {
            ...
            int i2 = inventoryIn.getSizeInventory();
            int j2 = 0;
            while (j2 < i2 && stack != null && stack.stackSize > 0) {
