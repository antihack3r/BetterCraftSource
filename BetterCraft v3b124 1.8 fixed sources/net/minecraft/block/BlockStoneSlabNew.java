...
extends BlockSlab {
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
        if (itemIn != Item.getItemFromBlock(Blocks.double_stone_slab2)) {
            ...
            int n3 = 0;
            while (n3 < n2) {
                EnumType blockstoneslabnew$enumtype = enumTypeArray[n3];
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        static {
            ...
            while (n3 < n2) {
                ...
                EnumType.META_LOOKUP[blockstoneslabnew$enumtype.getMetadata()] = blockstoneslabnew$enumtype = enumTypeArray[n3];
                ++n3;
            }
        }
