...
extends Block {
    ...
    public static enum EnumRailDirection implements IStringSerializable
    {
        ...
        static {
            ...
            while (n3 < n2) {
                EnumRailDirection blockrailbase$enumraildirection;
                EnumRailDirection.META_LOOKUP[blockrailbase$enumraildirection.getMetadata()] = blockrailbase$enumraildirection = enumRailDirectionArray[n3];
                ++n3;
            }
        }
    ...
    public class Rail {
        ...
        private void func_150651_b() {
            int i2 = 0;
            while (i2 < this.field_150657_g.size()) {
