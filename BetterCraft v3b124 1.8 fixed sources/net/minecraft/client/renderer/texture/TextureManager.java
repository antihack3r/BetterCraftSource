...
IResourceManagerReloadListener {
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        ...
        while (iterator.hasNext()) {
            ...
            if (!s2.startsWith("mcpatcher/") && !s2.startsWith("optifine/") && !EmissiveTextures.isEmissive(resourcelocation)) continue;
        ...
        while (iterator2.hasNext()) {
            Map.Entry<ResourceLocation, ITextureObject> o2;
            Map.Entry<ResourceLocation, ITextureObject> entry = o2 = iterator2.next();
    ...
    public void reloadBannerTextures() {
        ...
        while (iterator.hasNext()) {
            Map.Entry<ResourceLocation, ITextureObject> o2;
            Map.Entry<ResourceLocation, ITextureObject> entry = o2 = iterator.next();
