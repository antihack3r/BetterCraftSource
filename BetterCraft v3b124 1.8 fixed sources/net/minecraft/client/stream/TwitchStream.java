...
IStream {
    ...
    public void func_152911_a(Metadata p_152911_1_, long p_152911_2_) {
        if (this.isBroadcasting() && this.field_152957_i) {
            long i2 = this.broadcastController.getStreamTime();
    ...
    public void func_152930_t() {
        ...
        if (gamesettings.streamPreferredServer != null && gamesettings.streamPreferredServer.length() > 0) {
            ...
            int n2 = ingestServerArray.length;
            int n3 = 0;
            while (n3 < n2) {
                IngestServer ingestserver = ingestServerArray[n3];
    ...
    public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
        ...
        int n2 = p_180605_2_.length;
        int n3 = 0;
        while (n3 < n2) {
            ChatRawMessage chatrawmessage = chatRawMessageArray[n3];
    ...
    public void func_176018_a(String p_176018_1_, ChatUserInfo[] p_176018_2_, ChatUserInfo[] p_176018_3_, ChatUserInfo[] p_176018_4_) {
        ...
        int n3 = 0;
        while (n3 < n2) {
            ChatUserInfo chatuserinfo = chatUserInfoArray[n3];
        ...
        n3 = 0;
        while (n3 < n2) {
            ChatUserInfo chatuserinfo1 = chatUserInfoArray[n3];
        ...
        n3 = 0;
        while (n3 < n2) {
            ChatUserInfo chatuserinfo2 = chatUserInfoArray[n3];
    ...
    public boolean func_152929_G() {
        boolean flag;
        boolean bl2 = flag = this.mc.gameSettings.streamMicToggleBehavior == 1;
