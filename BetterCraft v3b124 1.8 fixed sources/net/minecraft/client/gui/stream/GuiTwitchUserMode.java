...
extends GuiScreen {
    ...
    public static List<IChatComponent> func_152328_a(Set<ChatUserMode> p_152328_0_, Set<ChatUserSubscription> p_152328_1_, IStream p_152328_2_) {
        String s2 = p_152328_2_ == null ? null : p_152328_2_.func_152921_C();
        ...
        for (ChatUserMode chatusermode : p_152328_0_) {
            IChatComponent ichatcomponent = GuiTwitchUserMode.func_152329_a(chatusermode, s2, flag);
        ...
        for (ChatUserSubscription chatusersubscription : p_152328_1_) {
            IChatComponent ichatcomponent2 = GuiTwitchUserMode.func_152330_a(chatusersubscription, s2, flag);
    ...
    public void initGui() {
        int i2 = width / 3;
        int j2 = i2 - 130;
        this.buttonList.add(new GuiButton(1, i2 * 0 + j2 / 2, height - 70, 130, 20, I18n.format("stream.userinfo.timeout", new Object[0])));
        this.buttonList.add(new GuiButton(0, i2 * 1 + j2 / 2, height - 70, 130, 20, I18n.format("stream.userinfo.ban", new Object[0])));
        this.buttonList.add(new GuiButton(2, i2 * 2 + j2 / 2, height - 70, 130, 20, I18n.format("stream.userinfo.mod", new Object[0])));
        this.buttonList.add(new GuiButton(5, i2 * 0 + j2 / 2, height - 45, 130, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(new GuiButton(3, i2 * 1 + j2 / 2, height - 45, 130, 20, I18n.format("stream.userinfo.unban", new Object[0])));
        this.buttonList.add(new GuiButton(4, i2 * 2 + j2 / 2, height - 45, 130, 20, I18n.format("stream.userinfo.unmod", new Object[0])));
        int k2 = 0;
        for (IChatComponent ichatcomponent : this.field_152332_r) {
            k2 = Math.max(k2, this.fontRendererObj.getStringWidth(ichatcomponent.getFormattedText()));
        }
        this.field_152334_t = width / 2 - k2 / 2;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i2 = 80;
        for (IChatComponent ichatcomponent : this.field_152332_r) {
            this.drawString(this.fontRendererObj, ichatcomponent.getFormattedText(), this.field_152334_t, i2, 0xFFFFFF);
