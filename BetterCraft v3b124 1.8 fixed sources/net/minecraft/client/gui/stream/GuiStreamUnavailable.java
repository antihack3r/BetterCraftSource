...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i2 = Math.max((int)((double)height * 0.85 / 2.0 - (double)((float)(this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT) / 2.0f)), 50);
        GuiStreamUnavailable.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), width / 2, i2 - this.fontRendererObj.FONT_HEIGHT * 2, 0xFFFFFF);
        for (String s2 : this.field_152323_r) {
            GuiStreamUnavailable.drawCenteredString(this.fontRendererObj, s2, width / 2, i2, 0xA0A0A0);
