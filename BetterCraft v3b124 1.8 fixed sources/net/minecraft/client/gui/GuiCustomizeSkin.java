...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonOF(210, width / 2 - 100, height / 6 + 24 * (i2 >> 1), I18n.format("of.options.skinCustomisation.ofCape", new Object[0])));
        this.buttonList.add(new GuiButton(200, width / 2 - 100, height / 6 + 24 * ((i2 += 2) >> 1), I18n.format("gui.done", new Object[0])));
    }
