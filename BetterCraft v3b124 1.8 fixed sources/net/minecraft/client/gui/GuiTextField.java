    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                GuiTextField.drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, ColorUtils.rainbowEffect());
                GuiTextField.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, Integer.MIN_VALUE);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    this.fontRendererInstance.drawStringWithShadow("\u00a74<", k1, i1, i2);
                }
            }
            if (k2 != j2) {
