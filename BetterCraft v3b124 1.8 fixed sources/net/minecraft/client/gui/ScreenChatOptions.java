    ...
    public void initGui() {
        ...
        while (n3 < n2) {
            ...
            if (gamesettings$options.getEnumFloat()) {
                ...
                this.buttonList.add(new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), width / 2 - 155 + i2 % 2 * 160, height / 6 + 24 * (i2 >> 1), gamesettings$options, this.game_settings.getKeyBinding(gamesettings$options)));
            }
            ++i2;
            ++n3;
        }
