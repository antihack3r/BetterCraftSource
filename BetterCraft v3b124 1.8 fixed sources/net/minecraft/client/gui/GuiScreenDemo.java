...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i2 = -16;
        this.buttonList.add(new GuiButton(1, width / 2 - 116, height / 2 + 62 + i2, 114, 20, I18n.format("demo.help.buy", new Object[0])));
        this.buttonList.add(new GuiButton(2, width / 2 + 2, height / 2 + 62 + i2, 114, 20, I18n.format("demo.help.later", new Object[0])));
    }
