...
extends GuiListExtended {
    ...
    private void func_178069_s() {
        ...
        int n2 = this.field_178078_x.length;
        int n3 = 0;
        while (n3 < n2) {
            GuiListEntry[] aguipagebuttonlist$guilistentry = guiListEntryArray[n3];
            int i2 = 0;
            while (i2 < aguipagebuttonlist$guilistentry.length) {
    ...
    private void func_178055_t() {
        ...
        int i2 = 0;
        while (i2 < this.field_178078_x[this.field_178077_y].length) {
    ...
    private void func_178060_e(int p_178060_1_, int p_178060_2_) {
        ...
        int n2 = guiListEntryArray.length;
        int n3 = 0;
        while (n3 < n2) {
            GuiListEntry guipagebuttonlist$guilistentry = guiListEntryArray[n3];
        ...
        n2 = guiListEntryArray.length;
        n3 = 0;
        while (n3 < n2) {
            GuiListEntry guipagebuttonlist$guilistentry1 = guiListEntryArray[n3];
