...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        ArgumentAcceptingOptionSpec<String> argumentAcceptingOptionSpec = optionparser.accepts("username").withRequiredArg();
        BetterCraft.getInstance();
        ArgumentAcceptingOptionSpec<String> optionspec9 = argumentAcceptingOptionSpec.defaultsTo(String.valueOf(BetterCraft.clientName) + Minecraft.getSystemTime() % 1000L, (String[])new String[0]);
