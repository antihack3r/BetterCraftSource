...
public class PathEntity {
    ...
    public boolean isSamePath(PathEntity pathentityIn) {
        ...
        while (i2 < this.points.length) {
            if (this.points[i2].xCoord != pathentityIn.points[i2].xCoord || this.points[i2].yCoord != pathentityIn.points[i2].yCoord || this.points[i2].zCoord != pathentityIn.points[i2].zCoord) {
                return false;
            }
            ++i2;
        }
