...
extends WorldGenAbstractTree {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (position.getY() >= 1 && position.getY() + i2 + 1 <= 256) {
            ...
            if ((block1 == Blocks.grass || block1 == Blocks.dirt || block1 == Blocks.farmland) && position.getY() < 256 - i2 - 1) {
                ...
                int k2 = 3;
                int l2 = 0;
                int i3 = position.getY() - k2 + i2;
                while (i3 <= position.getY() + i2) {
                    int i4 = i3 - (position.getY() + i2);
                    int j1 = l2 + 1 - i4 / 2;
                    int k1 = position.getX() - j1;
                    while (k1 <= position.getX() + j1) {
                        int l1 = k1 - position.getX();
                        int i22 = position.getZ() - j1;
                        while (i22 <= position.getZ() + j1) {
                            BlockPos blockpos;
                            Block block;
                            int j22 = i22 - position.getZ();
                            if ((Math.abs(l1) != j1 || Math.abs(j22) != j1 || rand.nextInt(2) != 0 && i4 != 0) && ((block = worldIn.getBlockState(blockpos = new BlockPos(k1, i3, i22)).getBlock()).getMaterial() == Material.air || block.getMaterial() == Material.leaves || block.getMaterial() == Material.vine)) {
                ...
                if (this.vinesGrow) {
                    int k3 = position.getY() - 3 + i2;
                    while (k3 <= position.getY() + i2) {
    ...
    private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
        ...
        while (p_181650_1_.getBlockState(p_181650_2_).getBlock().getMaterial() == Material.air && i2 > 0) {
            this.func_181651_a(p_181650_1_, p_181650_2_, p_181650_3_);
            p_181650_2_ = p_181650_2_.down();
            --i2;
        }
