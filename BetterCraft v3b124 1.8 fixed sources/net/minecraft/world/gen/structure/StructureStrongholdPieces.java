...
public class StructureStrongholdPieces {
    ...
    public static void prepareStructurePieces() {
        ...
        int n2 = StructureStrongholdPieces.pieceWeightArray.length;
        int n3 = 0;
        while (n3 < n2) {
            PieceWeight structurestrongholdpieces$pieceweight = pieceWeightArray[n3];
