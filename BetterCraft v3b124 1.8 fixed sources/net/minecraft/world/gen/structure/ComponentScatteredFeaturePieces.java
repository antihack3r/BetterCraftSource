    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            while (j2 < this.scatteredFeatureSizeX) {
                int j3 = 0;
                while (j3 < this.scatteredFeatureSizeZ) {
                    int k2 = -5;
            ...
            for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                ...
                int i22 = enumfacing.getFrontOffsetZ() * 2;
                this.hasPlacedChest[enumfacing.getHorizontalIndex()] = this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 10 + l1, -11, 10 + i22, WeightedRandomChestContent.func_177629_a(itemsToGenerateInTemple, Items.enchanted_book.getRandom(randomIn)), 2 + randomIn.nextInt(5));
            }
            return true;
        }
    }
