...
public class StructureNetherBridgePieces {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int i22 = this.getMetadataWithOffset(Blocks.nether_brick_stairs, 0);
            int j22 = this.getMetadataWithOffset(Blocks.nether_brick_stairs, 1);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j22), 4, 5, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j22), 4, 5, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j22), 4, 5, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(j22), 4, 5, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i22), 8, 5, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i22), 8, 5, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i22), 8, 5, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i22), 8, 5, 10, structureBoundingBoxIn);
    ...
    extends Crossing3 {
        ...
        public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_) {
            ...
            int n2 = pieceWeightArray.length;
            int n3 = 0;
            while (n3 < n2) {
                PieceWeight structurenetherbridgepieces$pieceweight = pieceWeightArray[n3];
            ...
            n2 = pieceWeightArray.length;
            n3 = 0;
            while (n3 < n2) {
                PieceWeight structurenetherbridgepieces$pieceweight1 = pieceWeightArray[n3];
