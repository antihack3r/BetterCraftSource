...
public abstract class BiomeGenBase {
    ...
    static {
        ...
        int n2 = biomeList.length;
        int n3 = 0;
        while (n3 < n2) {
            BiomeGenBase biomegenbase = biomeGenBaseArray[n3];
                ...
                if (iblockstate2.getBlock().getMaterial() == Material.air) {
                    ...
                    if (j2 == -1) {
                        ...
                        if (j1 < i2 && (iblockstate == null || iblockstate.getBlock().getMaterial() == Material.air)) {
                            iblockstate = this.getFloatTemperature(blockpos$mutableblockpos.set(x2, j1, z2)) < 0.15f ? Blocks.ice.getDefaultState() : Blocks.water.getDefaultState();
                        }
                        j2 = k2;
                        if (j1 >= i2 - 1) {
                        ...
                        chunkPrimerIn.setBlockState(i1, j1, l2, iblockstate1);
                        if (--j2 == 0 && iblockstate1.getBlock() == Blocks.sand) {
