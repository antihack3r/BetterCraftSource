...
IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        ...
        while (j2 < 2) {
            ...
            if (entity1 != null) {
                ...
                float f2 = (float)(MathHelper.atan2(d8, d6) * 180.0 / Math.PI) - 90.0f;
    ...
    protected void updateAITasks() {
        if (this.getInvulTime() > 0) {
            ...
            int i2 = 1;
            while (i2 < 3) {
                if (this.ticksExisted >= this.field_82223_h[i2 - 1]) {
                    int k1;
            ...
            if (this.blockBreakCounter > 0) {
                ...
                if (this.blockBreakCounter == 0 && this.worldObj.getGameRules().getBoolean("mobGriefing")) {
                    ...
                    int i22 = MathHelper.floor_double(this.posZ);
                    boolean flag = false;
                    int k2 = -1;
                    while (k2 <= 1) {
                        int l2 = -1;
                        while (l2 <= 1) {
                            ...
                            while (j2 <= 3) {
                                ...
                                if (block.getMaterial() != Material.air && EntityWither.canDestroyBlock(block)) {
