...
extends EntityLivingBase {
    ...
    public EntityLiving(World worldIn) {
        ...
        int i2 = 0;
        while (i2 < this.equipmentDropChances.length) {
    ...
    protected int getExperiencePoints(EntityPlayer player) {
        if (this.experienceValue > 0) {
            ...
            int j2 = 0;
            while (j2 < aitemstack.length) {
                if (aitemstack[j2] != null && this.equipmentDropChances[j2] <= 1.0f) {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        int j2 = 0;
        while (j2 < this.equipmentDropChances.length) {
    ...
    public void faceEntity(Entity entityIn, float p_70625_2_, float p_70625_3_) {
        ...
        float f2 = (float)(MathHelper.atan2(d1, d0) * 180.0 / Math.PI) - 90.0f;
    ...
    protected void dropEquipment(boolean wasRecentlyHit, int lootingModifier) {
        int i2 = 0;
        while (i2 < this.getInventory().length) {
            boolean flag;
            ItemStack itemstack = this.getEquipmentInSlot(i2);
            boolean bl2 = flag = this.equipmentDropChances[i2] > 1.0f;
            if (itemstack != null && (wasRecentlyHit || flag) && this.rand.nextFloat() - (float)lootingModifier * 0.01f < this.equipmentDropChances[i2]) {
    ...
    protected void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty) {
        if (this.rand.nextFloat() < 0.15f * difficulty.getClampedAdditionalDifficulty()) {
            ...
            while (j2 >= 0) {
                ...
                if (itemstack == null && (item = EntityLiving.getArmorItemForSlot(j2 + 1, i2)) != null) {
    ...
    protected void setEnchantmentBasedOnDifficulty(DifficultyInstance difficulty) {
        ...
        while (i2 < 4) {
            ...
            if (itemstack != null && this.rand.nextFloat() < 0.5f * f2) {
