...
public class VirtualHologramEntity {
    ...
    public void updateMetadata(List<Metadata> metadataList) {
        for (Metadata metadata : metadataList) {
            this.metadataTracker.removeIf(m2 -> m2.id() == metadata.id());
    ...
    protected void teleportEntity(int entityId, double x2, double y2, double z2, float yaw, float pitch) {
        ...
        entityTeleport.write(Type.INT, (int)(x2 * 32.0));
        entityTeleport.write(Type.INT, (int)(y2 * 32.0));
        entityTeleport.write(Type.INT, (int)(z2 * 32.0));
    ...
    public void deleteEntity() {
        ...
        for (int id2 : this.entityIds) {
            despawn.write(Type.INT, id2);
        }
        this.entityIds = null;
