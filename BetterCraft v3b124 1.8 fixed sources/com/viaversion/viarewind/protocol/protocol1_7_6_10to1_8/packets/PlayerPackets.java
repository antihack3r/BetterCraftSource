    ...
    public static void register(final Protocol1_7_6_10To1_8 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_8.PLAYER_POSITION, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Type.FLOAT);
                this.handler(wrapper -> {
                    double x2 = wrapper.get(Type.DOUBLE, 0);
                    double y2 = wrapper.get(Type.DOUBLE, 1);
                    double z2 = wrapper.get(Type.DOUBLE, 2);
                    ...
                    if ((flags & 1) == 1) {
                        wrapper.set(Type.DOUBLE, 0, x2 + playerSession.getPosX());
                    }
                    if ((flags & 2) == 2) {
                        y2 += playerSession.getPosY();
                    }
                    playerSession.receivedPosY = y2;
                    wrapper.set(Type.DOUBLE, 1, y2 + (double)1.62f);
                    if ((flags & 4) == 4) {
                        wrapper.set(Type.DOUBLE, 2, z2 + playerSession.getPosZ());
                    }
                    if ((flags & 8) == 8) {
                    ...
                    if (gameMode == 3 || playerSession.gameMode == 3) {
                        ...
                        if (gameMode == 3) {
                            ...
                            for (int i2 = 0; i2 < equipment.length; ++i2) {
                                equipment[i2] = playerSession.getPlayerEquipment(myId, i2);
                            }
                        }
                        for (int i3 = 0; i3 < equipment.length; ++i3) {
                            ...
                            setSlot.write(Type.SHORT, (short)(8 - i3));
                            setSlot.write(Types1_7_6_10.COMPRESSED_NBT_ITEM, equipment[i3]);
                    ...
                    for (int i2 = 0; i2 < count; ++i2) {
                        ...
                        if (action == 1) {
                            ...
                            if (gamemode == 3 || gameProfile2.gamemode == 3) {
                                ...
                                boolean bl2 = isOwnPlayer = entityId == tracker.getPlayerId();
                                if (entityId != -1) {
                                    ...
                                    if (gamemode == 3) {
                                        ...
                                        for (int j2 = 0; j2 < equipment.length; ++j2) {
                                            equipment[j2] = packetWrapper.user().get(PlayerSessionStorage.class).getPlayerEquipment(uuid, j2);
                                        }
                                    }
        ...
        protocol.registerServerbound(ServerboundPackets1_7_2_5.PLAYER_POSITION, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    PlayerSessionStorage playerSession = packetWrapper.user().get(PlayerSessionStorage.class);
                    playerSession.onGround = packetWrapper.get(Type.BOOLEAN, 0);
                    playerSession.setPos(x2, feetY, z2);
                });
            }
        });
        ...
        protocol.registerServerbound(ServerboundPackets1_7_2_5.PLAYER_DIGGING, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    packetWrapper.write(Type.POSITION1_8, new Position(x2, (int)y2, z2));
                });
            }
        });
