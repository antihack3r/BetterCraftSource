                ...
                this.handler(wrapper -> {
                    ...
                    if (gameProfile != null && gameProfile.gamemode == 3) {
                        for (short i2 = 0; i2 < 5; i2 = (short)(i2 + 1)) {
                            ...
                            entityEquipment.write(Type.SHORT, i2);
                            entityEquipment.write(Types1_7_6_10.COMPRESSED_NBT_ITEM, i2 == 4 ? gameProfile.getSkull() : null);
        ...
        protocol.registerClientbound(ClientboundPackets1_8.SPAWN_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    int entityId = wrapper.get(Type.VAR_INT, 0);
                    int x2 = wrapper.get(Type.INT, 0);
                    int y2 = wrapper.get(Type.INT, 1);
                    int z2 = wrapper.get(Type.INT, 2);
                    ...
                    if (type == EntityTypes1_10.ObjectType.ITEM_FRAME.getType()) {
                        ...
                        hologram.updateReplacementPosition((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
                    ...
                    wrapper.set(Type.INT, 0, x2);
                    wrapper.set(Type.INT, 1, y2);
                    wrapper.set(Type.INT, 2, z2);
