            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (type.is((EntityType)EntityTypes1_10.EntityType.BOAT)) {
                        ...
                        shulkerBulletReplacement.updateReplacementPosition((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (typeId == 69) {
                        ...
                        shulkerReplacement.updateReplacementPosition((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
