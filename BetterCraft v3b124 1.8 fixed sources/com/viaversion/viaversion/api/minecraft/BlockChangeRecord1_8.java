...
implements BlockChangeRecord {
    ...
    public BlockChangeRecord1_8(byte sectionX, short y2, byte sectionZ, int blockId) {
    ...
    public BlockChangeRecord1_8(int sectionX, int y2, int sectionZ, int blockId) {
        this((byte)sectionX, (short)y2, (byte)sectionZ, blockId);
    }
