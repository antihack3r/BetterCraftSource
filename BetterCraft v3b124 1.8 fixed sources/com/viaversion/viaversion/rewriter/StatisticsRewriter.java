...
public class StatisticsRewriter<C extends ClientboundPacketType> {
    ...
    protected @Nullable IdRewriteFunction getRewriter(RegistryType type) {
        switch (type) {
            case BLOCK: {
                return this.protocol.getMappingData().getBlockMappings() != null ? id2 -> this.protocol.getMappingData().getNewBlockId(id2) : null;
            }
            case ITEM: {
                return this.protocol.getMappingData().getItemMappings() != null ? id2 -> this.protocol.getMappingData().getNewItemId(id2) : null;
            }
            case ENTITY: {
                return this.protocol.getEntityRewriter() != null ? id2 -> this.protocol.getEntityRewriter().newEntityId(id2) : null;
            }
        }
