...
implements TranslatableComponent {
    ...
    implements TranslatableComponent.Builder {
        ...
        @Override
        @NotNull
        public TranslatableComponent.Builder args(@NotNull ComponentBuilder<?, ?> arg2) {
            return this.args(Collections.singletonList(Objects.requireNonNull(arg2, "arg").build()));
        }
        ...
        @Override
        @NotNull
        public TranslatableComponent.Builder args(@NotNull Component arg2) {
            return this.args(Collections.singletonList(Objects.requireNonNull(arg2, "arg")));
        }
