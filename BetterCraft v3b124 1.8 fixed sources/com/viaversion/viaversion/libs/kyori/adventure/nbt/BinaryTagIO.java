...
public final class BinaryTagIO {
    ...
    public static abstract class Compression {
        public static final Compression NONE = new Compression(){
            ...
            @Override
            @NotNull
            InputStream decompress(@NotNull InputStream is2) {
                return is2;
            }

            @Override
            @NotNull
            OutputStream compress(@NotNull OutputStream os2) {
                return os2;
            }
        ...
        public static final Compression GZIP = new Compression(){
            ...
            @Override
            @NotNull
            InputStream decompress(@NotNull InputStream is2) throws IOException {
                return new GZIPInputStream(is2);
            }

            @Override
            @NotNull
            OutputStream compress(@NotNull OutputStream os2) throws IOException {
        ...
        public static final Compression ZLIB = new Compression(){
            ...
            @NotNull
            InputStream decompress(@NotNull InputStream is2) {
                return new InflaterInputStream(is2);
            }

            @Override
            @NotNull
            OutputStream compress(@NotNull OutputStream os2) {
                return new DeflaterOutputStream(os2);
            }
