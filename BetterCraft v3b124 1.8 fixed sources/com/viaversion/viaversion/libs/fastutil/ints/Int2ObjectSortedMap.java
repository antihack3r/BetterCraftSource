...
SortedMap<Integer, V> {
    ...
    @Deprecated
    default public Int2ObjectSortedMap<V> subMap(Integer from, Integer to2) {
        return this.subMap((int)from, (int)to2);
    }

    @Deprecated
    default public Int2ObjectSortedMap<V> headMap(Integer to2) {
        return this.headMap((int)to2);
    }
