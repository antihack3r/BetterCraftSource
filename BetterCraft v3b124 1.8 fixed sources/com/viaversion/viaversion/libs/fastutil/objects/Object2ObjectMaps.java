...
public final class Object2ObjectMaps {
    ...
    public static <K, V> Object2ObjectMap<K, V> synchronize(Object2ObjectMap<K, V> m2) {
        return new SynchronizedMap(m2);
    }

    public static <K, V> Object2ObjectMap<K, V> synchronize(Object2ObjectMap<K, V> m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static <K, V> Object2ObjectMap<K, V> unmodifiable(Object2ObjectMap<? extends K, ? extends V> m2) {
