...
public class ItemRewriter {
        ...
        if (item != null) {
            ...
            if (item.identifier() == 383 && item.data() == 0) {
                ...
                if (tag != null && tag.get("EntityTag") instanceof CompoundTag) {
                    ...
                    if (entityTag.get("id") instanceof StringTag && ENTITY_NAME_TO_ID.containsKey((id2 = (StringTag)entityTag.get("id")).getValue())) {
                        data = ENTITY_NAME_TO_ID.get(id2.getValue());
                    }
    ...
    public static void toClient(Item item) {
        if (item != null) {
            ...
            if (item.identifier() == 383 && item.data() != 0) {
                ...
                if (entityName != null) {
                    StringTag id2 = new StringTag(entityName);
                    entityTag.put("id", id2);
    ...
    private static void registerEntity(int id2, String name) {
        ENTITY_ID_TO_NAME.put(id2, name);
        ENTITY_NAME_TO_ID.put(name, id2);
    }

    private static void registerPotion(int id2, String name) {
        POTION_INDEX.put(id2, POTION_ID_TO_NAME.size());
        POTION_ID_TO_NAME.put(id2, name);
        POTION_NAME_TO_ID.put(name, id2);
    }
