...
extends AbstractProtocol<ClientboundPackets1_19_4, ClientboundPackets1_20_2, ServerboundPackets1_19_4, ServerboundPackets1_20_2> {
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_19_4.TAGS, (PacketWrapper wrapper) -> wrapper.user().put(new LastTags(wrapper)));
        this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.UPDATE_TAGS.getId(), ClientboundConfigurationPackets1_20_2.UPDATE_TAGS.getId(), (PacketWrapper wrapper) -> wrapper.user().put(new LastTags(wrapper)));
