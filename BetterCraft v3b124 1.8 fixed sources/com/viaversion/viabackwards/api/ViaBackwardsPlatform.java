...
public interface ViaBackwardsPlatform {
    public static final String MINIMUM_VV_VERSION = "4.9.0";
    ...
    default public boolean isOutdated() {
        ...
        if (vvVersion != null && new Version(vvVersion).compareTo(new Version("4.9.0--")) < 0) {
            this.getLogger().severe("================================");
            this.getLogger().severe("YOUR VIAVERSION IS OUTDATED");
            this.getLogger().severe("PLEASE USE VIAVERSION 4.9.0 OR NEWER");
