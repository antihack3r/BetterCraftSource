...
extends EntityRewriter<ClientboundPackets1_19_3, Protocol1_19_1To1_19_3> {
        ...
        ((Protocol1_19_1To1_19_3)this.protocol).registerClientbound(ClientboundPackets1_19_3.PLAYER_INFO_UPDATE, ClientboundPackets1_19_1.PLAYER_INFO, wrapper -> {
            ...
            if (actions.get(0)) {
                ...
                for (int i2 = 0; i2 < entries; ++i2) {
                    ...
                    int n2 = gamemode = actions.get(2) ? wrapper.read(Type.VAR_INT) : 0;
                    if (actions.get(3)) {
    ...
    public void registerRewrites() {
        this.filter().handler((event, meta) -> {
            int id2 = meta.metaType().typeId();
            if (id2 > 2) {
                meta.setMetaType(Types1_19.META_TYPES.byId(id2 - 1));
            } else if (id2 != 2) {
                meta.setMetaType(Types1_19.META_TYPES.byId(id2));
            }
        });
