...
public class Authenticator {
    ...
    private Object sendRequest(Object request, Class<?> model, String authPoint, Proxy proxy) throws AuthenticationException {
        ...
        try {
            ...
            throw new AuthenticationException(new AuthError("Can't send the request : " + e2.getClass().getName(), e2.getMessage(), "Unknown"));
        }
        if (model != null) {
    ...
    private String sendPostRequest(String url, String json, Proxy proxy) throws AuthenticationException, IOException {
        ...
        wr2.write(jsonBytes, 0, jsonBytes.length);
        wr2.flush();
        wr2.close();
        connection.connect();
        ...
        InputStream is2 = responseCode == 200 ? connection.getInputStream() : connection.getErrorStream();
