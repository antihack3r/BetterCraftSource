...
public final class ResourceLeakDetector<T> {
    ...
    private void reportLeak(Level level) {
        ...
        int n2 = samplingInterval = level == Level.PARANOID ? 1 : this.samplingInterval;
    ...
    static {
        ...
        for (Level l2 : EnumSet.allOf(Level.class)) {
            if (!levelStr.equals(l2.name()) && !levelStr.equals(String.valueOf(l2.ordinal()))) continue;
            level = l2;
        }
        ResourceLeakDetector.level = level;
