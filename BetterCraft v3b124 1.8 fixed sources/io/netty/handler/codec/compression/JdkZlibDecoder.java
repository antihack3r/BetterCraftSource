...
extends ZlibDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in2, List<Object> out) throws Exception {
        ...
        if (this.decideZlibOrNone) {
            ...
            boolean nowrap = !JdkZlibDecoder.looksLikeZlib(in2.getShort(0));
        ...
        if (in2.hasArray()) {
            this.inflater.setInput(in2.array(), in2.arrayOffset() + in2.readerIndex(), in2.readableBytes());
        } else {
            byte[] array = new byte[in2.readableBytes()];
