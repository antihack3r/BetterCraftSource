...
extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        try {
            ...
            switch (_1.$SwitchMap$io$netty$handler$codec$compression$SnappyFramedDecoder$ChunkType[chunkType.ordinal()]) {
                case 1: {
...
lbl76:
    ...
    static class _1 {
        ...
        static {
            ...
            try {
                _1.$SwitchMap$io$netty$handler$codec$compression$SnappyFramedDecoder$ChunkType[ChunkType.STREAM_IDENTIFIER.ordinal()] = 1;
            }
            catch (NoSuchFieldError ex2) {
                // empty catch block
            }
            try {
                _1.$SwitchMap$io$netty$handler$codec$compression$SnappyFramedDecoder$ChunkType[ChunkType.RESERVED_SKIPPABLE.ordinal()] = 2;
            }
            catch (NoSuchFieldError ex3) {
                // empty catch block
            }
            try {
                _1.$SwitchMap$io$netty$handler$codec$compression$SnappyFramedDecoder$ChunkType[ChunkType.RESERVED_UNSKIPPABLE.ordinal()] = 3;
            }
            catch (NoSuchFieldError ex4) {
                // empty catch block
            }
            try {
                _1.$SwitchMap$io$netty$handler$codec$compression$SnappyFramedDecoder$ChunkType[ChunkType.UNCOMPRESSED_DATA.ordinal()] = 4;
            }
            catch (NoSuchFieldError ex5) {
                // empty catch block
            }
            try {
                _1.$SwitchMap$io$netty$handler$codec$compression$SnappyFramedDecoder$ChunkType[ChunkType.COMPRESSED_DATA.ordinal()] = 5;
            }
