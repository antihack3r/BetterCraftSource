...
extends Transformer {
        ...
        while (iterator.hasNext()) {
            try {
                ...
                if (c2 == 50 || c2 == 51 || c2 == 52 || c2 == 49 || c2 == 48 || c2 == 46 || c2 == 47 || c2 == 53) {
                    pos = this.replace(cp2, iterator, pos, c2, this.getLoadReplacementSignature(c2));
                    continue;
                }
                if (c2 != 83 && c2 != 84 && c2 != 85 && c2 != 82 && c2 != 81 && c2 != 79 && c2 != 80 && c2 != 86) continue;
                pos = this.replace(cp2, iterator, pos, c2, this.getStoreReplacementSignature(c2));
            }
            catch (Exception e2) {
    ...
    private int replace(ConstPool cp2, CodeIterator iterator, int pos, int opcode, String signature) throws BadBytecode {
