...
extends ConstInfo {
    ...
    public MemberrefInfo(DataInputStream in2, int thisIndex) throws IOException {
        super(thisIndex);
        this.classIndex = in2.readUnsignedShort();
        this.nameAndTypeIndex = in2.readUnsignedShort();
    }
