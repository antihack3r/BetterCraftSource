...
public class ProtocolVersion {
    ...
    public static boolean isRegistered(int id2) {
        return versions.containsKey(id2);
    }

    public static @NonNull ProtocolVersion getProtocol(int id2) {
        ProtocolVersion protocolVersion = (ProtocolVersion)versions.get(id2);
        if (protocolVersion != null) {
            return protocolVersion;
        }
        return new ProtocolVersion(id2, "Unknown (" + id2 + ")");
    }
