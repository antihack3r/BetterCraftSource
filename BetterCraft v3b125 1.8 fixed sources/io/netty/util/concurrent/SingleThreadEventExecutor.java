...
extends AbstractEventExecutor {
    ...
    protected boolean runAllTasks() {
        ...
        do {
            try {
                ...
                logger.warn("A task raised an exception.", t2);
            }
    ...
    implements Runnable {
        ...
        @Override
        public void run() {
            Iterator i2 = SingleThreadEventExecutor.this.delayedTaskQueue.iterator();
            while (i2.hasNext()) {
                ScheduledFutureTask task = (ScheduledFutureTask)i2.next();
