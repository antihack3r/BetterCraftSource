        ...
        try {
            switch ((State)((Object)this.state())) {
                case FRAME_START: {
                    ...
                    boolean frameMasked = ((b2 = in2.readByte()) & 0x80) != 0;
                ...
                case PAYLOAD: {
                    ...
                    if (willHaveReadByteCount == this.framePayloadLength) {
                        ...
                        this.payloadBuffer.writeBytes(in2, rbytes);
                    } else {
                        if (willHaveReadByteCount < this.framePayloadLength) {
                            ...
                            this.framePayload.writeBytes(in2, rbytes);
                        ...
                        if (willHaveReadByteCount > this.framePayloadLength) {
                            ...
                            this.framePayload.writeBytes(in2, WebSocket08FrameDecoder.toFrameLength(this.framePayloadLength - (long)this.framePayloadBytesRead));
                        }
                    }
