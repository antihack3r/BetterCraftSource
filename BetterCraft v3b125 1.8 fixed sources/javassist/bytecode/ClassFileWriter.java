...
public class ClassFileWriter {
    ...
    static void writeAttribute(ByteStream bs2, AttributeWriter aw2, int attrCount) {
        if (aw2 == null) {
            bs2.writeShort(attrCount);
            return;
        }
        bs2.writeShort(aw2.size() + attrCount);
        DataOutputStream dos = new DataOutputStream(bs2);
        try {
            aw2.write(dos);
            dos.flush();
        }
    ...
    public static final class MethodWriter {
        ...
        MethodWriter(ConstPoolWriter cp2) {
            this.constPool = cp2;
            this.methodCount = 0;
            this.codeIndex = 0;
            this.throwsIndex = 0;
        ...
        public void addInvoke(int opcode, String targetClass, String methodName, String descriptor) {
            ...
            int nt2 = this.constPool.addNameAndTypeInfo(methodName, descriptor);
            int method = this.constPool.addMethodrefInfo(target, nt2);
            this.add(opcode);
            this.add16(method);
        }
    ...
    public static final class FieldWriter {
        ...
        FieldWriter(ConstPoolWriter cp2) {
            this.constPool = cp2;
            this.fieldCount = 0;
        }
