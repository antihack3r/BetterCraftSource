    ...
    protected void registerRewrites() {
        this.filter().handler((event, meta) -> {
            ...
            if (type == Types1_20_3.META_TYPES.componentType) {
                meta.setTypeAndValue(Types1_20_2.META_TYPES.componentType, Protocol1_20_3To1_20_2.tagComponentToJson((Tag)meta.value()));
                return;
            }
            if (type == Types1_20_3.META_TYPES.optionalComponentType) {
                meta.setTypeAndValue(Types1_20_2.META_TYPES.optionalComponentType, Protocol1_20_3To1_20_2.tagComponentToJson((Tag)meta.value()));
                return;
            }
