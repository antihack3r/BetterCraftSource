        ...
        ((Protocol1_20To1_20_2)this.protocol).registerClientbound(ClientboundPackets1_20_2.MAP_DATA, wrapper -> {
            ...
            if (wrapper.passthrough(Type.BOOLEAN).booleanValue()) {
                ...
                for (int i2 = 0; i2 < icons; ++i2) {
                    byte markerType = wrapper.read(Type.BYTE);
                    wrapper.write(Type.BYTE, markerType < 27 ? markerType : (byte)2);
                    wrapper.passthrough(Type.BYTE);
                    wrapper.passthrough(Type.BYTE);
                    wrapper.passthrough(Type.BYTE);
        ...
        ((Protocol1_20To1_20_2)this.protocol).registerClientbound(ClientboundPackets1_20_2.CHUNK_DATA, wrapper -> {
            ...
            for (ChunkSection section : chunk.getSections()) {
                ...
                for (int i2 = 0; i2 < blockPalette.size(); ++i2) {
                    ...
                    blockPalette.setIdByIndex(i2, ((Protocol1_20To1_20_2)this.protocol).getMappingData().getNewBlockStateId(id2));
                }
            }
