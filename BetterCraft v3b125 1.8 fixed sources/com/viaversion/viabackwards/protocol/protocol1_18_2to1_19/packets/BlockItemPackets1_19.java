        ...
        ((Protocol1_18_2To1_19)this.protocol).registerClientbound(ClientboundPackets1_19.SPAWN_PARTICLE, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (id2 == (particleMappings = ((Protocol1_18_2To1_19)BlockItemPackets1_19.this.protocol).getMappingData().getParticleMappings()).id("sculk_charge")) {
                        wrapper.set(Type.INT, 0, -1);
                        wrapper.cancel();
                    } else if (id2 == particleMappings.id("shriek")) {
                        wrapper.set(Type.INT, 0, -1);
                        wrapper.cancel();
                    } else if (id2 == particleMappings.id("vibration")) {
                        wrapper.set(Type.INT, 0, -1);
                        wrapper.cancel();
                    }
                });
        ...
        ((Protocol1_18_2To1_19)this.protocol).registerClientbound(ClientboundPackets1_19.CHUNK_DATA, wrapper -> {
            ...
            for (ChunkSection section : chunk.getSections()) {
                ...
                for (int i2 = 0; i2 < blockPalette.size(); ++i2) {
                    ...
                    blockPalette.setIdByIndex(i2, ((Protocol1_18_2To1_19)this.protocol).getMappingData().getNewBlockStateId(id2));
                }
            }
        });
