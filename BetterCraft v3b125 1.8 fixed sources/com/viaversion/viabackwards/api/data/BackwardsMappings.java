...
extends MappingDataBase {
    ...
    protected void loadExtras(CompoundTag data) {
        ...
        if (itemNames != null) {
            ...
            for (Map.Entry<String, Tag> entry : itemNames.entrySet()) {
                ...
                this.backwardsItemMappings.put(id2, new MappedItem(this.getNewItemId(id2), name.getValue(), customModelData));
            }
        }
    ...
    public int getNewItemId(int id2) {
        return this.itemMappings.getNewId(id2);
    }
    ...
    public int getOldItemId(int id2) {
        return this.checkValidity(id2, this.itemMappings.inverse().getNewId(id2), "item");
    }
    ...
    public @Nullable String getMappedNamedSound(String id2) {
        ...
        return this.backwardsSoundMappings.get(Key.stripMinecraftNamespace(id2));
    }
