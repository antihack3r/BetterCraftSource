...
public final class Int2ObjectFunctions {
    ...
    public static <V> Int2ObjectFunction<V> synchronize(Int2ObjectFunction<V> f2) {
        return new SynchronizedFunction(f2);
    }

    public static <V> Int2ObjectFunction<V> synchronize(Int2ObjectFunction<V> f2, Object sync) {
        return new SynchronizedFunction(f2, sync);
    }

    public static <V> Int2ObjectFunction<V> unmodifiable(Int2ObjectFunction<? extends V> f2) {
        return new UnmodifiableFunction(f2);
    }

    public static <V> Int2ObjectFunction<V> primitive(java.util.function.Function<? super Integer, ? extends V> f2) {
        Objects.requireNonNull(f2);
        if (f2 instanceof Int2ObjectFunction) {
            return (Int2ObjectFunction)f2;
        }
        if (f2 instanceof IntFunction) {
            return ((IntFunction)((Object)f2))::apply;
        }
        return new PrimitiveFunction<V>(f2);
    }
