...
public final class Int2ObjectMaps {
    ...
    public static <V> Int2ObjectMap<V> synchronize(Int2ObjectMap<V> m2) {
        return new SynchronizedMap(m2);
    }

    public static <V> Int2ObjectMap<V> synchronize(Int2ObjectMap<V> m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static <V> Int2ObjectMap<V> unmodifiable(Int2ObjectMap<? extends V> m2) {
