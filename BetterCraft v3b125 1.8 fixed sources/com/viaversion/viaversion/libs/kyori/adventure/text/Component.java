...
StyleSetter<Component> {
    ...
    public static Collector<Component, ? extends ComponentBuilder<?, ?>, Component> toComponent(@NotNull Component separator) {
        return Collector.of(Component::text, (builder, add2) -> {
            if (separator != Component.empty() && !builder.children().isEmpty()) {
                builder.append(separator);
            }
            builder.append((Component)add2);
        }, (a2, b2) -> {
    ...
    @Contract(pure=true)
    @NotNull
    default public Component replaceText(@NotNull String search, @Nullable ComponentLike replacement, @NotNull IntFunction2<PatternReplacementResult> fn2) {
        return this.replaceText((TextReplacementConfig.Builder b2) -> b2.matchLiteral(search).replacement(replacement).condition(fn2));
    }
    ...
    @Contract(pure=true)
    @NotNull
    default public Component replaceText(@NotNull Pattern pattern, @NotNull Function<TextComponent.Builder, @Nullable ComponentLike> replacement, @NotNull IntFunction2<PatternReplacementResult> fn2) {
        return this.replaceText((TextReplacementConfig.Builder b2) -> b2.match(pattern).replacement(replacement).condition(fn2));
    }
    ...
    @Override
    @NotNull
    default public HoverEvent<Component> asHoverEvent(@NotNull UnaryOperator<Component> op2) {
        return HoverEvent.showText((Component)op2.apply(this));
    }
