...
implements Examinable {
    ...
    @Override
    public TextDecoration.State get(Object o2) {
        if (o2 instanceof TextDecoration) {
            return STATES[this.bitSet >> ((TextDecoration)o2).ordinal() * 2 & 3];
        }
        return null;
    }
    ...
    extends AbstractSet<TextDecoration> {
        ...
        public boolean contains(Object o2) {
            return o2 instanceof TextDecoration;
        }
    ...
    extends AbstractCollection<TextDecoration.State> {
        ...
        public Object @NotNull [] toArray() {
            ...
            for (int i2 = 0; i2 < MAP_SIZE; ++i2) {
                states[i2] = DecorationMap.this.get(DECORATIONS[i2]);
            }
            return states;
        }
        ...
        @Override
        public boolean contains(Object o2) {
            return o2 instanceof TextDecoration.State && super.contains(o2);
        }
