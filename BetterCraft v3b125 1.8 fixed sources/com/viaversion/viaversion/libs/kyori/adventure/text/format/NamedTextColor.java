...
implements TextColor {
    ...
    @NotNull
    public static NamedTextColor nearestTo(@NotNull TextColor any2) {
        if (any2 instanceof NamedTextColor) {
            return (NamedTextColor)any2;
        }
        return TextColor.nearestColorTo(VALUES, any2);
    }
