...
public class EntityTypes1_13 {
    ...
    public static enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType
    {
        ...
        private ObjectType(int id2, EntityType type) {
            this.id = id2;
            this.type = type;
        }
        ...
        public static Optional<ObjectType> findById(int id2) {
            if (id2 == -1) {
                return Optional.empty();
            }
            return Optional.ofNullable(TYPES.get(id2));
        }

        public static Optional<EntityType> getPCEntity(int id2) {
            Optional<ObjectType> output = ObjectType.findById(id2);
            if (!output.isPresent()) {
                return Optional.empty();
            }
    ...
    public static enum EntityType implements com.viaversion.viaversion.api.minecraft.entities.EntityType
    {
        ...
        private EntityType(int id2) {
            this.id = id2;
            this.parent = null;
        }

        private EntityType(int id2, EntityType parent) {
            this.id = id2;
            this.parent = parent;
        }
        ...
        public static Optional<EntityType> findById(int id2) {
            if (id2 == -1) {
                return Optional.empty();
            }
            return Optional.ofNullable(TYPES.get(id2));
