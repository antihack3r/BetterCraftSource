        ...
        this.protocol.registerClientbound(packetType, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    int mappedId = BlockRewriter.this.protocol.getMappingData().getNewBlockId(id2);
                    if (mappedId == -1) {
                        wrapper.cancel();
                        return;
                    }
        ...
        this.protocol.registerClientbound(packetType, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (id2 == playRecordId && BlockRewriter.this.protocol.getMappingData().getItemMappings() != null) {
                        wrapper.set(Type.INT, 1, BlockRewriter.this.protocol.getMappingData().getNewItemId(data));
                    } else if (id2 == blockBreakId && BlockRewriter.this.protocol.getMappingData().getBlockStateMappings() != null) {
        ...
        return wrapper -> {
            ...
            for (ChunkSection section : chunk.getSections()) {
                ...
                for (int i2 = 0; i2 < blockPalette.size(); ++i2) {
                    int id2 = blockPalette.idByIndex(i2);
                    blockPalette.setIdByIndex(i2, this.protocol.getMappingData().getNewBlockStateId(id2));
                }
            }
            ...
            if (blockEntityMappings != null || blockEntityHandler != null) {
                ...
                for (int i3 = 0; i3 < blockEntities.size(); ++i3) {
                    BlockEntity blockEntity = blockEntities.get(i3);
                    if (blockEntityMappings != null) {
                        blockEntities.set(i3, blockEntity.withTypeId(blockEntityMappings.getNewIdOrDefault(blockEntity.typeId(), blockEntity.typeId())));
                    }
