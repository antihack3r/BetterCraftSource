...
implements com.viaversion.viaversion.api.rewriter.EntityRewriter<T> {
    ...
    @Override
    public int newEntityId(int id2) {
        return this.typeMappings != null ? this.typeMappings.getNewIdOrDefault(id2, id2) : id2;
    }
    ...
    protected void mapEntityType(int id2, int mappedId) {
        if (this.typeMappings == null) {
            this.typeMappings = Int2IntMapMappings.of();
        }
        this.typeMappings.setNewId(id2, mappedId);
    }
    ...
    protected void rewriteParticle(Particle particle) {
        ...
        if (mappings.isBlockParticle(id2 = particle.getId())) {
        ...
        } else if (mappings.isItemParticle(id2) && this.protocol.getItemRewriter() != null) {
        ...
        particle.setId(this.protocol.getMappingData().getNewParticleId(id2));
    }
