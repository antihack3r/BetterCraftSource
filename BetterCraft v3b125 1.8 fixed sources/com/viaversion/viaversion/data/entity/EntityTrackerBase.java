...
ClientEntityIdChangeListener {
    ...
    @Override
    public void addEntity(int id2, EntityType type) {
        this.entities.put(id2, (TrackedEntity)new TrackedEntityImpl(type));
    }

    @Override
    public boolean hasEntity(int id2) {
        return this.entities.containsKey(id2);
    }
    ...
    @Override
    public @Nullable EntityType entityType(int id2) {
        TrackedEntity entity = (TrackedEntity)this.entities.get(id2);
        return entity != null ? entity.entityType() : null;
    }

    @Override
    public @Nullable StoredEntityData entityData(int id2) {
        TrackedEntity entity = (TrackedEntity)this.entities.get(id2);
        return entity != null ? entity.data() : null;
    }

    @Override
    public @Nullable StoredEntityData entityDataIfPresent(int id2) {
        TrackedEntity entity = (TrackedEntity)this.entities.get(id2);
        return entity != null && entity.hasData() ? entity.data() : null;
    }

    @Override
    public void removeEntity(int id2) {
        this.entities.remove(id2);
    }
