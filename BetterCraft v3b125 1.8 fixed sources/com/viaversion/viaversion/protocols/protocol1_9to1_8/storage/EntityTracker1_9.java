...
extends EntityTrackerBase {
    ...
    public UUID getEntityUUID(int id2) {
        UUID uuid = (UUID)this.uuidMap.get(id2);
        if (uuid == null) {
            uuid = UUID.randomUUID();
            this.uuidMap.put(id2, uuid);
        }
        return uuid;
    }
    ...
    public boolean interactedBlockRecently(int x2, int y2, int z2) {
        return this.blockInteractions.contains(new Position(x2, y2, z2));
    }
    ...
    public void sendTeamPacket(boolean add2, boolean now) {
