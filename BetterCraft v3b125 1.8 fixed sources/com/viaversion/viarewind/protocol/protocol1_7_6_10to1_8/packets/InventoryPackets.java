            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (int i2 = 0; i2 < items.length; ++i2) {
                        items[i2] = protocol.getItemRewriter().handleItemToClient(items[i2]);
                    }
                ...
                this.handler(wrapper -> {
                    ...
                    for (int i2 = 5; i2 < 9; ++i2) {
                        playerSession.setPlayerEquipment(userId, items[i2], 8 - i2);
        ...
        protocol.registerClientbound(ClientboundPackets1_8.WINDOW_PROPERTY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (windowType == 2) {
                        FurnaceData furnace = windowTracker.getFurnaceData().computeIfAbsent(windowId, x2 -> new FurnaceData());
