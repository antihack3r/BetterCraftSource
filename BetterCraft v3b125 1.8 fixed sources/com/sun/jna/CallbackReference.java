...
import [Ljava.lang.CfrRenamed5697;
...
extends WeakReference {
    ...
    private Class getNativeType(Class cls) {
        if (Structure.class.isAssignableFrom(cls)) {
            ...
            if (cls == String.class || cls == WString.class || cls == CfrRenamed5687.class || cls == CfrRenamed5704.class || Callback.class.isAssignableFrom(cls)) {
                return Pointer.class;
            }
        }
        return cls;
    ...
    static {
        try {
            PROXY_CALLBACK_METHOD = CallbackProxy.class.getMethod("callback", CfrRenamed5697.class);
        }
        catch (Exception e2) {
