...
implements Closeable {
    ...
    public void close() {
        ...
        try {
            ...
            LOGGER.debug("Failed to close pipe", e2);
        }
    }
    ...
    private /* synthetic */ void lambda$startReading$0() {
        try {
...

            {
                ...
                switch (_1.$SwitchMap$com$jagrosh$discordipc$IPCClient$Event[event.ordinal()]) {
                    case 1: {
                ...
                try {
                    ...
                    switch (_1.$SwitchMap$com$jagrosh$discordipc$IPCClient$Event[Event.of(json.getString("evt")).ordinal()]) {
                        case 3: {
