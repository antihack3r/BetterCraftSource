...
public class CosmeticDevilHorns
extends CosmeticBase {
    private static final ResourceLocation TEXTURE = new ResourceLocation("client/cosmetic/devilhorns.png");
    private DevilHornsModel devilHornsModel;

    public CosmeticDevilHorns(RenderPlayer player) {
        super(player);
    ...
    private class DevilHornsModel
    extends CosmeticModelBase {
        private final ModelRenderer rightHorn;
        private final ModelRenderer leftHorn;

        public DevilHornsModel(RenderPlayer player) {
            super(player);
