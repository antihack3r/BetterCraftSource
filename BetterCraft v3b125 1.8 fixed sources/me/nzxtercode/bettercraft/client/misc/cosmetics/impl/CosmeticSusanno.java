...
public class CosmeticSusanno
extends CosmeticBase {
    private static final ResourceLocation TEXTURE = new ResourceLocation("client/cosmetic/susanno.png");
    ...
    public static class SusannoModel
    extends CosmeticModelBase {
        ...
        public SusannoModel(RenderPlayer player) {
            ...
            this.leftRib12.addBox(0.0f, 0.0f, 0.0f, 1, 3, 10);
            ...
            this.leftRib22.addBox(0.0f, 0.0f, 0.0f, 1, 3, 14);
            ...
            this.leftRib32.addBox(0.0f, 0.0f, 0.0f, 1, 3, 14);
            ...
            this.leftRib42.addBox(0.0f, 0.0f, 0.0f, 1, 3, 10);
            ...
            this.rightRib12.addBox(0.0f, 0.0f, 0.0f, 1, 3, 10);
            ...
            this.rightRib22.addBox(0.0f, 0.0f, 0.0f, 1, 3, 14);
            ...
            this.rightRib32.addBox(0.0f, 0.0f, 0.0f, 1, 3, 14);
            ...
            this.rightRib42.addBox(0.0f, 0.0f, 0.0f, 1, 3, 10);
            ...
            this.Spine.addBox(0.0f, 0.0f, 0.0f, 4, 26, 3);
            ...
            this.leftRib41.addBox(0.0f, 0.0f, 0.0f, 10, 3, 1);
            ...
            this.rightRib41.addBox(-10.0f, 0.0f, 0.0f, 10, 3, 1);
            ...
            this.leftRib31.addBox(0.0f, 0.0f, 0.0f, 11, 3, 1);
            ...
            this.leftRib21.addBox(0.0f, 0.0f, 0.0f, 11, 3, 1);
            ...
            this.leftRib11.addBox(0.0f, -1.0f, 0.0f, 10, 3, 1);
            ...
            this.rightRib31.addBox(-11.0f, 0.0f, 0.0f, 11, 3, 1);
            ...
            this.rightRib21.addBox(-11.0f, 0.0f, 0.0f, 11, 3, 1);
            ...
            this.rightRib11.addBox(-10.0f, 0.0f, 0.0f, 10, 3, 1);
            ...
            this.leftRib43.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.leftRib33.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.leftRib23.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.leftRib13.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.rightRib43.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.rightRib33.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.rightRib23.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
            ...
            this.rightRib13.addBox(0.0f, 0.0f, 0.0f, 7, 3, 1);
        ...
        private void setRotation(ModelRenderer model, float x2, float y2, float z2) {
            model.rotateAngleX = x2;
            model.rotateAngleY = y2;
            model.rotateAngleZ = z2;
        }
