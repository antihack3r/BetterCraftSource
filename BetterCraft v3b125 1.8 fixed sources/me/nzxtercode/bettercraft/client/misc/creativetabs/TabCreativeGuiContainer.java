...
extends InventoryEffectRenderer {
    ...
    public TabCreativeGuiContainer(EntityPlayer p_i1088_1_) {
    ...
    public void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != TabsCreative.tabInventory.getTabIndex() && clickType != 5) {
        ...
        } else if (selectedTabIndex == TabsCreative.tabInventory.getTabIndex()) {
    ...
    public void initGui() {
        if (this.mc.playerController.isInCreativeMode()) {
            ...
            int tabCount = TabsCreative.creativeTabArray.length;
            if (tabCount > 12) {
                this.maxPages = (tabCount - 12) / 10 + 1;
            }
            this.buttonList.add(new GuiButton(45, width / 2 - 7, height / 2 - 117, 20, 20, "<"));
            ...
            selectedTabIndex = -1;
            this.setCurrentCreativeTab(TabsCreative.creativeTabArray[i2]);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        if (selectedTabIndex != TabsCreative.tabAllSearch.getTabIndex()) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        TabsCreative creativetabs = TabsCreative.creativeTabArray[selectedTabIndex];
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ...
            TabsCreative[] tabsCreativeArray = TabsCreative.creativeTabArray;
            int n2 = TabsCreative.creativeTabArray.length;
            int n3 = 0;
            while (n3 < n2) {
                TabsCreative creativetabs = tabsCreativeArray[n3];
    ...
    private boolean needsScrollBars() {
        return selectedTabIndex != TabsCreative.tabInventory.getTabIndex() && TabsCreative.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((ContainerCreative)this.inventorySlots).func_148328_e();
    }

    private void setCurrentCreativeTab(TabsCreative p_147050_1_) {
        int i2 = selectedTabIndex;
        ...
        } else if (i2 == TabsCreative.tabInventory.getTabIndex()) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int end = Math.min(TabsCreative.creativeTabArray.length, (tabPage + 1) * 10 + 2);
        if (tabPage != 0) {
            start += 2;
        }
        boolean rendered = false;
        TabsCreative[] arrcreativeTabs = Arrays.copyOfRange(TabsCreative.creativeTabArray, start, end);
        int n2 = arrcreativeTabs.length;
        int n22 = 0;
        while (n22 < n2) {
            TabsCreative creativetabs = arrcreativeTabs[n22];
        ...
        if (this.field_147064_C != null && selectedTabIndex == TabsCreative.tabInventory.getTabIndex() && this.isPointInRegion(this.field_147064_C.xDisplayPosition, this.field_147064_C.yDisplayPosition, 16, 16, mouseX, mouseY)) {
    ...
    protected void renderToolTip(ItemStack stack, int x2, int y2) {
        if (selectedTabIndex == TabsCreative.tabAllSearch.getTabIndex()) {
            ...
            if (creativetabs == null && stack.getItem() == Items.enchanted_book && (map = EnchantmentHelper.getEnchantments(stack)).size() == 1) {
                ...
                int n3 = 0;
                while (n3 < n2) {
                    TabsCreative creativetabs1 = tabsCreativeArray[n3];
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int n22 = 0;
        while (n22 < n2) {
            TabsCreative creativetabs1 = arrcreativeTabs[n22];
        ...
        if ((creativetabs == null || creativetabs.getTabPage() != tabPage) && creativetabs != TabsCreative.tabAllSearch && creativetabs != TabsCreative.tabInventory) {
            return;
        }
    ...
    protected boolean func_147049_a(TabsCreative p_147049_1_, int p_147049_2_, int p_147049_3_) {
        if (p_147049_1_.getTabPage() != tabPage && p_147049_1_ != TabsCreative.tabAllSearch && p_147049_1_ != TabsCreative.tabInventory) {
            return false;
        }
        ...
        int n2 = k2 = p_147049_1_.isTabInFirstRow() ? (k2 -= 32) : (k2 = k2 + this.ySize);
        return p_147049_2_ >= j2 && p_147049_2_ <= j2 + 28 && p_147049_3_ >= k2 && p_147049_3_ <= k2 + 32;
    }

    protected boolean renderCreativeInventoryHoveringText(TabsCreative p_147052_1_, int p_147052_2_, int p_147052_3_) {
    ...
    protected void func_147051_a(TabsCreative p_147051_1_) {
