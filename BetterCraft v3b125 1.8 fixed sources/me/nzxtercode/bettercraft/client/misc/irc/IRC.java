...
extends PircBot {
    ...
    public void init() {
        ...
        BetterCraft.getInstance();
        StringBuilder stringBuilder2 = stringBuilder.append(BetterCraft.clientName);
        BetterCraft.getInstance();
        this.connectBot(this.server, stringBuilder2.append(BetterCraft.clientVersion).toString());
