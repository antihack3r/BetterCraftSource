...
implements Serializable {
    ...
    public ThrowableProxy[] getSuppressed() {
        if (GET_SUPPRESSED != null) {
            try {
                return (ThrowableProxy[])GET_SUPPRESSED.invoke((Object)this.throwable, new Object[0]);
            }
    ...
    private void setSuppressed(Throwable throwable) {
        if (GET_SUPPRESSED != null && ADD_SUPPRESSED != null) {
            try {
                Throwable[] array;
                for (Throwable t2 : array = (Throwable[])GET_SUPPRESSED.invoke((Object)throwable, new Object[0])) {
                    ADD_SUPPRESSED.invoke((Object)this, new ThrowableProxy(t2));
                }
            }
