...
public class MappedObjectTransformer {
    ...
    static byte[] transformMappedObject(byte[] bytecode) {
        ...
        ClassAdapter cv2 = new ClassAdapter(cw2){
    ...
    static byte[] transformMappedAPI(String className, byte[] bytecode) {
        ...
        TransformationAdapter cv2 = ta2 = new TransformationAdapter(cw2, className);
        if (className_to_subtype.containsKey(className)) {
            cv2 = MappedObjectTransformer.getMethodGenAdapter(className, (ClassVisitor)((Object)cv2));
        }
        new ClassReader(bytecode).accept((ClassVisitor)((Object)cv2), 4);
        if (!ta2.transformed) {
            return bytecode;
        }
    ...
    private static void printBytecode(byte[] bytecode) {
        ...
        TraceClassVisitor tracer = new TraceClassVisitor(new ClassWriter(0), new PrintWriter(sw2));
        ...
        public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
            ...
            return new MethodNode(access, name, desc, signature, exceptions){
                ...
                private Frame<BasicValue>[] analyse() throws AnalyzerException {
                    Analyzer a2 = new Analyzer(new SimpleVerifier());
