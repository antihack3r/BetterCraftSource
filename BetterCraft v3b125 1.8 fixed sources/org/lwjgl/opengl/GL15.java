...
public final class GL15 {
    ...
    public static void glDeleteQueries(int id2) {
        ...
        long function_pointer = caps.glDeleteQueries;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL15.nglDeleteQueries(1, APIUtil.getInt(caps, id2), function_pointer);
    }
    ...
    public static void glGetQueryObject(int id2, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        GL15.nglGetQueryObjectiv(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetQueryObjectu(int id2, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        GL15.nglGetQueryObjectuiv(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
