...
public final class GL11 {
    ...
    public static void glNormal3b(byte nx2, byte ny, byte nz2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormal3b;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglNormal3b(nx2, ny, nz2, function_pointer);
    }

    static native void nglNormal3b(byte var0, byte var1, byte var2, long var3);

    public static void glNormal3f(float nx2, float ny, float nz2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormal3f;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglNormal3f(nx2, ny, nz2, function_pointer);
    }

    static native void nglNormal3f(float var0, float var1, float var2, long var3);

    public static void glNormal3d(double nx2, double ny, double nz2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormal3d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglNormal3d(nx2, ny, nz2, function_pointer);
    }

    static native void nglNormal3d(double var0, double var2, double var4, long var6);

    public static void glNormal3i(int nx2, int ny, int nz2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormal3i;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglNormal3i(nx2, ny, nz2, function_pointer);
    }
