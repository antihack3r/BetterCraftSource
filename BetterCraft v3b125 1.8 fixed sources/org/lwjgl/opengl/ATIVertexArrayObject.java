...
public final class ATIVertexArrayObject {
    ...
    public static void glGetVariantArrayObjectATI(int id2, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ATIVertexArrayObject.nglGetVariantArrayObjectfvATI(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVariantArrayObjectATI(int id2, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ATIVertexArrayObject.nglGetVariantArrayObjectivATI(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
