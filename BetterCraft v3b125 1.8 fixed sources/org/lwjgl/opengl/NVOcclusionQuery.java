...
public final class NVOcclusionQuery {
    ...
    public static void glGetOcclusionQueryuNV(int id2, int pname, IntBuffer params) {
        ...
        NVOcclusionQuery.nglGetOcclusionQueryuivNV(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetOcclusionQueryNV(int id2, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        NVOcclusionQuery.nglGetOcclusionQueryivNV(id2, pname, MemoryUtil.getAddress(params), function_pointer);
    }
