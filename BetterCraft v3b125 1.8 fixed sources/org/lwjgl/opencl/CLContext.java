...
extends CLObjectChild<CLPlatform> {
    ...
    public CLCommandQueue getCLCommandQueue(long id2) {
        return this.clCommandQueues.getObject(id2);
    }

    public CLMem getCLMem(long id2) {
        return this.clMems.getObject(id2);
    }

    public CLSampler getCLSampler(long id2) {
        return this.clSamplers.getObject(id2);
    }

    public CLProgram getCLProgram(long id2) {
        return this.clPrograms.getObject(id2);
    }

    public CLEvent getCLEvent(long id2) {
        return this.clEvents.getObject(id2);
    }
