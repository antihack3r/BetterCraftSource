...
public class ReflectorForge {
    ...
    public static String[] getForgeModIds() {
        ...
        for (Object object1 : list) {
            String s2;
            if (!Reflector.ModContainer.isInstance(object1) || (s2 = Reflector.callString(object1, Reflector.ModContainer_getModId, new Object[0])) == null) continue;
            list1.add(s2);
        }
    ...
    public static boolean canEntitySpawn(EntityLiving entityliving, World world, float x2, float y2, float z2) {
        Object object = Reflector.call(Reflector.ForgeEventFactory_canEntitySpawn, entityliving, world, Float.valueOf(x2), Float.valueOf(y2), Float.valueOf(z2));
        return object == EVENT_RESULT_ALLOW || object == EVENT_RESULT_DEFAULT && entityliving.getCanSpawnHere() && entityliving.isNotColliding();
    }

    public static boolean doSpecialSpawn(EntityLiving entityliving, World world, float x2, int y2, float z2) {
        return Reflector.ForgeEventFactory_doSpecialSpawn.exists() ? Reflector.callBoolean(Reflector.ForgeEventFactory_doSpecialSpawn, entityliving, world, Float.valueOf(x2), y2, Float.valueOf(z2)) : false;
    }
}
