        ...
        while (i2 < areaHeight) {
            ...
            while (j2 < areaWidth) {
                ...
                if (k2 == BiomeGenBase.mushroomIsland.biomeID) {
                    ...
                    aint1[j2 + i2 * areaWidth] = j22 != BiomeGenBase.ocean.biomeID && i3 != BiomeGenBase.ocean.biomeID && l3 != BiomeGenBase.ocean.biomeID && k4 != BiomeGenBase.ocean.biomeID ? k2 : BiomeGenBase.mushroomIslandShore.biomeID;
                    ...
                    aint1[j2 + i2 * areaWidth] = this.func_151631_c(i22) && this.func_151631_c(l2) && this.func_151631_c(k3) && this.func_151631_c(j4) ? (!(GenLayerShore.isBiomeOceanic(i22) || GenLayerShore.isBiomeOceanic(l2) || GenLayerShore.isBiomeOceanic(k3) || GenLayerShore.isBiomeOceanic(j4)) ? k2 : BiomeGenBase.beach.biomeID) : BiomeGenBase.jungleEdge.biomeID;
                } else if (k2 != BiomeGenBase.extremeHills.biomeID && k2 != BiomeGenBase.extremeHillsPlus.biomeID && k2 != BiomeGenBase.extremeHillsEdge.biomeID) {
                    if (biomegenbase != null && biomegenbase.isSnowyBiome()) {
                    ...
                    } else if (k2 != BiomeGenBase.mesa.biomeID && k2 != BiomeGenBase.mesaPlateau_F.biomeID) {
                        if (k2 != BiomeGenBase.ocean.biomeID && k2 != BiomeGenBase.deepOcean.biomeID && k2 != BiomeGenBase.river.biomeID && k2 != BiomeGenBase.swampland.biomeID) {
                            ...
                            aint1[j2 + i2 * areaWidth] = !(GenLayerShore.isBiomeOceanic(l1) || GenLayerShore.isBiomeOceanic(k22) || GenLayerShore.isBiomeOceanic(j3) || GenLayerShore.isBiomeOceanic(i4)) ? k2 : BiomeGenBase.beach.biomeID;
                        } else {
                        ...
                        aint1[j2 + i2 * areaWidth] = !(GenLayerShore.isBiomeOceanic(l2) || GenLayerShore.isBiomeOceanic(i1) || GenLayerShore.isBiomeOceanic(j1) || GenLayerShore.isBiomeOceanic(k1)) ? (this.func_151633_d(l2) && this.func_151633_d(i1) && this.func_151633_d(j1) && this.func_151633_d(k1) ? k2 : BiomeGenBase.desert.biomeID) : k2;
                    }
                } else {
