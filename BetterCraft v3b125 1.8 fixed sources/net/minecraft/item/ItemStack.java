...
public final class ItemStack {
    ...
    public ItemStack(Item itemIn, int amount, int meta) {
        this.item = Objects.nonNull(itemIn) ? itemIn : Items.potato;
    ...
    public ItemStack setStackDisplayLore(String string) {
        this.setStackDisplayLore(new String[]{string});
        return this;
    }
    ...
    public ItemStack setStackDisplayLore(String[] string) {
        ...
        String[] arrstring = string;
        int n2 = arrstring.length;
        int n22 = 0;
        while (n22 < n2) {
            String lore = arrstring[n22];
