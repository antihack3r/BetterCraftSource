...
public class Village {
    ...
    private boolean func_179861_a(BlockPos p_179861_1_, BlockPos p_179861_2_) {
        ...
        int k2 = i2;
        while (k2 < i2 + p_179861_1_.getX()) {
            int l2 = p_179861_2_.getY();
            while (l2 < p_179861_2_.getY() + p_179861_1_.getY()) {
                int i1 = j2;
                while (i1 < j2 + p_179861_1_.getZ()) {
                    if (this.worldObj.getBlockState(new BlockPos(k2, l2, i1)).getBlock().isNormalCube()) {
                        return false;
                    }
                    ++i1;
                }
    ...
    public EntityLivingBase findNearestVillageAggressor(EntityLivingBase entitylivingbaseIn) {
        ...
        int i2 = 0;
        while (i2 < this.villageAgressors.size()) {
