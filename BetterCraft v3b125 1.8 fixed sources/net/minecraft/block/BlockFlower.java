...
extends BlockBush {
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
        ...
        int n2 = enumFlowerTypeArray.length;
        int n3 = 0;
        while (n3 < n2) {
            EnumFlowerType blockflower$enumflowertype = enumFlowerTypeArray[n3];
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        static {
            ...
            int n2 = enumFlowerColorArray.length;
            int n3 = 0;
            while (n3 < n2) {
                final EnumFlowerColor blockflower$enumflowercolor = enumFlowerColorArray[n3];
