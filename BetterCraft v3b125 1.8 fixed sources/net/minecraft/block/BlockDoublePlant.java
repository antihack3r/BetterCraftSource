...
implements IGrowable {
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
        ...
        int n3 = 0;
        while (n3 < n2) {
            EnumPlantType blockdoubleplant$enumplanttype = enumPlantTypeArray[n3];
    ...
    public static enum EnumPlantType implements IStringSerializable
    {
        ...
        static {
            ...
            while (n3 < n2) {
                ...
                EnumPlantType.META_LOOKUP[blockdoubleplant$enumplanttype.getMeta()] = blockdoubleplant$enumplanttype = enumPlantTypeArray[n3];
                ++n3;
            }
        }
