...
implements IWorldNameable {
    ...
    public static EntityMinecart getMinecart(World worldIn, double x2, double y2, double z2, EnumMinecartType type) {
        switch (type) {
            case CHEST: {
    ...
    public static enum EnumMinecartType {
        ...
        static {
            ...
            int n2 = enumMinecartTypeArray.length;
            int n3 = 0;
            while (n3 < n2) {
                EnumMinecartType entityminecart$enumminecarttype = enumMinecartTypeArray[n3];
