...
extends Entity {
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTime == 20) {
            if (!this.worldObj.isRemote && (this.recentlyHit > 0 || this.isPlayer()) && this.canDropLoot() && this.worldObj.getGameRules().getBoolean("doMobLoot")) {
                int i2 = this.getExperiencePoints(this.attackingPlayer);
                while (i2 > 0) {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        n3 = 0;
        while (n3 < n2) {
            ItemStack itemstack1 = itemStackArray[n3];
            if (itemstack1 != null) {
            ...
            while (k2 < i2) {
                if (j2 != 0 || k2 != 0) {
                    ...
                    if (this.worldObj.getCollisionBoxes(axisalignedbb).isEmpty()) {
                        ...
                        if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(l2, (int)this.posY - 1, i1)) || this.worldObj.getBlockState(new BlockPos(l2, (int)this.posY - 1, i1)).getBlock().getMaterial() == Material.water) {
    ...
    public void onUpdate() {
        ...
        f22 = this.updateDistance(f1, f22);
        this.worldObj.theProfiler.endSection();
