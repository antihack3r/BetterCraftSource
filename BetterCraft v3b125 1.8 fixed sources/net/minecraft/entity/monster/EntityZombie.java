...
extends EntityMob {
        ...
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (entitylivingbase != null && this.worldObj.getDifficulty() == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(reinforcementChance).getAttributeValue()) {
                ...
                while (l2 < 50) {
                    ...
                    if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(i1, (j1 = j2 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1)) - 1, k1 = k2 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1))) && this.worldObj.getLightFromNeighbors(new BlockPos(i1, j1, k1)) < 10) {
    ...
    protected int getConversionTimeBoost() {
        ...
        if (this.rand.nextFloat() < 0.01f) {
            ...
            int k2 = (int)this.posX - 4;
            while (k2 < (int)this.posX + 4 && j2 < 14) {
                int l2 = (int)this.posY - 4;
                while (l2 < (int)this.posY + 4 && j2 < 14) {
                    int i1 = (int)this.posZ - 4;
                    while (i1 < (int)this.posZ + 4 && j2 < 14) {
                        Block block = this.worldObj.getBlockState(blockpos$mutableblockpos.set(k2, l2, i1)).getBlock();
