...
implements IInventory {
    ...
    public ItemStack func_174894_a(ItemStack stack) {
        ...
        while (i2 < this.slotsCount) {
            ...
            if (ItemStack.areItemsEqual(itemstack1, itemstack) && (k2 = Math.min(itemstack.stackSize, (j2 = Math.min(this.getInventoryStackLimit(), itemstack1.getMaxStackSize())) - itemstack1.stackSize)) > 0) {
    ...
    public void markDirty() {
        if (this.changeListeners != null) {
            int i2 = 0;
            while (i2 < this.changeListeners.size()) {
    ...
    public void clear() {
        int i2 = 0;
        while (i2 < this.inventoryContents.length) {
