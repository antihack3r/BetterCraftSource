...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new Button(SoundCategory.MASTER.getCategoryId(), width / 2 - 155 + i2 % 2 * 160, height / 6 - 12 + 24 * (i2 >> 1), SoundCategory.MASTER, true));
        i2 += 2;
        ...
        while (n3 < n2) {
            ...
            if (soundcategory != SoundCategory.MASTER) {
                this.buttonList.add(new Button(soundcategory.getCategoryId(), width / 2 - 155 + i2 % 2 * 160, height / 6 - 12 + 24 * (i2 >> 1), soundcategory, false));
                ++i2;
            }
            ++n3;
        }
    ...
    protected String getSoundVolume(SoundCategory p_146504_1_) {
        ...
        return f2 == 0.0f ? this.field_146508_h : String.valueOf((int)(f2 * 100.0f)) + "%";
    }
