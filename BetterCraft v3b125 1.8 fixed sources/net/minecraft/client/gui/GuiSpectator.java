...
implements ISpectatorMenuRecipient {
    ...
    public void func_175259_b(int p_175259_1_) {
        int i2 = this.field_175271_i.func_178648_e() + p_175259_1_;
        while (!(i2 < 0 || i2 > 8 || this.field_175271_i.func_178643_a(i2) != SpectatorMenu.field_178657_a && this.field_175271_i.func_178643_a(i2).func_178662_A_())) {
            i2 += p_175259_1_;
        }
        if (i2 >= 0 && i2 <= 8) {
