...
public class ChunkRenderDispatcher {
    ...
    public ChunkRenderDispatcher(int p_i4_1_) {
        ...
        int j2 = Math.max(1, MathHelper.clamp_int(Runtime.getRuntime().availableProcessors() - 2, 1, i2 / 5));
        this.countRenderBuilders = p_i4_1_ < 0 ? MathHelper.clamp_int(j2 * 8, 1, i2) : p_i4_1_;
        int k2 = 0;
        while (k2 < j2) {
        ...
        int l2 = 0;
        while (l2 < this.countRenderBuilders) {
