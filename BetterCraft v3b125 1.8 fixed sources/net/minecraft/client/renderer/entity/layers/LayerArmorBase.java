...
implements LayerRenderer<EntityLivingBase> {
    ...
    private void renderLayer(EntityLivingBase entitylivingbaseIn, float p_177182_2_, float p_177182_3_, float partialTicks, float p_177182_5_, float p_177182_6_, float p_177182_7_, float scale, int armorSlot) {
        ...
        if (itemstack != null && itemstack.getItem() instanceof ItemArmor) {
            ...
            T t2 = this.getArmorModel(armorSlot);
            ((ModelBase)t2).setModelAttributes(this.renderer.getMainModel());
            ((ModelBase)t2).setLivingAnimations(entitylivingbaseIn, p_177182_2_, p_177182_3_, partialTicks);
            if (Reflector.ForgeHooksClient.exists()) {
                t2 = this.getArmorModelHook(entitylivingbaseIn, itemstack, armorSlot, t2);
            }
            this.setModelPartVisible(t2, armorSlot);
            ...
            if (Reflector.ForgeHooksClient_getArmorTexture.exists()) {
                if (ReflectorForge.armorHasOverlay(itemarmor, itemstack)) {
                    ...
                    ((ModelBase)t2).render(entitylivingbaseIn, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, scale);
                ...
                ((ModelBase)t2).render(entitylivingbaseIn, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, scale);
                if (!(this.skipRenderGlint || !itemstack.hasEffect() || Config.isCustomItems() && CustomItems.renderCustomArmorEffect(entitylivingbaseIn, itemstack, t2, p_177182_2_, p_177182_3_, partialTicks, p_177182_5_, p_177182_6_, p_177182_7_, scale))) {
                    this.renderGlint(entitylivingbaseIn, t2, p_177182_2_, p_177182_3_, partialTicks, p_177182_5_, p_177182_6_, p_177182_7_, scale);
                }
                return;
            }
            ...
            if (!(this.skipRenderGlint || !itemstack.isItemEnchanted() || Config.isCustomItems() && CustomItems.renderCustomArmorEffect(entitylivingbaseIn, itemstack, t2, p_177182_2_, p_177182_3_, partialTicks, p_177182_5_, p_177182_6_, p_177182_7_, scale))) {
                this.renderGlint(entitylivingbaseIn, t2, p_177182_2_, p_177182_3_, partialTicks, p_177182_5_, p_177182_6_, p_177182_7_, scale);
            }
        }
    }
    ...
    public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, int p_getArmorResource_3_, String p_getArmorResource_4_) {
        ...
        String s22 = String.format("%s:textures/models/armor/%s_layer_%d%s.png", s1, s2, this.isSlotForLeggings(p_getArmorResource_3_) ? 2 : 1, p_getArmorResource_4_ == null ? "" : String.format("_%s", p_getArmorResource_4_));
        ResourceLocation resourcelocation = ARMOR_TEXTURE_RES_MAP.get(s22 = Reflector.callString(Reflector.ForgeHooksClient_getArmorTexture, p_getArmorResource_1_, p_getArmorResource_2_, s22, p_getArmorResource_3_, p_getArmorResource_4_));
        if (resourcelocation == null) {
