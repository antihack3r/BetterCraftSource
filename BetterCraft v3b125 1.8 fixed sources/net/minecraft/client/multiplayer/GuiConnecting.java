...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        switch ((int)(Minecraft.getSystemTime() / 300L % 4L)) {
            ...
            case 2: {
                s2 = "Connecting to " + EnumChatFormatting.RED.toString() + this.mc.getCurrentServerData().serverIP;
                break;
            }
            case 3: {
                s2 = "Send Handshake...";
        ...
        GuiConnecting.drawCenteredString(this.fontRendererObj, s2, width / 2, height / 2 - 50, 0xFFFFFF);
