...
implements INetHandlerPlayClient {
    ...
    public void handleDestroyEntities(S13PacketDestroyEntities packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        int i2 = 0;
        while (i2 < packetIn.getEntityIDs().length) {
    ...
    public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn) {
        ...
        int n2 = blockUpdateDataArray.length;
        int n3 = 0;
        while (n3 < n2) {
            S22PacketMultiBlockChange.BlockUpdateData s22packetmultiblockchange$blockupdatedata = blockUpdateDataArray[n3];
    ...
    public void handleMapChunkBulk(S26PacketMapChunkBulk packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        int i2 = 0;
        while (i2 < packetIn.getChunkCount()) {
            ...
            if ("MC|TrList".equals(packetIn.getChannelName())) {
                ...
                try {
                    try {
                        ...
                        if (guiscreen != null && guiscreen instanceof GuiMerchant && i2 == this.gameController.thePlayer.openContainer.windowId) {
    ...
    public void handleParticles(S2APacketParticles packetIn) {
        ...
        if (packetIn.getParticleCount() == 0) {
            ...
            int i2 = 0;
            while (i2 < packetIn.getParticleCount()) {
