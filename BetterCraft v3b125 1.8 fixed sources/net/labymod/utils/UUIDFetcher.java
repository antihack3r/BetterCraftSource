...
public class UUIDFetcher {
    ...
    public static UUID getUUIDAt(String name, long timestamp) {
        ...
        block4: {
            ...
            try {
                ...
                data = gson.fromJson((Reader)new BufferedReader(new InputStreamReader(connection.getInputStream())), UUIDFetcher.class);
    ...
    public static String getName(UUID uuid) {
        ...
        try {
            ...
            connection.setReadTimeout(5000);
            UUIDFetcher[] nameHistory = gson.fromJson((Reader)new BufferedReader(new InputStreamReader(connection.getInputStream())), UUIDFetcher[].class);
